...
set yrange [-4:6]
set key at 6.0,-1.5,0
set arrow 1 from a,-4 to a,6 nohead linetype 10
set arrow 2 from b,-4 to b,6 nohead linetype 10
plot[0:L] duanal(x) title "Analytic", dual(x) title "Arc length", dumin(x) title "Minimum", duhm(x) title "Harmonic mean", dugm(x) title "Geometric mean", duam(x) title "Arithmetic mean", durms(x) title "Root Mean Square", dumax(x) title "Maximum"
