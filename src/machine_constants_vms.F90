...
!> \brief This module contains all machine dependent constants for VMS systems.
!>
!> \section LICENSE
!>
...
MODULE MachineConstants
  ...
  !Machine constants
  INTEGER(INTG), PARAMETER :: MACHINE_TYPE=DEC_COMPUTER
  INTEGER(INTG), PARAMETER :: MACHINE_OS=VMS_OS
