    ...
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      IF(CONTROL_LOOP%NUMBER_OF_SUB_LOOPS==0) THEN
        ...
        CASE(PROBLEM_CONTROL_WHILE_LOOP_TYPE)
          ...
          CALL Field_VariableGet(INDEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE,FIELD_VAR_U1,ERR,ERROR,*999)
          ...
          DO element_idx=1,NUMBER_OF_ELEMENTS
            ...
            FIELD_VAR_TYPE=EQUATIONS_SET%EQUATIONS%equationsMapping%NONLINEAR_MAPPING%RESIDUAL_VARIABLES(1)%PTR%VARIABLE_TYPE
    ...
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      IF(CONTROL_LOOP%NUMBER_OF_SUB_LOOPS==0) THEN
        ...
        CASE(PROBLEM_CONTROL_WHILE_LOOP_TYPE)
          ...
          CALL Field_VariableGet(INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VAR_U,ERR,ERROR,*999)
          CALL Field_VariableGet(INDEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE,FIELD_VAR_U1,ERR,ERROR,*999)
        ...
        IF(ASSOCIATED(PROBLEM)) THEN
          ...
          CASE(PROBLEM_CONTROL_WHILE_LOOP_TYPE)
            ...
            IF(CONTROL_LOOP%WHILE_LOOP%ITERATION_NUMBER==1) THEN
              !
            ELSE
              CALL Field_VariableGet(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VAR,ERR,ERROR,*999)
