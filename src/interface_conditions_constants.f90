...
MODULE INTERFACE_CONDITIONS_CONSTANTS
  ...
  !> \addtogroup INTERFACE_CONDITIONS_CONSTANTS_OutputTypes INTERFACE_CONDITIONS_CONSTANTS::OutputTypes
  !> \brief The interface conditions output types
  !> \see INTERFACE_CONDITIONS_CONSTANTS,OPENCMISS_InterfaceConditionsConstants
  !>@{
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_NO_OUTPUT=0 !<No output. \see INTERFACE_CONDITIONS_CONSTANTS_OutputTypes,INTERFACE_CONDITIONS_CONSTANTS
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_PROGRESS_OUTPUT=1 !<Progress information output. \see INTERFACE_CONDITIONS_CONSTANTS_OutputTypes,INTERFACE_CONDITIONS_CONSTANTS
  !>@}
