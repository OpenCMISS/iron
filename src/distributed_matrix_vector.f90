...
#include "petscversion.h"
  ...
  INTERFACE DistributedMatrix_CreateFinish
    MODULE PROCEDURE DISTRIBUTED_MATRIX_CREATE_FINISH
  END INTERFACE DistributedMatrix_CreateFinish

  INTERFACE DistributedMatrix_CreateStart
    MODULE PROCEDURE DISTRIBUTED_MATRIX_CREATE_START
  END INTERFACE DistributedMatrix_CreateStart
  ...
  INTERFACE DistributedMatrix_DataTypeSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_DATA_TYPE_SET
  END INTERFACE DistributedMatrix_DataTypeSet

  INTERFACE DistributedMatrix_Destroy
    MODULE PROCEDURE DISTRIBUTED_MATRIX_DESTROY
  END INTERFACE DistributedMatrix_Destroy

  INTERFACE DistributedMatrix_Duplicate
    MODULE PROCEDURE DISTRIBUTED_MATRIX_DUPLICATE
  END INTERFACE DistributedMatrix_Duplicate

  INTERFACE DistributedMatrix_Form
    MODULE PROCEDURE DISTRIBUTED_MATRIX_FORM
  END INTERFACE DistributedMatrix_Form

  INTERFACE DistributedMatrix_GhostingTypeSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_GHOSTING_TYPE_SET
  END INTERFACE DistributedMatrix_GhostingTypeSet

  INTERFACE DistributedMatrix_LibraryTypeSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_LIBRARY_TYPE_SET
  END INTERFACE DistributedMatrix_LibraryTypeSet

  INTERFACE DistributedMatrix_MaxColumnsPerRowGet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_MAX_COLUMNS_PER_ROW_GET
  END INTERFACE DistributedMatrix_MaxColumnsPerRowGet

  INTERFACE DistributedMatrix_NumberNonZerosGet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_GET
  END INTERFACE DistributedMatrix_NumberNonZerosGet
  ...
  END INTERFACE DistributedMatrix_OverrideSetOn

  INTERFACE DistributedMatrix_OverrideSetOff
    MODULE PROCEDURE DISTRIBUTED_MATRIX_OVERRIDE_SET_OFF
  END INTERFACE DistributedMatrix_OverrideSetOff

  INTERFACE DistributedMatrix_StorageLocationsGet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_GET
  END INTERFACE DistributedMatrix_StorageLocationsGet

  INTERFACE DistributedMatrix_StorageLocationsSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET
  END INTERFACE DistributedMatrix_StorageLocationsSet

  INTERFACE DistributedMatrix_StorageTypeGet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_STORAGE_TYPE_GET
  END INTERFACE DistributedMatrix_StorageTypeGet

  INTERFACE DistributedMatrix_StorageTypeSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_STORAGE_TYPE_SET
  END INTERFACE DistributedMatrix_StorageTypeSet

  INTERFACE DistributedMatrix_UpdateFinish
    MODULE PROCEDURE DISTRIBUTED_MATRIX_UPDATE_FINISH
  END INTERFACE DistributedMatrix_UpdateFinish

  INTERFACE DistributedMatrix_UpdateStart
    MODULE PROCEDURE DISTRIBUTED_MATRIX_UPDATE_START
  END INTERFACE DistributedMatrix_UpdateStart

  INTERFACE DistributedMatrix_UpdateIsFinished
    MODULE PROCEDURE DISTRIBUTED_MATRIX_UPDATE_ISFINISHED
  END INTERFACE DistributedMatrix_UpdateIsFinished

  INTERFACE DistributedMatrix_UpdateWaitFinished
    MODULE PROCEDURE DISTRIBUTED_MATRIX_UPDATE_WAITFINISHED
  END INTERFACE DistributedMatrix_UpdateWaitFinished
  ...
  INTERFACE DistributedMatrix_MatrixByVectorAdd
    MODULE PROCEDURE DISTRIBUTED_MATRIX_BY_VECTOR_ADD
  END INTERFACE DistributedMatrix_MatrixByVectorAdd
  ...
  INTERFACE DistributedVector_CreateFinish
    MODULE PROCEDURE DISTRIBUTED_VECTOR_CREATE_FINISH
  END INTERFACE DistributedVector_CreateFinish

  INTERFACE DistributedVector_CreateStart
    MODULE PROCEDURE DISTRIBUTED_VECTOR_CREATE_START
  END INTERFACE DistributedVector_CreateStart
  ...
  INTERFACE DistributedVector_Destroy
    MODULE PROCEDURE DISTRIBUTED_VECTOR_DESTROY
  END INTERFACE DistributedVector_Destroy

  INTERFACE DistributedVector_Duplicate
    MODULE PROCEDURE DISTRIBUTED_VECTOR_DUPLICATE
  END INTERFACE DistributedVector_Duplicate

  INTERFACE DistributedVector_GhostingTypeSet
    MODULE PROCEDURE DISTRIBUTED_VECTOR_GHOSTING_TYPE_SET
  END INTERFACE DistributedVector_GhostingTypeSet

  INTERFACE DistributedVector_LibraryTypeSet
    MODULE PROCEDURE DISTRIBUTED_VECTOR_LIBRARY_TYPE_SET
  END INTERFACE DistributedVector_LibraryTypeSet

  INTERFACE DistributedVector_Output
    MODULE PROCEDURE DISTRIBUTED_VECTOR_OUTPUT
  END INTERFACE DistributedVector_Output

  INTERFACE DistributedVector_OverrideSetOn
    MODULE PROCEDURE DISTRIBUTED_VECTOR_OVERRIDE_SET_ON
  END INTERFACE DistributedVector_OverrideSetOn

  INTERFACE DistributedVector_OverrideSetOff
    MODULE PROCEDURE DISTRIBUTED_VECTOR_OVERRIDE_SET_OFF
  END INTERFACE DistributedVector_OverrideSetOff

  INTERFACE DistributedVector_UpdateFinish
    MODULE PROCEDURE DISTRIBUTED_VECTOR_UPDATE_FINISH
  END INTERFACE DistributedVector_UpdateFinish

  INTERFACE DistributedVector_UpdateStart
    MODULE PROCEDURE DISTRIBUTED_VECTOR_UPDATE_START
  END INTERFACE DistributedVector_UpdateStart

  INTERFACE DistributedVector_UpdateIsFinished
    MODULE PROCEDURE DISTRIBUTED_VECTOR_UPDATE_ISFINISHED
  END INTERFACE DistributedVector_UpdateIsFinished
  ...
  INTERFACE DistributedMatrix_LinkListSet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_LINKLIST_SET
  END INTERFACE DistributedMatrix_LinkListSet

  INTERFACE DistributedMatrix_LinkListGet
    MODULE PROCEDURE DISTRIBUTED_MATRIX_LINKLIST_GET
  END INTERFACE DistributedMatrix_LinkListGet
  ...
  PUBLIC DistributedMatrix_NumberNonZerosGet,DistributedMatrix_NumberNonZerosSet
...
CONTAINS  
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_ALL_VALUES_SET_INTG(DISTRIBUTED_MATRIX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_INTG",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        ...
        END SELECT
      ELSE
        CALL FlagError("The distributed matrix has not been finished.",ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix is not associated.",ERR,ERROR,*999)
    ENDIF

    EXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_ALL_VALUES_SET_SP(DISTRIBUTED_MATRIX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_ALL_VALUES_SET_DP(DISTRIBUTED_MATRIX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_ALL_VALUES_SET_L(DISTRIBUTED_MATRIX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_ALL_VALUES_SET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_CMISS_CREATE_FINISH(CMISS_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_CMISS_CREATE_FINISH",ERR,ERROR,*998)
    ...
    IF(ASSOCIATED(CMISS_MATRIX)) THEN
      ...
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix CMISS is not associated.",ERR,ERROR,*998)
    ENDIF
    
    EXITS("DISTRIBUTED_MATRIX_CMISS_CREATE_FINISH")
    RETURN
999 CALL DISTRIBUTED_MATRIX_CMISS_FINALISE(CMISS_MATRIX,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_CMISS_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_CMISS_FINALISE(CMISS_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_CMISS_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_CMISS_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_CMISS_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_CMISS_INITIALISE(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_CMISS_INITIALISE",ERR,ERROR,*998)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      ...
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix is not associated.",ERR,ERROR,*998)
    ENDIF
    
    EXITS("DISTRIBUTED_MATRIX_CMISS_INITIALISE")
    RETURN
...
998 ERRORSEXITS("DISTRIBUTED_MATRIX_CMISS_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_CREATE_FINISH(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_CREATE_FINISH",ERR,ERROR,*998)

    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        CALL FlagError("The distributed matrix has been finished.",ERR,ERROR,*998)
      ELSE
        SELECT CASE(DISTRIBUTED_MATRIX%LIBRARY_TYPE)
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
    ...
    EXITS("DISTRIBUTED_MATRIX_CREATE_FINISH")
    RETURN
999 CALL DISTRIBUTED_MATRIX_FINALISE(DISTRIBUTED_MATRIX,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_CREATE_START(ROW_DOMAIN_MAPPING,COLUMN_DOMAIN_MAPPING,DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_CREATE_START",ERR,ERROR,*998)

    IF(ASSOCIATED(ROW_DOMAIN_MAPPING)) THEN
      IF(ASSOCIATED(COLUMN_DOMAIN_MAPPING)) THEN
        IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
          CALL FlagError("Distributed matrix is already associated.",ERR,ERROR,*998)
        ELSE
          ...
          ELSE
            LOCAL_ERROR="The number of domains in the row domain mapping ("// &
              & TRIM(NumberToVString(ROW_DOMAIN_MAPPING%NUMBER_OF_DOMAINS,"*",ERR,ERROR))// &
              & ") does not match the number of domains in the column domain mapping ("// &
              & TRIM(NumberToVString(COLUMN_DOMAIN_MAPPING%NUMBER_OF_DOMAINS,"*",ERR,ERROR))//")."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          ENDIF
        ENDIF
      ELSE
    ...
    EXITS("DISTRIBUTED_MATRIX_CREATE_START")
    RETURN
999 CALL DISTRIBUTED_MATRIX_FINALISE(DISTRIBUTED_MATRIX,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_CREATE_START",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_GET_INTG(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_GET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_GET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_GET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_GET_SP(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_GET_SP",ERR,ERROR,*999)
      ...
      ELSE
        ...
        IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
          ...
          CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
            ...
            ENDIF
          CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
            CALL FlagError("Cannot get data for a single precision PETSc distributed matrix.",ERR,ERROR,*999)
          CASE DEFAULT
            LOCAL_ERROR="The distributed matrix library type of "// &
              & TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_GET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_GET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_GET_DP(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_GET_DP",ERR,ERROR,*999)
          ...
          CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
            IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) THEN
              IF(DISTRIBUTED_MATRIX%PETSC%USE_OVERRIDE_MATRIX) THEN
                ...
                CASE DEFAULT
                  LOCAL_ERROR="The PETSc matrix storage type of "//TRIM(NumberToVString( &
              ...
              END SELECT
            ELSE
              CALL FlagError("Distributed matris PETSc is not associated.",ERR,ERROR,*999)
            ENDIF
          CASE DEFAULT
            LOCAL_ERROR="The distributed matrix library type of "// &
              & TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_GET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_GET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_GET_L(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_GET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_GET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_GET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_RESTORE_INTG(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_RESTORE_INTG",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(ASSOCIATED(DATA)) THEN
        ...
        ENDIF
      ELSE
        CALL FlagError("Data is not associated.",ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix is not associated.",ERR,ERROR,*999)
    ENDIF
    
    EXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_RESTORE_SP(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_RESTORE_SP",ERR,ERROR,*999)
      ...
      IF(ASSOCIATED(DATA)) THEN
        IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
          ...
          CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
            NULLIFY(DATA)
          CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
            CALL FlagError("Cannot restore data for a single precision PETSc distributed matrix.",ERR,ERROR,*999)
          CASE DEFAULT
            LOCAL_ERROR="The distributed matrix library type of "// &
              & TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_RESTORE_DP(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_RESTORE_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_RESTORE_L(DISTRIBUTED_MATRIX,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_RESTORE_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_RESTORE_L",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DistributedMatrix_DataTypeGet",err,error)
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DATA_TYPE_SET(DISTRIBUTED_MATRIX,DATA_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DATA_TYPE_SET",ERR,ERROR,*999)

    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        CALL FlagError("The distributed matrix has been finished.",ERR,ERROR,*999)
      ELSE
        SELECT CASE(DISTRIBUTED_MATRIX%LIBRARY_TYPE)
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%CMISS)) THEN
    ...
    EXITS("DISTRIBUTED_MATRIX_DATA_TYPE_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DATA_TYPE_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DistributedMatrix_DimensionsGet",err,error)
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DESTROY(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_DESTROY")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_DESTROY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_DUPLICATE(DISTRIBUTED_MATRIX,NEW_DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_DUPLICATE",ERR,ERROR,*998)

    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(ASSOCIATED(NEW_DISTRIBUTED_MATRIX)) THEN
        CALL FlagError("New distributed matrix is already associated.",ERR,ERROR,*998)
      ELSE
        SELECT CASE(DISTRIBUTED_MATRIX%LIBRARY_TYPE)
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%CMISS)) THEN
    ...
    EXITS("DISTRIBUTED_MATRIX_DUPLICATE")
    RETURN
999 CALL DISTRIBUTED_MATRIX_FINALISE(NEW_DISTRIBUTED_MATRIX,DUMMY_ERR,DUMMY_ERROR,*999)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_DUPLICATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_FINALISE(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_FORM(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_FORM",ERR,ERROR,*999)
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          ...
          IF(ASSOCIATED(PETSC_MATRIX)) THEN
            ...
            CASE(DISTRIBUTED_MATRIX_ROW_COLUMN_STORAGE_TYPE)
              CALL FlagError("Row column storage is not implemented for PETSc matrices.",ERR,ERROR,*999)
            CASE DEFAULT
              LOCAL_ERROR="The PETSc matrix storage type of "//TRIM(NumberToVString(PETSC_MATRIX%STORAGE_TYPE,"*",ERR,ERROR))// &
                & " is invalid."
              CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
            END SELECT
            IF(PETSC_MATRIX%USE_OVERRIDE_MATRIX) THEN
    ...
    EXITS("DISTRIBUTED_MATRIX_FORM")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_FORM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_GHOSTING_TYPE_SET(DISTRIBUTED_MATRIX,GHOSTING_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_GHOSTING_TYPE_SET",ERR,ERROR,*999)

    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        CALL FlagError("The distributed matrix has already been finished.",ERR,ERROR,*999)
      ELSE
        ROW_DOMAIN_MAPPING=>DISTRIBUTED_MATRIX%ROW_DOMAIN_MAPPING
        COLUMN_DOMAIN_MAPPING=>DISTRIBUTED_MATRIX%COLUMN_DOMAIN_MAPPING
        IF(ASSOCIATED(ROW_DOMAIN_MAPPING)) THEN
              ...
              IF(ASSOCIATED(DISTRIBUTED_MATRIX%CMISS)) THEN
                ...
                CASE(DISTRIBUTED_MATRIX_VECTOR_NO_GHOSTS_TYPE)
                  CALL MATRIX_SIZE_SET(DISTRIBUTED_MATRIX%CMISS%MATRIX,ROW_DOMAIN_MAPPING%NUMBER_OF_LOCAL, &
                    & COLUMN_DOMAIN_MAPPING%NUMBER_OF_GLOBAL,ERR,ERROR,*999)
                CASE DEFAULT
                  LOCAL_ERROR="The given ghosting type of "//TRIM(NumberToVString(GHOSTING_TYPE,"*",ERR,ERROR))//" is invalid."
                  CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                END SELECT
              ELSE
                CALL FlagError("Distributed matrix CMISS is not associated.",ERR,ERROR,*999)
          ...
          ELSE
            CALL FlagError("Distributed matrix column domain mapping is not associated.",ERR,ERROR,*999)
          ENDIF
        ELSE
          CALL FlagError("Distributed matrix row domain mapping is not associated.",ERR,ERROR,*999)
        ENDIF
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix is not associated.",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_GHOSTING_TYPE_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_GHOSTING_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_LIBRARY_TYPE_SET(DISTRIBUTED_MATRIX,LIBRARY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_LIBRARY_TYPE_SET",ERR,ERROR,*998)

    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        CALL FlagError("The distributed matrix has already been finished.",ERR,ERROR,*998)
      ELSE
        ...
        IF(LIBRARY_TYPE/=OLD_LIBRARY_TYPE) THEN
          ...
          CASE DEFAULT
            LOCAL_ERROR="The library type of "//TRIM(NumberToVString(LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          END SELECT
          ...
          CASE DEFAULT
            LOCAL_ERROR="The distributed matrix library type of "// &
              & TRIM(NumberToVString(OLD_LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          END SELECT          
    ...
    EXITS("DISTRIBUTED_MATRIX_LIBRARY_TYPE_SET")
    RETURN
999 SELECT CASE(LIBRARY_TYPE)
    ...
    END SELECT
998 ERRORSEXITS("DISTRIBUTED_MATRIX_LIBRARY_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_INITIALISE(ROW_DOMAIN_MAPPING,COLUMN_DOMAIN_MAPPING,DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("DISTRIBUTED_MATRIX_INITIALISE")
    RETURN
999 CALL DISTRIBUTED_MATRIX_FINALISE(DISTRIBUTED_MATRIX,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_MAX_COLUMNS_PER_ROW_GET(DISTRIBUTED_MATRIX,MAX_COLUMNS_PER_ROW,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_MAX_COLUMNS_PER_ROW_GET",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      ...
      ENDIF
    ELSE
      CALL FlagError("Distributed mtrix is not associated.",ERR,ERROR,*999)
    ENDIF

    EXITS("DISTRIBUTED_MATRIX_MAX_COLUMNS_PER_ROW_GET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_MAX_COLUMNS_PER_ROW_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_SET(DISTRIBUTED_MATRIX,NUMBER_NON_ZEROS,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_SET",ERR,ERROR,*999)
      ...
      ELSE
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) THEN
            ...
            ELSE
              LOCAL_ERROR="The specified number of non zeros ("//TRIM(NumberToVString(NUMBER_NON_ZEROS,"*",ERR,ERROR))// &
    ...
    EXITS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_GET(DISTRIBUTED_MATRIX,NUMBER_NON_ZEROS,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_GET",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        ...
        END SELECT
      ELSE
        CALL FlagError("The distributed matrix is not finished.",ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix is not associated.",ERR,ERROR,*999)
    ENDIF

    EXITS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_GET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_NUMBER_NON_ZEROS_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_LINKLIST_SET(DISTRIBUTED_MATRIX,LIST,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_LINKLIST_SET",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_LINKLIST_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_LINKLIST_SET",ERR,ERROR)
    RETURN 1
...
!    INTEGER(INTG), INTENT(OUT) :: NUMBER_NON_ZEROS !<On return, the number of non zeros in the matrix to get
    ...
    ENTERS("DISTRIBUTED_MATRIX_LINKLIST_GET",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_LINKLIST_GET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_LINKLIST_GET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DISTRIBUTED_MATRIX_OUTPUT",ERR,ERROR)
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_OVERRIDE_SET_ON(DISTRIBUTED_MATRIX,OVERRIDE_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_OVERRIDE_SET_ON",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_OVERRIDE_SET_ON")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_OVERRIDE_SET_ON",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_OVERRIDE_SET_OFF(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_OVERRIDE_SET_OFF",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_OVERRIDE_SET_OFF")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_OVERRIDE_SET_OFF",ERR,ERROR)
    RETURN 1
    ...
    IF(ASSOCIATED(PETSC_MATRIX)) THEN
      ...
      IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
        ...
        IF(ASSOCIATED(ROW_DOMAIN_MAPPING)) THEN
          ...
          ENDIF
        ELSE
          CALL FlagError("PETSc matrix distributed matrix row domain mapping is not associated.",ERR,ERROR,*999)
        ENDIF
      ENDIF
    ELSE
      CALL FlagError("Distributed matrix PETSc is not associated.",ERR,ERROR,*998)
    ENDIF
    
    EXITS("DISTRIBUTED_MATRIX_PETSC_CREATE_FINISH")
    RETURN
999 CALL DISTRIBUTED_MATRIX_PETSC_FINALISE(PETSC_MATRIX,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_PETSC_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_PETSC_FINALISE(PETSC_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_PETSC_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_PETSC_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_PETSC_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_PETSC_INITIALISE(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_PETSC_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("DISTRIBUTED_MATRIX_PETSC_INITIALISE")
    RETURN
999 IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) &
      & CALL DISTRIBUTED_MATRIX_PETSC_FINALISE(DISTRIBUTED_MATRIX%PETSC,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_MATRIX_PETSC_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_GET(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_GET",ERR,ERROR,*999)
          ...
          IF(ASSOCIATED(PETSC_MATRIX)) THEN
            ...
            CASE DEFAULT
              LOCAL_ERROR="The matrix storage type of "// &
                & TRIM(NumberToVString(PETSC_MATRIX%STORAGE_TYPE,"*",ERR,ERROR))//" is invalid."
              CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
            END SELECT
          ELSE
            CALL FlagError("Distributed matrix PETSc is not associated.",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_GET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET",ERR,ERROR,*999)
                      ...
                      IF(ROW_INDICES(1)==1) THEN
                        ...
                        IF(ROW_INDICES(PETSC_MATRIX%M+1)==PETSC_MATRIX%NUMBER_NON_ZEROS+1) THEN
                          DO i=2,PETSC_MATRIX%M+1
                            IF(ROW_INDICES(i)<ROW_INDICES(i-1)) THEN
                              LOCAL_ERROR="Invalid row indices. Row "//TRIM(NumberToVString(i,"*",ERR,ERROR))// &
                                & " index number ("//TRIM(NumberToVString(ROW_INDICES(i),"*",ERR,ERROR))//" &
                                & ) is less than row "//TRIM(NumberToVString(i-1,"*",ERR,ERROR))//" index number ("// &
                                & TRIM(NumberToVString(ROW_INDICES(i-1),"*",ERR,ERROR))//")."
                              CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                            ENDIF
                          ENDDO !i
                              ...
                              IF(k>0) THEN
                                IF(k>PETSC_MATRIX%GLOBAL_N) THEN
                                  LOCAL_ERROR="Invalid column indices. Column index "//TRIM(NumberToVString(j,"*",ERR,ERROR))// &
                                    & " ("//TRIM(NumberToVString(k,"*",ERR,ERROR))// &
                                    & ") is greater than the number of columns ("// &
                                    & TRIM(NumberToVString(PETSC_MATRIX%GLOBAL_N,"*",ERR,ERROR))//")."
                                  CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                                ENDIF
                        ...
                        ELSE
                          LOCAL_ERROR="Invalid row indices. The last row index ("// &
                            & TRIM(NumberToVString(ROW_INDICES(PETSC_MATRIX%M+1),"*",ERR,ERROR))// &
                            & ") does not equal the number of non-zeros + 1 ("// &
                            & TRIM(NumberToVString(PETSC_MATRIX%NUMBER_NON_ZEROS+1,"*",ERR,ERROR))//")."
                          CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                        ENDIF
                      ELSE
                        LOCAL_ERROR="Invalid row indices. The first row index ("// &
                          & TRIM(NumberToVString(ROW_INDICES(1),"*",ERR,ERROR))//") does not equal 1."
                        CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                      ENDIF
                    ELSE
                      LOCAL_ERROR="The supplied number of column indices ("// &
                        & TRIM(NumberToVString(SIZE(COLUMN_INDICES,1),"*",ERR,ERROR))// &
                        & ") does not match the number of non-zeros in the matrix ("// &
                        & TRIM(NumberToVString(PETSC_MATRIX%NUMBER_NON_ZEROS,"*",ERR,ERROR))//")."
                      CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                    ENDIF
                  ELSE
                    LOCAL_ERROR="The supplied number of row indices ("// &
                      & TRIM(NumberToVString(SIZE(ROW_INDICES,1),"*",ERR,ERROR))// &
                      & ") does not match the number of rows in the matrix + 1 ("// &
                      & TRIM(NumberToVString(PETSC_MATRIX%M+1,"*",ERR,ERROR))//")."
                    CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                  ENDIF
                CASE(DISTRIBUTED_MATRIX_COMPRESSED_COLUMN_STORAGE_TYPE)
                  CALL FlagError("Compressed column storage is not implemented for PETSc matrices.",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET")
    RETURN
999 IF(ASSOCIATED(PETSC_MATRIX)) THEN
      IF(ALLOCATED(PETSC_MATRIX%DIAGONAL_NUMBER_NON_ZEROS)) DEALLOCATE(PETSC_MATRIX%DIAGONAL_NUMBER_NON_ZEROS)
      IF(ALLOCATED(PETSC_MATRIX%OFFDIAGONAL_NUMBER_NON_ZEROS)) DEALLOCATE(PETSC_MATRIX%OFFDIAGONAL_NUMBER_NON_ZEROS)
    ENDIF
    ERRORSEXITS("DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_STORAGE_TYPE_GET(DISTRIBUTED_MATRIX,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_STORAGE_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_STORAGE_TYPE_GET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_STORAGE_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_STORAGE_TYPE_SET(DISTRIBUTED_MATRIX,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_STORAGE_TYPE_SET",ERR,ERROR,*999)
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) THEN
            ...
            CASE(DISTRIBUTED_MATRIX_ROW_COLUMN_STORAGE_TYPE)
              CALL FlagError("Row column storage is not implemented for PETSc matrices.",ERR,ERROR,*999)
            CASE DEFAULT
              LOCAL_ERROR="The specified matrix storage type of "//TRIM(NumberToVString(STORAGE_TYPE,"*",ERR,ERROR))// &
                & " is invalid."
              CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
            END SELECT
          ELSE
            CALL FlagError("Distributed matrix PETSc is not implemented.",ERR,ERROR,*999)
          ENDIF
        CASE DEFAULT
          LOCAL_ERROR="The distributed matrix library type of "// &
            & TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
    ...
    EXITS("DISTRIBUTED_MATRIX_STORAGE_TYPE_SET")
    RETURN
...
999 ERRORSEXITS("DistributedMatrix_SymmetryTypeSet",err,error)
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_UPDATE_FINISH(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_UPDATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_UPDATE_FINISH")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_UPDATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_UPDATE_ISFINISHED(DISTRIBUTED_MATRIX,ISFINISHED,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_UPDATE_ISFINISHED",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_UPDATE_ISFINISHED")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_UPDATE_ISFINISHED",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_UPDATE_WAITFINISHED(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_UPDATE_WAITFINISHED",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_UPDATE_WAITFINISHED")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_UPDATE_WAITFINISHED",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_UPDATE_START(DISTRIBUTED_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_UPDATE_START",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_UPDATE_START")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_UPDATE_START",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_INTG(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_INTG1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_INTG2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_INTG2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_SP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_SP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_SP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_SP2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_SP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_DP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_DP",ERR,ERROR,*999)
      ...
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) THEN
            ...
            ENDIF
          ELSE
            CALL FlagError("The distributed matrix PETSc is not associated.",ERR,ERROR,*999)
          ENDIF
        CASE DEFAULT
          LOCAL_ERROR="The distributed matrix library type of "// &
            & TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_DP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_DP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_DP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_L(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_L1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_ADD_L2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_ADD_L2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_ADD_L2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_INTG(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_INTG1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_INTG1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_INTG2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_INTG2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_INTG2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_SP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_SP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_SP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_SP2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_SP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_DP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_DP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_DP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_DP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(DISTRIBUTED_MATRIX)) THEN
      IF(DISTRIBUTED_MATRIX%MATRIX_FINISHED) THEN
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          ...
          ENDIF
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          CALL FlagError("Cannot get values for an integer precision PETSc distributed matrix.",ERR,ERROR,*999)          
          IF(ASSOCIATED(DISTRIBUTED_MATRIX%PETSC)) THEN
            IF(SIZE(ROW_INDICES,1)==SIZE(VALUES,1)) THEN
              IF(SIZE(COLUMN_INDICES,1)==SIZE(VALUES,2)) THEN
                DO i=1,SIZE(ROW_INDICES,1)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_DP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_L(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_L1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_L1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_GET_L2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_GET_L2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_GET_L2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_GET_L2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_INTG(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_INTG1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_INTG1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_INTG2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_INTG2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_INTG2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_SP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_SP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_SP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_SP2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_SP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_DP(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_DP1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_DP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_DP2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_DP2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_L(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_L1(DISTRIBUTED_MATRIX,ROW_INDEX,COLUMN_INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_L1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_VALUES_SET_L2(DISTRIBUTED_MATRIX,ROW_INDICES,COLUMN_INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_MATRIX_VALUES_SET_L2",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_MATRIX_VALUES_SET_L2")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_VALUES_SET_L2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_MATRIX_BY_VECTOR_ADD(ROW_SELECTION_TYPE,ALPHA,DISTRIBUTED_MATRIX,DISTRIBUTED_VECTOR,DISTRIBUTED_PRODUCT, &
    ...
    ENTERS("DISTRIBUTED_MATRIX_BY_VECTOR_ADD",ERR,ERROR,*999)
    ...
    IF(ABS(ALPHA)>ZERO_TOLERANCE) THEN
          ...
          IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
            IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
              IF(ASSOCIATED(DISTRIBUTED_PRODUCT)) THEN
                  ...
                  IF(DISTRIBUTED_MATRIX%LIBRARY_TYPE==DISTRIBUTED_VECTOR%LIBRARY_TYPE) THEN
                                      ...
                                      IF(ASSOCIATED(CMISS_PRODUCT)) THEN
                                        ...
                                        IF(MATRIX%DATA_TYPE==DISTRIBUTED_VECTOR%DATA_TYPE) THEN
                                          ...
                                          ELSE
                                            LOCAL_ERROR="The distributed product vector data type of "// &
                                              & TRIM(NumberToVString(DISTRIBUTED_PRODUCT%DATA_TYPE,"*",ERR,ERROR))// &
                                        ...
                                        ELSE
                                          LOCAL_ERROR="The distributed vector data type of "// &
                                            & TRIM(NumberToVString(DISTRIBUTED_VECTOR%DATA_TYPE,"*",ERR,ERROR))// &
                                            & " does not match the distributed matrix data type of "// &
                                            & TRIM(NumberToVString(MATRIX%DATA_TYPE,"*",ERR,ERROR))//"."
                                          CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                                        ENDIF
                                      ELSE
                                        CALL FlagError("Distributed product CMISS vector is not associated.",ERR,ERROR,*999)
                                      ENDIF
                                    ELSE
                    ...
                    ELSE
                      LOCAL_ERROR="The distributed product vector library type of "// &
                        & TRIM(NumberToVString(DISTRIBUTED_PRODUCT%LIBRARY_TYPE,"*",ERR,ERROR))// &
                        & " does not match the distributed matrix library type of "// &
                        &  TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//"."
                      CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                    ENDIF
                  ELSE
                    LOCAL_ERROR="The distributed vector library type of "// &
                      & TRIM(NumberToVString(DISTRIBUTED_VECTOR%LIBRARY_TYPE,"*",ERR,ERROR))// &
                      & " does not match the distributed matrix library type of "// &
                      &  TRIM(NumberToVString(DISTRIBUTED_MATRIX%LIBRARY_TYPE,"*",ERR,ERROR))//"."
                    CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                  ENDIF
                ...
                ENDIF
              ELSE
                CALL FlagError("The distributed product vector is not associated.",ERR,ERROR,*999)
              ENDIF
            ELSE
      ...
      ENDIF
    ENDIF
    EXITS("DISTRIBUTED_MATRIX_BY_VECTOR_ADD")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_MATRIX_BY_VECTOR_ADD",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_ALL_VALUES_SET_INTG(DISTRIBUTED_VECTOR,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_INTG",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        IF(DISTRIBUTED_VECTOR%DATA_TYPE==MATRIX_VECTOR_INTG_TYPE) THEN
          ...
          CASE DEFAULT
            LOCAL_ERROR="The distributed vector library type of "// &
              & TRIM(NumberToVString(DISTRIBUTED_VECTOR%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          END SELECT
        ELSE
          LOCAL_ERROR="The data type of "//TRIM(NumberToVString(DISTRIBUTED_VECTOR%DATA_TYPE,"*",ERR,ERROR))// &
    ...
    EXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_ALL_VALUES_SET_SP(DISTRIBUTED_VECTOR,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_ALL_VALUES_SET_DP(DISTRIBUTED_VECTOR,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_ALL_VALUES_SET_L(DISTRIBUTED_VECTOR,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_ALL_VALUES_SET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_COPY_INTG(FROM_VECTOR,TO_VECTOR,ALPHA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_COPY_INTG",ERR,ERROR,*999)
          ...
          IF(TO_VECTOR%VECTOR_FINISHED) THEN
            IF(FROM_VECTOR%DATA_TYPE==TO_VECTOR%DATA_TYPE) THEN
              IF(FROM_VECTOR%DATA_TYPE==DISTRIBUTED_MATRIX_VECTOR_INTG_TYPE) THEN
                IF(FROM_VECTOR%LIBRARY_TYPE==TO_VECTOR%LIBRARY_TYPE) THEN
                  ...
                  CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
                    IF(ASSOCIATED(FROM_VECTOR%CMISS)) THEN
                      ...
                      ENDIF
                    ELSE
                      CALL FlagError("From vector CMISS is not associated.",ERR,ERROR,*999)
                    ENDIF
                  CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
                  ...
                  CASE DEFAULT
                    LOCAL_ERROR="The from vector library type of "// &
                      & TRIM(NumberToVString(FROM_VECTOR%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
                    CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
                  END SELECT
                ELSE
                ...
                ENDIF
              ELSE
                LOCAL_ERROR="The from vector data type of "//TRIM(NumberToVString(FROM_VECTOR%DATA_TYPE,"*",ERR,ERROR))// &
                  & " does not match the integer data type of the supplied alpha value."
                CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
              ENDIF
            ELSE
              LOCAL_ERROR="The from vector data type of "// &
                & TRIM(NumberToVString(FROM_VECTOR%DATA_TYPE,"*",ERR,ERROR))// &
                & " does not match the to vector data type of "// &
                & TRIM(NumberToVString(TO_VECTOR%DATA_TYPE,"*",ERR,ERROR))//"."
              CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
            ENDIF
          ELSE
            CALL FlagError("To vector has not been finished.",ERR,ERROR,*999)
          ENDIF
        ELSE
          CALL FlagError("To vector is not associated.",ERR,ERROR,*999)
        ENDIF
      ELSE
        CALL FlagError("From vector has not been finished.",ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FlagError("From vector is not associated.",ERR,ERROR,*999)
    ENDIF
     
    EXITS("DISTRIBUTED_VECTOR_COPY_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_COPY_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_COPY_DP(FROM_VECTOR,TO_VECTOR,ALPHA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_COPY_DP",ERR,ERROR,*999)
                  ...
                  CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
                    IF(ASSOCIATED(FROM_VECTOR%PETSC)) THEN
                      IF(ASSOCIATED(TO_VECTOR%PETSC)) THEN
                        ...
                        ENDIF
                      ELSE
                        CALL FlagError("To vector PETSc is not associated.",ERR,ERROR,*999)
                      ENDIF
                    ELSE
                      CALL FlagError("From vector PETSc is not associated.",ERR,ERROR,*999)
                    ENDIF
                  CASE DEFAULT
                    LOCAL_ERROR="The from vector library type of "// &
                      & TRIM(NumberToVString(FROM_VECTOR%LIBRARY_TYPE,"*",ERR,ERROR))//" is invalid."
    ...
    EXITS("DISTRIBUTED_VECTOR_COPY_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_COPY_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_COPY_SP(FROM_VECTOR,TO_VECTOR,ALPHA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_COPY_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_COPY_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_COPY_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_COPY_L(FROM_VECTOR,TO_VECTOR,ALPHA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_COPY_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_COPY_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_COPY_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CMISS_FINALISE(CMISS_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CMISS_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_CMISS_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_CMISS_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CMISS_INITIALISE(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CMISS_INITIALISE",ERR,ERROR,*998)
    ...
    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
        ...
        IF(ASSOCIATED(DISTRIBUTED_VECTOR%DOMAIN_MAPPING)) THEN
          ...
          CASE DEFAULT
            LOCAL_ERROR="The distributed vector ghosting type of "// &
              & TRIM(NumberToVString(DISTRIBUTED_VECTOR%GHOSTING_TYPE,"*",ERR,ERROR))//" is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          END SELECT         
      ...
      ENDIF
    ELSE
      CALL FlagError("Distributed vector is not associated.",ERR,ERROR,*998)
    ENDIF
    
    EXITS("DISTRIBUTED_VECTOR_CMISS_INITIALISE")
    RETURN
...
998 ERRORSEXITS("DISTRIBUTED_VECTOR_CMISS_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CMISS_CREATE_FINISH(CMISS_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CMISS_CREATE_FINISH",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(CMISS_VECTOR)) THEN
      ...
      IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
        ...
        IF(ASSOCIATED(DOMAIN_MAPPING)) THEN
          ...
          ENDIF
        ELSE
          CALL FlagError("CMISS vector distributed vector domain mapping is not associated.",ERR,ERROR,*999)
        ENDIF
      ELSE
        CALL FlagError("CMISS vector distributed vector is not associated.",ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FlagError("CMISS vector is not associated.",ERR,ERROR,*999)
    ENDIF
    
    EXITS("DISTRIBUTED_VECTOR_CMISS_CREATE_FINISH")
    RETURN
999 CALL DISTRIBUTED_VECTOR_CMISS_FINALISE(CMISS_VECTOR,DUMMY_ERR,DUMMY_ERROR,*998)      
998 ERRORSEXITS("DISTRIBUTED_VECTOR_CMISS_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CREATE_FINISH(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CREATE_FINISH",ERR,ERROR,*999)

    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        CALL FlagError("The distributed vector has already been finished.",ERR,ERROR,*999)
      ELSE
        SELECT CASE(DISTRIBUTED_VECTOR%LIBRARY_TYPE)
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_VECTOR%CMISS)) THEN
    ...
    EXITS("DISTRIBUTED_VECTOR_CREATE_FINISH")
    RETURN
...
998 ERRORSEXITS("DISTRIBUTED_VECTOR_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CREATE_START(DOMAIN_MAPPING,DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CREATE_START",ERR,ERROR,*998)

    IF(ASSOCIATED(DOMAIN_MAPPING)) THEN
      IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
        CALL FlagError("Distributed vector is already associated.",ERR,ERROR,*998)
      ELSE
        CALL DISTRIBUTED_VECTOR_INITIALISE(DOMAIN_MAPPING,DISTRIBUTED_VECTOR,ERR,ERROR,*999)
        !Set the default values
      ENDIF
    ELSE
      CALL FlagError("Domain mapping is not associated.",ERR,ERROR,*998)
    ENDIF
    
    EXITS("DISTRIBUTED_VECTOR_CREATE_START")
    RETURN
999 CALL DISTRIBUTED_VECTOR_FINALISE(DISTRIBUTED_VECTOR,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_VECTOR_CREATE_START",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DistributedVector_DataTypeGet",err,error)
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_TYPE_SET(DISTRIBUTED_VECTOR,DATA_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_TYPE_SET",ERR,ERROR,*999)

    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        CALL FlagError("The distributed vector has been finished.",ERR,ERROR,*999)
      ELSE
        SELECT CASE(DISTRIBUTED_VECTOR%LIBRARY_TYPE)
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          SELECT CASE(DATA_TYPE)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_TYPE_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DESTROY(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DESTROY")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DESTROY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DUPLICATE(DISTRIBUTED_VECTOR,NEW_DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DUPLICATE",ERR,ERROR,*998)

    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(ASSOCIATED(NEW_DISTRIBUTED_VECTOR)) THEN
        CALL FlagError("New distributed vector is already associated.",ERR,ERROR,*998)
      ELSE
    ...
    EXITS("DISTRIBUTED_VECTOR_DUPLICATE")
    RETURN
999 CALL DISTRIBUTED_VECTOR_FINALISE(NEW_DISTRIBUTED_VECTOR,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_VECTOR_DUPLICATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_FINALISE(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_INITIALISE(DOMAIN_MAPPING,DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("DISTRIBUTED_VECTOR_INITIALISE")
    RETURN
999 CALL DISTRIBUTED_VECTOR_FINALISE(DISTRIBUTED_VECTOR,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_VECTOR_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_GET_INTG(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_GET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_GET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_GET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_GET_SP(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_GET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_GET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_GET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_GET_DP(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_GET_DP",ERR,ERROR,*999)
        ...
        IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
          IF(DISTRIBUTED_VECTOR%DATA_TYPE==MATRIX_VECTOR_DP_TYPE) THEN
            ...
            CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
              IF(ASSOCIATED(DISTRIBUTED_VECTOR%PETSC)) THEN
                IF(DISTRIBUTED_VECTOR%PETSC%USE_OVERRIDE_VECTOR) THEN
                  CALL Petsc_VecGetArrayReadF90(DISTRIBUTED_VECTOR%PETSC%OVERRIDE_VECTOR,DATA,ERR,ERROR,*999)
                ELSE
                  CALL Petsc_VecGetArrayReadF90(DISTRIBUTED_VECTOR%PETSC%VECTOR,DATA,ERR,ERROR,*999)
                ENDIF
              ELSE
                CALL FlagError("Distributed vector PETSc is not associated.",ERR,ERROR,*999)
              ENDIF
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_GET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_GET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_GET_L(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_GET_L",ERR,ERROR,*999)
      ...
      ELSE
        ...
        IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
          IF(DISTRIBUTED_VECTOR%DATA_TYPE==MATRIX_VECTOR_L_TYPE) THEN
            ...
            END SELECT
          ELSE
            LOCAL_ERROR="The distributed data type of "//TRIM(NumberToVString(DISTRIBUTED_VECTOR%DATA_TYPE,"*",ERR,ERROR))// &
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_GET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_GET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_RESTORE_INTG(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_RESTORE_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_RESTORE_SP(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_RESTORE_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_RESTORE_DP(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_RESTORE_DP",ERR,ERROR,*999)
      ...
      IF(ASSOCIATED(DATA)) THEN
        IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
          ...
          CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
            IF(ASSOCIATED(DISTRIBUTED_VECTOR%PETSC)) THEN
              IF(DISTRIBUTED_VECTOR%PETSC%USE_OVERRIDE_VECTOR) THEN
                CALL Petsc_VecRestoreArrayReadF90(DISTRIBUTED_VECTOR%PETSC%OVERRIDE_VECTOR,DATA,ERR,ERROR,*999)
              ELSE
                CALL Petsc_VecRestoreArrayReadF90(DISTRIBUTED_VECTOR%PETSC%VECTOR,DATA,ERR,ERROR,*999)
              ENDIF
            ELSE
              CALL FlagError("Distributed vector PETSc is not associated.",ERR,ERROR,*999)
            ENDIF
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_DATA_RESTORE_L(DISTRIBUTED_VECTOR,DATA,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_DATA_RESTORE_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_DATA_RESTORE_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_GHOSTING_TYPE_SET(DISTRIBUTED_VECTOR,GHOSTING_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_GHOSTING_TYPE_SET",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      ...
      ELSE
        ...
        ELSE
          CALL FlagError("Distributed vector domain mapping is not associated.",ERR,ERROR,*999)
        ENDIF
      ENDIF
    ELSE
      CALL FlagError("Distributed vector is not associated.",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_GHOSTING_TYPE_SET")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_GHOSTING_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_LIBRARY_TYPE_SET(DISTRIBUTED_VECTOR,LIBRARY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_LIBRARY_TYPE_SET",ERR,ERROR,*998)

    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        CALL FlagError("The distributed vector has already been finished.",ERR,ERROR,*998)
      ELSE
        ...
        IF(LIBRARY_TYPE/=OLD_LIBRARY_TYPE) THEN
          ...
          CASE DEFAULT
            LOCAL_ERROR="The distributed vector library type of "//TRIM(NumberToVString(LIBRARY_TYPE,"*",ERR,ERROR))// &
              & " is invalid."
            CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
          END SELECT
          !Finalise the old library type
    ...
    EXITS("DISTRIBUTED_VECTOR_LIBRARY_TYPE_SET")
    RETURN
999 SELECT CASE(LIBRARY_TYPE)
    CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
      CALL DISTRIBUTED_VECTOR_CMISS_FINALISE(DISTRIBUTED_VECTOR%CMISS,DUMMY_ERR,DUMMY_ERROR,*998)
    ...
    END SELECT
998 ERRORSEXITS("DISTRIBUTED_VECTOR_LIBRARY_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_OUTPUT(ID,DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_OUTPUT",ERR,ERROR,*999)
      ...
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_VECTOR%PETSC)) THEN
            NULLIFY(VECTOR)
            IF(DISTRIBUTED_VECTOR%PETSC%USE_OVERRIDE_VECTOR) THEN
              CALL Petsc_VecGetArrayReadF90(DISTRIBUTED_VECTOR%PETSC%OVERRIDE_VECTOR,VECTOR,ERR,ERROR,*999)
            ELSE              
              CALL Petsc_VecGetArrayReadF90(DISTRIBUTED_VECTOR%PETSC%VECTOR,VECTOR,ERR,ERROR,*999)
            ENDIF
            CALL WRITE_STRING_VECTOR(ID,1,1,DISTRIBUTED_VECTOR%PETSC%N,8,8,VECTOR, &
              & '("Vector(:)          :",8(X,E13.6))','(20X,8(X,E13.6))',ERR,ERROR,*999)
            IF(DISTRIBUTED_VECTOR%PETSC%USE_OVERRIDE_VECTOR) THEN
              CALL Petsc_VecRestoreArrayReadF90(DISTRIBUTED_VECTOR%PETSC%OVERRIDE_VECTOR,VECTOR,ERR,ERROR,*999)
            ELSE              
              CALL Petsc_VecRestoreArrayReadF90(DISTRIBUTED_VECTOR%PETSC%VECTOR,VECTOR,ERR,ERROR,*999)
            ENDIF
          ELSE
            CALL FlagError("Distributed vector PETSc is not associated.",ERR,ERROR,*999)
          ENDIF
    ...
    EXITS("DISTRIBUTED_VECTOR_OUTPUT")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_OUTPUT",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_OVERRIDE_SET_ON(DISTRIBUTED_VECTOR,OVERRIDE_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_OVERRIDE_SET_ON",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_OVERRIDE_SET_ON")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_OVERRIDE_SET_ON",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_OVERRIDE_SET_OFF(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_OVERRIDE_SET_OFF",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_OVERRIDE_SET_OFF")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_OVERRIDE_SET_OFF",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_PETSC_CREATE_FINISH(PETSC_VECTOR,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PETSC_VECTOR)) THEN
      ...
      ENDIF
    ELSE
      CALL FlagError("PETSc vector is not associated.",ERR,ERROR,*998)
    ENDIF
...
998 ERRORSEXITS("DISTRIBUTED_VECTOR_PETSC_CREATE_FINISH",ERR,ERROR)
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_PETSC_FINALISE(PETSC_VECTOR,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_VECTOR_PETSC_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_PETSC_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_PETSC_INITIALISE(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_PETSC_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("DISTRIBUTED_VECTOR_PETSC_INITIALISE")
    RETURN
999 IF(ASSOCIATED(DISTRIBUTED_VECTOR%PETSC)) &
      & CALL DISTRIBUTED_VECTOR_PETSC_FINALISE(DISTRIBUTED_VECTOR%PETSC,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("DISTRIBUTED_VECTOR_PETSC_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_CMISS_TRANSFER_FINALISE(CMISS_VECTOR,domain_idx,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_CMISS_TRANSFER_FINALISE",ERR,ERROR,*999)
      ...
      IF(ALLOCATED(CMISS_VECTOR%TRANSFERS)) THEN
        ...
        ELSE
          LOCAL_ERROR="The domain index of "//TRIM(NumberToVString(domain_idx,"*",ERR,ERROR))// &
            & " is invalid. It must be between 1 and "//TRIM(NumberToVString(SIZE(CMISS_VECTOR%TRANSFERS,1),"*",ERR,ERROR))//"."
          CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
        ENDIF
      ENDIF
    ENDIF
    
    EXITS("DISTRIBUTED_VECTOR_CMISS_TRANSFER_FINALISE")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_CMISS_TRANSFER_FINALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DistributedVector_CmissTransferInitialise",ERR,ERROR)
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_UPDATE_FINISH(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_VECTOR_UPDATE_FINISH")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_UPDATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_UPDATE_ISFINISHED(DISTRIBUTED_VECTOR,ISFINISHED,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_UPDATE_ISFINISHED",ERR,ERROR,*999)
...
!!TODO: USE MPI_TESTALL and store the request handles as big array.
    ...
    EXITS("DISTRIBUTED_VECTOR_UPDATE_ISFINISHED")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_UPDATE_ISFINISHED",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_UPDATE_WAITFINISHED(DISTRIBUTED_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_UPDATE_WAITFINISHED",ERR,ERROR,*999)
...
!!TODO: USE MPI_WAITALL and store the request handles as big array.
    ...
    EXITS("DISTRIBUTED_VECTOR_UPDATE_WAITFINISHED")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_UPDATE_WAITFINISHED",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_UPDATE_START(DISTRIBUTED_VECTOR,ERR,ERROR,*)
        ...
        CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
          IF(ASSOCIATED(DISTRIBUTED_VECTOR%CMISS)) THEN
            IF(ASSOCIATED(DISTRIBUTED_VECTOR%DOMAIN_MAPPING)) THEN
              ...
              ENDIF
            ELSE
              CALL FlagError("Domain mapping is not associated for the distributed vector.",ERR,ERROR,*999)
            ENDIF
          ELSE
            CALL FlagError("Distributed vector CMISS is not associated.",ERR,ERROR,*999)
          ENDIF
    ...
    EXITS("DISTRIBUTED_VECTOR_UPDATE_START")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_UPDATE_START",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DistributedVector_L2Norm",err,error)
  ...
  SUBROUTINE DistributedVector_VecDotIntg(distributedVectorA,distributedVectorB,dotProduct,err,error,*)
            ...
            CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
              IF(ASSOCIATED(distributedVectorA%CMISS)) THEN
                IF(distributedVectorA%CMISS%DATA_SIZE==distributedVectorB%CMISS%DATA_SIZE) THEN
                  ...
                  ENDIF
                ELSE
                  CALL FlagError("The distributed vectors do not have the same size.",err,error,*999)
                ENDIF
              ELSE
                CALL FlagError("Distributed vector CMISS is not associated.",err,error,*999)
              ENDIF
            CASE(DISTRIBUTED_MATRIX_VECTOR_PETSC_TYPE)
              CALL FlagError("Distributed vector PETSC is double-precision, output scalar should be DP",err,error,*999)
            CASE DEFAULT
              localError="The distributed vector library type of "// &
                & TRIM(NumberToVString(distributedVectorA%LIBRARY_TYPE,"*",err,error))//" is invalid."
              CALL FlagError(localError,err,error,*999)
            END SELECT
          ELSE
            CALL FlagError("The distributed vectors do not have the same data type.",err,error,*999)
          ENDIF
        ELSE
          CALL FlagError("The distributed vectors do not have the same library type.",err,error,*999)
        ENDIF
      ELSE
        CALL FlagError("The distributed vector has not been finished.",err,error,*999)
      ENDIF
    ...
    EXITS("DistributedVector_VecDotIntg")
    RETURN
999 ERRORSEXITS("DistributedVector_VecDotIntg",err,error)
    RETURN 1
  ...
  SUBROUTINE DistributedVector_VecDotSp(distributedVectorA,distributedVectorB,dotProduct,err,error,*)
    ...
    EXITS("DistributedVector_VecDotSp")
    RETURN
999 ERRORSEXITS("DistributedVector_VecDotSp",err,error)
  ...
  SUBROUTINE DistributedVector_VecDotDp(distributedVectorA,distributedVectorB,dotProduct,err,error,*)
    ...
    EXITS("DistributedVector_VecDotDp")
    RETURN
999 ERRORSEXITS("DistributedVector_VecDotDp",err,error)
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_INTG(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(DISTRIBUTED_VECTOR)) THEN
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        IF(SIZE(INDICES,1)==SIZE(VALUES,1)) THEN
          ...
          ENDIF
        ELSE
          LOCAL_ERROR="The size of the indicies array ("//TRIM(NumberToVString(SIZE(INDICES,1),"*",ERR,ERROR))// &
            & ") does not conform to the size of the values array ("//TRIM(NumberToVString(SIZE(VALUES,1),"*",ERR,ERROR))//")."
          CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
        ENDIF
      ELSE
        CALL FlagError("The distributed vector has not been finished.",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_INTG1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG1",ERR,ERROR,*999)
        ...
        IF(DISTRIBUTED_VECTOR%DATA_TYPE==MATRIX_VECTOR_INTG_TYPE) THEN
          ...
          CASE(DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE)
            IF(ASSOCIATED(DISTRIBUTED_VECTOR%CMISS)) THEN
              ...
              ELSE
                LOCAL_ERROR="Index "//TRIM(NumberToVString(INDEX,"*",ERR,ERROR))// &
                  & " is invalid. The index must be between 1 and "// &
                  & TRIM(NumberToVString(DISTRIBUTED_VECTOR%CMISS%DATA_SIZE,"*",ERR,ERROR))//"."
                CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
              ENDIF
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_SP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_SP",ERR,ERROR,*999)
      ...
      IF(DISTRIBUTED_VECTOR%VECTOR_FINISHED) THEN
        IF(SIZE(INDICES,1)==SIZE(VALUES,1)) THEN
         ...
         ELSE
          ...
          ENDIF
        ELSE
          LOCAL_ERROR="The size of the indices array ("//TRIM(NumberToVString(SIZE(INDICES,1),"*",ERR,ERROR))// &
            & ") does not conform to the size of the values array ("//TRIM(NumberToVString(SIZE(VALUES,1),"*",ERR,ERROR))//")."
          CALL FlagError(LOCAL_ERROR,ERR,ERROR,*999)
        ENDIF
      ELSE
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_SP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_DP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_DP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_DP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_L(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_ADD_L1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_ADD_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_ADD_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_ADD_L1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_INTG(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_INTG1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_INTG1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_SP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_SP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_DP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_DP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_DP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_L(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_GET_L1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_GET_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_GET_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_GET_L1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_INTG(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_INTG",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_INTG")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_INTG",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_INTG1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_INTG1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_INTG1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_INTG1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_SP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_SP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_SP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_SP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_SP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_SP1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_SP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_SP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_DP(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_DP",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_DP")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_DP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_DP1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_DP1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_DP1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_L(DISTRIBUTED_VECTOR,INDICES,VALUES,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_L",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_L")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_L",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DISTRIBUTED_VECTOR_VALUES_SET_L1(DISTRIBUTED_VECTOR,INDEX,VALUE,ERR,ERROR,*)
    ...
    ENTERS("DISTRIBUTED_VECTOR_VALUES_SET_L1",ERR,ERROR,*999)
    ...
    EXITS("DISTRIBUTED_VECTOR_VALUES_SET_L1")
    RETURN
999 ERRORSEXITS("DISTRIBUTED_VECTOR_VALUES_SET_L1",ERR,ERROR)
    RETURN 1
