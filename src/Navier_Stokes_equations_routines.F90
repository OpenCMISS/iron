...
!
  ...
  SUBROUTINE NavierStokes_EquationsSetSetup(equationsSet,equationsSetSetup,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: geometricScalingType,geometricMeshComponent,independentFieldNumberOfComponents
    INTEGER(INTG) :: numberOfAnalyticComponents,dependentFieldNumberOfComponents
    INTEGER(INTG) :: numberOfDimensions,geometricComponentNumber,componentIdx
    INTEGER(INTG) :: materialsFieldNumberOfComponents1,materialsFieldNumberOfComponents2
    ...
    CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_CreateStart(equationsSetSetup%fieldUserNumber,equationsSet%region, &
                & equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,err,error,*999)
              CALL Field_LabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,"Equations Set Field",err,error,*999)
              CALL Field_TypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_GENERAL_TYPE, &
                & err,error,*999)
              CALL Field_NumberOfVariablesSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,1,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                & [FIELD_U_VARIABLE_TYPE],err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                & FIELD_U_VARIABLE_TYPE,"Penalty Coefficient",err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                & FIELD_U_VARIABLE_TYPE,FIELD_DP_TYPE,err,error,*999)
              CALL Field_NumberOfComponentsSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,&
                & FIELD_U_VARIABLE_TYPE,1,err,error,*999)
            ENDIF
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
              CALL Field_CreateFinish(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,err,error,*999)
              !Default the penalty coefficient value to 1E4
              CALL Field_ComponentValuesInitialise(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
        ...
        CASE(EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_CreateStart(equationsSetSetup%fieldUserNumber,equationsSet%region, &
                & equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,err,error,*999)
              CALL Field_LabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,"Equations Set Field", &
                & err,error,*999)
              CALL Field_TypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_GENERAL_TYPE,&
                & err,error,*999)
              CALL Field_NumberOfVariablesSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,3,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,&
                & [FIELD_U_VARIABLE_TYPE,FIELD_V_VARIABLE_TYPE,FIELD_U1_VARIABLE_TYPE],err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_U_VARIABLE_TYPE, &
                & "BoundaryFlow",err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                & "ElementMetrics",err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_U1_VARIABLE_TYPE, &
                & "EquationsConstants",err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_U_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,FIELD_U1_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_NumberOfComponentsSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,&
            ...
            ELSE
              localError="User-specified fields are not yet implemented for an equations set field field &
                & setup type of "//TRIM(NumberToVString(equationsSetSetup% &
        ...
        CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_DecompositionSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,&
                & geometricDecomposition,err,error,*999)
              CALL Field_GeometricFieldSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,&
                & equationsSet%geometry%geometricField,err,error,*999)
              ...
              CALL Field_ComponentMeshComponentSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                & FIELD_U_VARIABLE_TYPE,1,geometricComponentNumber,err,error,*999)
              CALL Field_ComponentInterpolationSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
              ...
              CALL Field_ScalingTypeSet(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD,geometricScalingType, &
                & err,error,*999)
            ENDIF
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ! do nothing
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
              ...
              DO componentIdx=1,elementBasedComponents
                CALL Field_ComponentMeshComponentSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                  & FIELD_V_VARIABLE_TYPE,componentIdx,geometricComponentNumber,err,error,*999)
                CALL Field_ComponentInterpolationSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
              ...
              DO componentIdx=1,constantBasedComponents
                CALL Field_ComponentMeshComponentSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                  & FIELD_U1_VARIABLE_TYPE,componentIdx,geometricComponentNumber,err,error,*999)
                CALL Field_ComponentInterpolationSetAndLock(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%dependent%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              NULLIFY(geometricDecomposition)
              CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition,err,error,*999)
              CALL Field_DecompositionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,geometricDecomposition,err,error,*999)
              ...
              IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                ...
                CALL Field_NumberOfVariablesSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,3,err,error,*999)
              ...
              ENDIF
              CALL Field_VariableLabelSet(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                & "U",err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%dependent%DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE, &
              ...
              dependentFieldNumberOfComponents=numberOfDimensions+1
              CALL Field_NumberOfComponentsSetAndLock(equationsSet%dependent%DEPENDENT_FIELD, &
              ...
              DO componentIdx=1,dependentFieldNumberOfComponents
                CALL Field_ComponentMeshComponentSet(equationsSet%dependent%DEPENDENT_FIELD, &
              ...
              IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE) THEN
                CALL Field_VariableLabelSet(equationsSet%dependent%DEPENDENT_FIELD,FIELD_W_VARIABLE_TYPE, &
                  & "Wss",err,error,*999)
                CALL Field_DimensionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_W_VARIABLE_TYPE, &
                  & FIELD_SCALAR_DIMENSION_TYPE,err,error,*999)
                CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_W_VARIABLE_TYPE, &
                  & FIELD_DP_TYPE,err,error,*999)
                CALL Field_NumberOfComponentsSetAndLock(equationsSet%dependent%DEPENDENT_FIELD, &
                  & FIELD_W_VARIABLE_TYPE,1,err,error,*999)
                CALL Field_ComponentMeshComponentSet(equationsSet%dependent%DEPENDENT_FIELD, &
                  & FIELD_W_VARIABLE_TYPE,1,geometricMeshComponent,err,error,*999)
              ENDIF
            ...
            ELSE
              ...
              IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                ...
                CALL Field_DimensionCheck(equationsSetSetup%field,FIELD_W_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE, &
                  & err,error,*999)
              ...
              CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                ...
                IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                  & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE) THEN
                  CALL Field_ComponentInterpolationCheck(equationsSetSetup%field,FIELD_W_VARIABLE_TYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%dependent%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_NumberOfComponentsGet(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                & dependentFieldNumberOfComponents,err,error,*999)
              IF(equationsSet%specification(3)==EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE) THEN
                CALL Field_ParameterSetCreate(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_PRESSURE_VALUES_SET_TYPE,err,error,*999)
                DO componentIdx=1,dependentFieldNumberOfComponents
                  CALL Field_ComponentValuesInitialise(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
        ...
        CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(equationsSet%dependent%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_NumberOfVariablesSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,5,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,[FIELD_U_VARIABLE_TYPE, &
              ...
              CALL Field_DimensionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DimensionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DimensionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DimensionSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U2_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              !set data type
              CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U2_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              ...
              CALL Field_ComponentMeshComponentGet(equationsSet%geometry%geometricField,FIELD_U_VARIABLE_TYPE, &
                & numberOfDimensions,geometricMeshComponent,err,error,*999)
              !Default to the geometric interpolation setup
              DO componentIdx=1,dependentFieldNumberOfComponents
                CALL Field_ComponentMeshComponentSet(equationsSet%dependent%DEPENDENT_FIELD, &
                  & FIELD_U_VARIABLE_TYPE,componentIdx,geometricMeshComponent,err,error,*999)
            ...
            !Specify finish action
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%dependent%DEPENDENT_FIELD_AUTO_CREATED) &
              & CALL Field_CreateFinish(equationsSet%dependent%DEPENDENT_FIELD,err,error,*999)              
          CASE DEFAULT
            localError="The action type of "//TRIM(NumberToVString(equationsSetSetup%ACTION_TYPE,"*", &
              & err,error))//" for a setup type of "//TRIM(NumberToVString(equationsSetSetup%SETUP_TYPE, &
        ...
        CASE(EQUATIONS_SET_COUPLED1D0D_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%dependent%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_NumberOfVariablesSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,5,err,error,*999)
              IF(equationsSet%specification(3)==EQUATIONS_SET_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE) THEN
                CALL Field_VariableTypesSetAndLock(equationsSet%dependent%DEPENDENT_FIELD,[FIELD_U_VARIABLE_TYPE, &
                  & FIELD_DELUDELN_VARIABLE_TYPE,FIELD_V_VARIABLE_TYPE,FIELD_U1_VARIABLE_TYPE,FIELD_U2_VARIABLE_TYPE, &
      ...
      CASE(EQUATIONS_SET_SETUP_INDEPENDENT_TYPE)
        ...
        CASE(EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%independent%INDEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_LabelSet(equationsSet%independent%INDEPENDENT_FIELD,"Independent Field",err,error,*999)
              ...
              NULLIFY(geometricDecomposition)
              CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition,err,error,*999)
              CALL Field_DecompositionSetAndLock(equationsSet%independent%INDEPENDENT_FIELD, &
                & geometricDecomposition,err,error,*999)
              ...
              CALL Field_NumberOfVariablesSetAndLock(equationsSet%independent%INDEPENDENT_FIELD,1,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%independent%INDEPENDENT_FIELD, &
                & [FIELD_U_VARIABLE_TYPE],err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%independent%INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                & "U",err,error,*999)
        ...
        CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            independentFieldNumberOfComponents=2
            !Create the auto created independent field
            IF(equationsSet%independent%INDEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_DependentTypeSetAndLock(equationsSet%INDEPENDENT%INDEPENDENT_FIELD,FIELD_INDEPENDENT_TYPE, &
                & err,error,*999)
              !look for decomposition rule already defined
              NULLIFY(geometricDecomposition)
              CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition,err,error,*999)
            ...
            !Specify finish action
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%independent%INDEPENDENT_FIELD_AUTO_CREATED) &
              & CALL Field_CreateFinish(equationsSet%independent%INDEPENDENT_FIELD,err,error,*999)
          CASE DEFAULT
            localError="The action type of "//TRIM(NumberToVString(equationsSetSetup%ACTION_TYPE,"*",err,error))// &
              & " for a setup type of "//TRIM(NumberToVString(equationsSetSetup%SETUP_TYPE,"*",err,error))// &
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_POISEUILLE)
              ...
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_POISEUILLE
              ...
              CALL Field_ComponentInterpolationCheck(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & 1,FIELD_CONSTANT_INTERPOLATION,err,error,*999)
              CALL Field_ComponentInterpolationCheck(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & 2,FIELD_CONSTANT_INTERPOLATION,err,error,*999)
              !Set analytic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=equationsSetSetup%ANALYTIC_FUNCTION_TYPE
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_FLOWRATE_AORTA, &
              ...
              IF(equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_COUPLED1D0D_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT1D_ADV_NAVIER_STOKES_SUBTYPE .OR. &
                & equationsSet%specification(3)==EQUATIONS_SET_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE) THEN
                !Set analytic function type
                equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=equationsSetSetup%ANALYTIC_FUNCTION_TYPE
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_TAYLOR_GREEN)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_TAYLOR_GREEN
              !Check that domain is 2D
              IF(numberOfDimensions/=2) THEN
                localError="The number of geometric dimensions of "// &
                  & TRIM(NumberToVString(numberOfDimensions,"*",err,error))// &
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_1)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_1
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_2)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_2
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_3)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_3
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_1)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_1
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_2)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_2
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_3)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_3
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_4)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_4
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_5)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_5
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_ONE_DIM_1)
              !Set analtyic function type
              equationsSet%analytic%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_ONE_DIM_1
            CASE DEFAULT
            ...
            IF(numberOfAnalyticComponents>=1) THEN
              IF(equationsSet%analytic%ANALYTIC_FIELD_AUTO_CREATED) THEN
                ...
                CALL Field_CreateStart(equationsSetSetup%fieldUserNumber,equationsSet%region, &
                  & equationsSet%analytic%ANALYTIC_FIELD,err,error,*999)
                CALL Field_LabelSet(equationsSet%analytic%ANALYTIC_FIELD,"Analytic Field",err,error,*999)
                CALL Field_TypeSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,FIELD_GENERAL_TYPE,err,error,*999)
                CALL Field_DependentTypeSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,FIELD_INDEPENDENT_TYPE, &
                  & err,error,*999)
                NULLIFY(geometricDecomposition)
                CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition,err,error,*999)
                CALL Field_DecompositionSetAndLock(equationsSet%analytic%ANALYTIC_FIELD, &
                  & geometricDecomposition,err,error,*999)
                CALL Field_GeometricFieldSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,equationsSet%geometry% &
                  & geometricField,err,error,*999)
                CALL Field_NumberOfVariablesSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,1,err,error,*999)
                CALL Field_VariableTypesSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,[FIELD_U_VARIABLE_TYPE], &
                  & err,error,*999)
                CALL Field_VariableLabelSet(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & "Analytic",err,error,*999)
                CALL Field_DimensionSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
                CALL Field_DataTypeSetAndLock(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_DP_TYPE,err,error,*999)
                !Set the number of analytic components
                CALL Field_NumberOfComponentsSetAndLock(equationsSet%analytic%ANALYTIC_FIELD, &
                  & FIELD_U_VARIABLE_TYPE,numberOfAnalyticComponents,err,error,*999)
                !Default the analytic components to the 1st geometric interpolation setup with constant interpolation
                CALL Field_ComponentMeshComponentGet(equationsSet%geometry%geometricField, &
                  & FIELD_U_VARIABLE_TYPE,1,geometricMeshComponent,err,error,*999)
                DO componentIdx=1,numberOfAnalyticComponents
                  CALL Field_ComponentMeshComponentSet(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & componentIdx,geometricMeshComponent,err,error,*999)
                  IF(equationsSetSetup%ANALYTIC_FUNCTION_TYPE == &
                    & EQUATIONS_SET_NAVIER_STOKES_EQUATION_SINUSOID) THEN
                    CALL Field_ComponentInterpolationSet(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                      & componentIdx,FIELD_NODE_BASED_INTERPOLATION,err,error,*999)
                  ELSE
                    CALL Field_ComponentInterpolationSet(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                ...
                !Default the field scaling to that of the geometric field
                CALL Field_ScalingTypeGet(equationsSet%geometry%geometricField,geometricScalingType,err,error,*999)
                CALL Field_ScalingTypeSet(equationsSet%analytic%ANALYTIC_FIELD,geometricScalingType,err,error,*999)
              ELSE
                !Check the user specified field
                CALL Field_TypeCheck(equationsSetSetup%field,FIELD_GENERAL_TYPE,err,error,*999)
                CALL Field_DependentTypeCheck(equationsSetSetup%field,FIELD_INDEPENDENT_TYPE,err,error,*999)
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            IF(equationsSet%analytic%ANALYTIC_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_CreateFinish(equationsSet%analytic%ANALYTIC_FIELD,err,error,*999)
              !Set the default values for the analytic field
              SELECT CASE(equationsSet%specification(3))
              CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
                & EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE)
                SELECT CASE(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE)
                CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_POISEUILLE)
                  !Default the analytic parameter values (L, H, U_mean, Pout) to 0.0
                  CALL Field_ComponentValuesInitialise(equationsSet%analytic%ANALYTIC_FIELD,FIELD_U_VARIABLE_TYPE, &
                ...
                CASE DEFAULT
                  localError="The analytic function type of "// &
                    & TRIM(NumberToVString(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE,"*",err,error))// &
      ...
      CASE(EQUATIONS_SET_SETUP_MATERIALS_TYPE)
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
          ...
          & EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE)
          materialsFieldNumberOfComponents1=2 !viscosity, density
          SELECT CASE(equationsSetSetup%ACTION_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_TypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_MATERIAL_TYPE,err,error,*999)
              !label the field
              CALL Field_LabelSet(equationsSet%materials%MATERIALS_FIELD,"Materials Field",err,error,*999)
              CALL Field_DependentTypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_INDEPENDENT_TYPE, &
                & err,error,*999)
              NULLIFY(geometricDecomposition)
              CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition, &
                & err,error,*999)
              !apply decomposition rule found on new created field
              CALL Field_DecompositionSetAndLock(equationsSet%materials%MATERIALS_FIELD, &
                & geometricDecomposition,err,error,*999)
              !point new field to geometric field
              CALL Field_GeometricFieldSetAndLock(equationsSet%materials%MATERIALS_FIELD,equationsSet%geometry% &
                & geometricField,err,error,*999)
              CALL Field_NumberOfVariablesSet(equationsSet%materials%MATERIALS_FIELD,1,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%materials%MATERIALS_FIELD, &
                & [FIELD_U_VARIABLE_TYPE],err,error,*999)
              CALL Field_VariableLabelSet(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & "Materials",err,error,*999)
              CALL Field_DimensionSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_NumberOfComponentsSetAndLock(equationsSet%materials%MATERIALS_FIELD, &
                & FIELD_U_VARIABLE_TYPE,materialsFieldNumberOfComponents1,err,error,*999)
              CALL Field_ComponentMeshComponentGet(equationsSet%geometry%geometricField, &
                & FIELD_U_VARIABLE_TYPE,1,geometricComponentNumber,err,error,*999)
              CALL Field_ComponentMeshComponentSet(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & 1,geometricComponentNumber,err,error,*999)
              CALL Field_ComponentInterpolationSet(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & 1,FIELD_CONSTANT_INTERPOLATION,err,error,*999)
              CALL Field_ComponentInterpolationSet(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & 2,FIELD_CONSTANT_INTERPOLATION,err,error,*999)
              !Default the field scaling to that of the geometric field
              CALL Field_ScalingTypeGet(equationsSet%geometry%geometricField,geometricScalingType, &
                & err,error,*999)
              CALL Field_ScalingTypeSet(equationsSet%materials%MATERIALS_FIELD,geometricScalingType,err,error,*999)
            ELSE
              !Check the user specified field
              ...
              CALL Field_DimensionCheck(equationsSetSetup%field,FIELD_U_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DataTypeCheck(equationsSetSetup%field,FIELD_U_VARIABLE_TYPE,FIELD_DP_TYPE, &
                & err,error,*999)
              CALL Field_NumberOfComponentsGet(equationsSet%geometry%geometricField,FIELD_U_VARIABLE_TYPE, &
                & numberOfDimensions,err,error,*999)
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_CreateFinish(equationsSet%materials%MATERIALS_FIELD,err,error,*999)
              !Set the default values for the materials field
              ! viscosity,density=1
              CALL Field_ComponentValuesInitialise(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
        ...
        CASE(EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE)
          materialsFieldNumberOfComponents1=2 !U_var (constant)  : viscosity scale, density
          materialsFieldNumberOfComponents2=2 !V_var (gaussBased): viscosity, shear rate
          SELECT CASE(equationsSetSetup%ACTION_TYPE)
            !Specify start action
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) THEN
              ...
              CALL Field_TypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_MATERIAL_TYPE,err,error,*999)
              !label the field
              CALL Field_LabelSet(equationsSet%materials%MATERIALS_FIELD,"MaterialsField",err,error,*999)
              CALL Field_DependentTypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_INDEPENDENT_TYPE, &
                & err,error,*999)
              NULLIFY(geometricDecomposition)
              CALL Field_DecompositionGet(equationsSet%geometry%geometricField,geometricDecomposition,err,error,*999)
              !apply decomposition rule found on new created field
              CALL Field_DecompositionSetAndLock(equationsSet%materials%MATERIALS_FIELD,geometricDecomposition,err,error,*999)
              !point new field to geometric field
              CALL Field_GeometricFieldSetAndLock(equationsSet%materials%MATERIALS_FIELD,equationsSet%geometry% &
                & geometricField,err,error,*999)
              CALL Field_NumberOfVariablesSet(equationsSet%materials%MATERIALS_FIELD,2,err,error,*999)
              CALL Field_VariableTypesSetAndLock(equationsSet%materials%MATERIALS_FIELD, &
              ...
              CALL Field_ComponentMeshComponentGet(equationsSet%geometry%geometricField, &
                & FIELD_U_VARIABLE_TYPE,1,geometricComponentNumber,err,error,*999)
              DO componentIdx=1,materialsFieldNumberOfComponents1
                CALL Field_ComponentMeshComponentSet(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
              ...
              CALL Field_VariableLabelSet(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                & "ConstitutiveValues",err,error,*999)
              CALL Field_DimensionSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                & FIELD_VECTOR_DIMENSION_TYPE,err,error,*999)
              CALL Field_DataTypeSetAndLock(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                & FIELD_DP_TYPE,err,error,*999)
              CALL Field_NumberOfComponentsSetAndLock(equationsSet%materials%MATERIALS_FIELD, &
                & FIELD_V_VARIABLE_TYPE,materialsFieldNumberOfComponents2,err,error,*999)
              CALL Field_ComponentMeshComponentGet(equationsSet%geometry%geometricField, &
                & FIELD_U_VARIABLE_TYPE,1,geometricComponentNumber,err,error,*999)
              DO componentIdx=1,materialsFieldNumberOfComponents2
                CALL Field_ComponentMeshComponentSet(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                  & componentIdx,geometricComponentNumber,err,error,*999)
                CALL Field_ComponentInterpolationSet(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) THEN
              ...
              DO componentIdx=1,materialsFieldNumberOfComponents2
                CALL Field_ComponentValuesInitialise(equationsSet%materials%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                  & FIELD_VALUES_SET_TYPE,componentIdx,1.0_DP,err,error,*999)
              ENDDO !componentIdx
            ENDIF
          CASE DEFAULT
        ...
        CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE, &
          ...
          materialsFieldNumberOfComponents1=8 !(MU,RHO,alpha,pressureExternal,LengthScale,TimeScale,MassScale)
          materialsFieldNumberOfComponents2=3 !(A0,E,H0)
          SELECT CASE(equationsSetSetup%ACTION_TYPE)
            !Specify start action
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) THEN
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            !Finish creating the materials field
            IF(equationsSet%materials%MATERIALS_FIELD_AUTO_CREATED) &
              & CALL Field_CreateFinish(equationsSet%materials%MATERIALS_FIELD,err,error,*999)
          CASE DEFAULT
            localError="The action type of "//TRIM(NumberToVString(equationsSetSetup%ACTION_TYPE,"*", &
              & err,error))//" for a setup type of "//TRIM(NumberToVString(equationsSetSetup%SETUP_TYPE,"*", &
...
999 ERRORSEXITS("NavierStokes_EquationsSetSetup",err,error)
  ...
  SUBROUTINE NavierStokes_PreSolve(solver,err,error,*)
    ...
    !Local Variables
    INTEGER(INTG) :: equationsSetIdx,iterationNumber,maxIterations,solverMatrixIdx
    ...
    IF(SIZE(controlLoop%problem%specification,1)<3) &
      ...
      CASE(PROBLEM_MULTISCALE_NAVIER_STOKES_SUBTYPE, &
        ...
        CASE(SOLVER_DYNAMIC_TYPE)
          ...
          DO equationsSetIdx=1,solverMapping%NUMBER_OF_EQUATIONS_SETS
            ...
            CASE DEFAULT
              localError="Equations set subtype "//TRIM(NumberToVString(equationsSet%specification(3),"*", &
        ...
        CASE(SOLVER_NONLINEAR_TYPE)
          ...
          IF(iterationNumber == 1) THEN
            ...
            IF(.NOT.ASSOCIATED(upwindParameterSet)) &
              & CALL Field_ParameterSetCreate(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_UPWIND_VALUES_SET_TYPE, &
              & err,error,*999)
    ...
    CASE(PROBLEM_MULTI_PHYSICS_CLASS)
      ...
      END SELECT
    CASE DEFAULT
      localError="Problem class "//TRIM(NumberToVString(controlLoop%PROBLEM%specification(1),"*",err,error))// &
...
999 ERRORSEXITS("NavierStokes_ProblemSetup",err,error)
  ...
  SUBROUTINE NavierStokes_FiniteElementResidualEvaluate(equationsSet,elementNumber,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: columnComponentIdx,columnElementDOFIdx,columnElementParameterIdx,columnMeshComponent,columnXiIdx, &
      & componentIdx,coordinateIdx,derivativeIdx,elementVersionNumber,firstNode,gaussPointIdx,lastNode,maxColumnElementDOFIdx, &
      & minColumnElementDOFIdx,maxRowElementDOFIdx,minRowElementDOFIdx,nodeNumber,nodeIdx,numberOfDimensions, &
      & numberOfElementNodes,numberOfParameters,numberOfVersions,residualVariableType,rowComponentIdx,rowElementDOFIdx, &
      & rowElementParameterIdx,rowMeshComponent,rowXiIdx,versionIdx,xiIdx    
    REAL(DP) :: aDeriv,a0Deriv,a0Param,alpha,area,AUpwind,aValue,beta,columnPhi,dColumnPhidXi(3),dRowPhidXi(3),dXidX(3,3), &
      & eDeriv,eParam,g0Param,hDeriv,hParam,jacobianGaussWeight,kappa,Lref,mass,momentum,Mref,muParam,muScale,normal, &
      & normalWave,pExternal,pressure,qDeriv,QUpwind,qValue,rhoParam,rowPhi,sum,Tref,uDeriv(3,3),uValue(3),wValue(3),x(3)
    ...
    TYPE(QuadratureSchemeType), POINTER :: columnQuadratureScheme,quadratureScheme,rowQuadratureScheme
    TYPE(VARYING_STRING) :: localError
    ...
    CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
      ...
      NULLIFY(dependentField)
      CALL EquationsInterpolation_DependentFieldGet(interpolation,dependentField,err,error,*999)
      NULLIFY(geometricField)
      CALL EquationsInterpolation_GeometricFieldGet(interpolation,geometricField,err,error,*999)
      NULLIFY(materialsField)
      CALL EquationsInterpolation_MaterialsFieldGet(interpolation,materialsField,err,error,*999)
      ...
      CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
        ...
        !! WHY ARE WE INITIALISING MATRICES HERE. ALSO WHY CHECK STIFFNESS AND NONLINEAR MATRICES. IF WE DONT HAVE THEM WE SHOULDN'T BE HERE. 
      ...
      CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_COUPLED1D0D_NAVIER_STOKES_SUBTYPE, &
        ...
        CALL EquationsInterpolation_MaterialsParametersGet(interpolation,FIELD_V_VARIABLE_TYPE,vMaterialsInterpParameters, &
          & err,error,*999)
      ...
      CASE(EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE, &
        ...
        CALL EquationsInterpolation_IndependentFieldGet(interpolation,independentField,err,error,*999)
        ...
        CALL EquationsInterpolation_IndependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE,independentInterpPoint, &
          & err,error,*999)        
      ...
      CALL EquationsInterpolation_DependentParametersGet(interpolation,residualVariableType,dependentInterpParameters, &
        & err,error,*999)
      NULLIFY(dependentInterpPoint)
      CALL EquationsInterpolation_DependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE,dependentInterpPoint,err,error,*999)
      ...
      CALL EquationsInterpolation_MaterialsParametersGet(interpolation,FIELD_U_VARIABLE_TYPE,uMaterialsInterpParameters, &
        & err,error,*999)
      NULLIFY(uMaterialsInterpPoint)
      CALL EquationsInterpolation_MaterialsPointGet(interpolation,FIELD_U_VARIABLE_TYPE,uMaterialsInterpPoint,err,error,*999)
      ...
      DO gaussPointIdx=1,quadratureScheme%numberOfGauss
        ...
        IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_PGM_NAVIER_STOKES_SUBTYPE) THEN
          ...
          IF(numberOfDimensions==3) wValue(3)=independentInterpPoint%values(3,NO_PART_DERIV)
        ELSE
          wValue=0.0_DP
        ENDIF
        ...
        IF(equationsSet%specification(3)==EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_QUASISTATIC_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_PGM_NAVIER_STOKES_SUBTYPE) THEN
          ...
          DO rowComponentIdx=1,numberOfDimensions
            ...
            DO rowElementParameterIdx=1,rowBasis%numberOfElementParameters
              ...
              IF(updateStiffnessMatrix.OR.updateDampingMatrix) THEN
                ...
                DO columnComponentIdx=1,residualVariable%numberOfComponents
                  ...
                  DO columnElementParameterIdx=1,columnBasis%numberOfElementParameters
                    ...
                    DO xiIdx=1,rowBasis%numberOfXi
                      DO coordinateIdx=1,numberOfDimensions
                        dXidX(xiIdx,coordinateIdx)=geometricInterpPointMetrics%dXidX(xiIdx,coordinateIdx)
                      ENDDO !coordinateIdx
                      dRowPhidXi(xiIdx)=rowQuadratureScheme% &
                        & gaussBasisFunctions(rowElementParameterIdx,PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(xiIdx),gaussPointIdx)
                      dColumnPhidXi(xiIdx)=columnQuadratureScheme%gaussBasisFunctions(columnElementParameterIdx, &
                        & PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(xiIdx),gaussPointIdx)
                    ENDDO !xiIdx
                    rowPhi=rowQuadratureScheme%gaussBasisFunctions(rowElementParameterIdx,NO_PART_DERIV,gaussPointIdx)
                    columnPhi=columnQuadratureScheme%gaussBasisFunctions(columnElementParameterIdx,NO_PART_DERIV,gaussPointIdx)
                    !Laplace only matrix
                    IF(updateStiffnessMatrix) THEN
                      ...
                      IF(columnComponentIdx==rowComponentIdx) THEN
                        ...
                        !Calculate sum
                        DO coordinateIdx=1,numberOfDimensions
                          DO rowXiIdx=1,rowBasis%numberOfXi
                            DO columnXiIdx=1,columnBasis%numberOfXi
                    ...
                    IF(updateStiffnessMatrix) THEN
                      ...
                      IF(equationsSet%specification(3)/=EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE) THEN
                        IF(columnComponentIdx<residualVariable%numberOfComponents) THEN
                          sum=0.0_DP
                          !Calculate sum
                          DO rowXiIdx=1,rowBasis%numberOfXi
                            DO columnXiIdx=1,columnBasis%numberOfXi
                    ...
                    IF(updateStiffnessMatrix) THEN
                      ...
                      IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                        ...
                        IF(columnComponentIdx==rowComponentIdx) THEN
                          ...
                          !Calculate sum
                          DO coordinateIdx=1,numberOfDimensions
                            DO xiIdx=1,columnBasis%numberOfXi
                    ...
                    ENDIF
                    !Damping matrix
                    IF(equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_NAVIER_STOKES_SUBTYPE.OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE.OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE.OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_PGM_NAVIER_STOKES_SUBTYPE.OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE.OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE .OR. &
                      & equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
          ...
          IF(rhsVector%firstAssembly) THEN
            IF(updateRHSVector) THEN
              IF(ASSOCIATED(equationsSet%analytic)) THEN
                IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_1.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_2.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_3.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_ONE_DIM_1.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_1.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_2.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_3.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_4.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_5) THEN
                  rowElementDOFIdx=0
                  DO rowComponentIdx=1,numberOfDimensions
                    CALL FieldVariable_ComponentMeshComponentGet(residualVariable,rowComponentIdx,rowMeshComponent,err,error,*999)
                    NULLIFY(rowDomain)
                    ...
                    DO rowElementParameterIdx=1,rowBasis%numberOfElementParameters
                      ...
                      IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_1) THEN
                        ...
                        ENDIF
                      ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_2) &
                        & THEN
                        IF(rowComponentIdx==1) THEN
                          !Calculate sum
                          sum=0.0_DP
                        ...
                        ENDIF
                      ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_3) &
                        & THEN
                        IF(rowComponentIdx==1) THEN
                          !Calculate sum
                          sum=0.0_DP
                        ...
                        ENDIF
                      ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4) &
                        & THEN
                        IF(rowComponentIdx==1) THEN
                          !Calculate sum
                        ...
                        ENDIF
                      ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5) &
                        & THEN
                        !do nothing
                      ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE== &
          ...
          IF(updateNonlinearResidual) THEN
            ...
            uValue(1)=dependentInterpPoint%values(1,NO_PART_DERIV)
            uValue(2)=dependentInterpPoint%values(2,NO_PART_DERIV)
            uDeriv(1,1)=dependentInterpPoint%values(1,PART_DERIV_S1)
            uDeriv(1,2)=dependentInterpPoint%values(1,PART_DERIV_S2)
            uDeriv(2,1)=dependentInterpPoint%values(2,PART_DERIV_S1)
            uDeriv(2,2)=dependentInterpPoint%values(2,PART_DERIV_S2)
            IF(numberOfDimensions==3) THEN
              uValue(3)=dependentInterpPoint%values(3,NO_PART_DERIV)
              uDeriv(3,1)=dependentInterpPoint%values(3,PART_DERIV_S1)
              uDeriv(3,2)=dependentInterpPoint%values(3,PART_DERIV_S2)
              uDeriv(3,3)=dependentInterpPoint%values(3,PART_DERIV_S3)
              uDeriv(1,3)=dependentInterpPoint%values(1,PART_DERIV_S3)
              uDeriv(2,3)=dependentInterpPoint%values(2,PART_DERIV_S3)
            ELSE
              uValue(3)=0.0_DP
              uDeriv(3,1)=0.0_DP
              uDeriv(3,2)=0.0_DP
            ...
            DO rowComponentIdx=1,numberOfDimensions
              ...
              DO componentIdx=1,numberOfDimensions
                DO rowXiIdx=1,rowBasis%numberOfXi
                  dXidX(rowXiIdx,componentIdx)=geometricInterpPointMetrics%dXidX(rowXiIdx,componentIdx)
                ENDDO !rowXiIdx
              ENDDO !componentIdx
              DO rowElementParameterIdx=1,rowBasis%numberOfElementParameters
                rowElementDOFIdx=rowElementDOFIdx+1
                ...
                nonlinearMatrices%elementResidual%vector(rowElementDOFIdx)= &
                  & nonlinearMatrices%elementResidual%vector(rowElementDOFIdx)+sum*jacobianGaussWeight
        ...
        !------------------------------------------------------------------
        IF(equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE.OR. &
          & equationsSet%specification(3)==EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE) THEN
        ...
        IF(equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE .OR. &
          ...
          CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,3,alpha,err,error,*999)
          CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,8,g0Param,err,error,*999)
          ...
          DO rowComponentIdx=1,residualVariable%numberOfComponents
            CALL FieldVariable_ComponentMeshComponentGet(residualVariable,rowComponentIdx,rowMeshComponent,err,error,*999)
            NULLIFY(rowDomain)
            CALL Decomposition_DomainGet(dependentDecomposition,rowMeshComponent,rowDomain,err,error,*999)
            NULLIFY(rowDomainTopology)
            ...
            DO rowElementParameterIdx=1,rowBasis%numberOfElementParameters
              rowPhi=rowQuadratureScheme%gaussBasisFunctions(rowElementParameterIdx,NO_PART_DERIV,gaussPointIdx)
              dRowPhidXi(1)=rowQuadratureScheme%gaussBasisFunctions(rowElementParameterIdx,FIRST_PART_DERIV,gaussPointIdx)
              rowElementDOFIdx=rowElementDOFIdx+1
              columnElementDOFIdx=0
              IF(updateStiffnessMatrix .OR. updateDampingMatrix) THEN
                !Loop Over Element Columns
                DO columnComponentIdx=1,residualVariable%numberOfComponents
                  ...
                  DO columnElementParameterIdx=1,columnBasis%numberOfElementParameters
                    columnPhi=columnQuadratureScheme%gaussBasisFunctions(columnElementParameterIdx,NO_PART_DERIV,gaussPointIdx)
                    dColumnPhidXi(1)=columnQuadratureScheme%gaussBasisFunctions(columnElementParameterIdx,FIRST_PART_DERIV, &
                      & gaussPointIdx)
                    columnElementDOFIdx=columnElementDOFIdx+1
                    !
      ...
      IF(equationsSet%specification(3)==EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE .OR. &
        ...
        & equationsSet%specification(3)==EQUATIONS_SET_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE) THEN
        IF(updateNonlinearResidual) THEN
          numberOfElementNodes=dependentBasis%numberOfNodes
          numberOfParameters=dependentDomainElements%maximumNumberOfElementParameters
          firstNode=dependentDomainElements%elements(elementNumber)%elementNodes(1)
          lastNode=dependentDomainElements%elements(elementNumber)%elementNodes(numberOfElementNodes)
          !Get material constants
          CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2, &
            & rhoParam,err,error,*999)
          ...
          DO nodeIdx=1,numberOfElementNodes
            nodeNumber=dependentDomainElements%elements(elementNumber)%elementNodes(nodeIdx)
            derivativeIdx = 1
            versionIdx=dependentDomainElements%elements(elementNumber)%elementVersions(derivativeIdx,nodeIdx)
            ...
            IF(elementNumber<=dependentDecompositionElements%numberOfElements) THEN
          ...
          DO nodeIdx=1,numberOfElementNodes
            nodeNumber=dependentDomainElements%elements(elementNumber)%elementNodes(nodeIdx)
            numberOfVersions=dependentDomainNodes%nodes(nodeNumber)%derivatives(1)%numberOfVersions
            ...
            IF(numberOfVersions>1) THEN
              ...
              CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                & elementVersionNumber,derivativeIdx,nodeNumber,1,a0Param,err,error,*999)
              CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                & elementVersionNumber,derivativeIdx,nodeNumber,2,eParam,err,error,*999)
              CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                & elementVersionNumber,derivativeIdx,nodeNumber,3,hParam,err,error,*999)
              ...
              CALL Field_ParameterSetGetLocalNode(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                & elementVersionNumber,derivativeIdx,nodeNumber,1,qValue,err,error,*999)
              CALL Field_ParameterSetGetLocalNode(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                & elementVersionNumber,derivativeIdx,nodeNumber,2,aValue,err,error,*999)
...
999 ERRORSEXITS("NavierStokes_FiniteElementResidualEvaluate",err,error)
  ...
  SUBROUTINE NavierStokes_FiniteElementJacobianEvaluate(equationsSet,elementNumber,err,error,*)
    ...
    INTEGER(INTG) :: columnComponentIdx,columnElementDOFIdx,columnElementParameterIdx,columnMeshComponent,componentIdx, &
      & coordinateIdx,derivativeIdx,elementVersionNumber,firstNode,gaussPointIdx,lastNode,nodeIdx,nodeNumber, &
      & numberOfDimensions,numberOfElementNodes,numberOfParameters,numberOfVersions,residualVariableType,rowComponentIdx, &
      & rowElementDOFIdx,rowElementParameterIdx,rowMeshComponent,xiIdx
    REAL(DP) :: jacobianGaussWeight,sum,dXidX(3,3),dRowPhidXi(3),dColumnPhidXi(3),rowPhi,columnPhi
    REAL(DP) :: uValue(3),wValue(3),uDeriv(3,3),qValue,qDeriv,aValue,aDeriv,alpha,beta,normal,normalWave,kappa
    REAL(DP) :: muParam,rhoParam,a0Param,a0Deriv,eParam,eDeriv,hParam,hDeriv,mass,momentum1,momentum2,muScale
    LOGICAL  :: updateJacobianMatrix,updateNonlinearResidual,updateRHSVector
    TYPE(BasisType), POINTER :: columnBasis,dependentBasis,geometricBasis,independentBasis,rowBasis
    TYPE(DecompositionType), POINTER :: dependentDecomposition,geometricDecomposition,independentDecomposition
    TYPE(DomainType), POINTER :: columnDomain,dependentDomain,geometricDomain,independentDomain,rowDomain
    TYPE(DomainElementsType), POINTER :: columnDomainElements,dependentDomainElements,geometricDomainElements, &
    ...
    CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
      ...
      CASE(EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE, &
        ...
        CALL Field_ParameterSetGetConstant(equationsSet%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
  ...
  SUBROUTINE NavierStokes_PostSolve(solver,err,error,*)
    ...
    CASE(PROBLEM_TRANSIENT1D_NAVIER_STOKES_SUBTYPE)
      ...
      CASE(SOLVER_NONLINEAR_TYPE)
        ...
        NULLIFY(upwindParameterSet)
        CALL FieldVariable_ParameterSetCheck(dependentVariable,FIELD_UPWIND_VALUES_SET_TYPE,upwindParameterSet,err,error,*999)
        IF(.NOT.ASSOCIATED(upwindParameterSet)) CALL Field_ParameterSetCreate(dependentField,FIELD_U_VARIABLE_TYPE, &
          & FIELD_UPWIND_VALUES_SET_TYPE,err,error,*999)
        CALL ControlLoop_CurrentWhileInformationGet(controlLoop,iterationNumber,maxIterations,absoluteTolerance, &
          & relativeTolerance,continueLoop,err,error,*999)
        IF(iterationNumber == 1) CALL Field_ParameterSetsCopy(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
      ...
      END SELECT
    CASE(PROBLEM_COUPLED1D0D_NAVIER_STOKES_SUBTYPE)
      IF(ASSOCIATED(controlLoop%whileLoop)) THEN
        ...
        CASE(1)
          ...
          CALL Field_VariableGet(dependentField,FIELD_U_VARIABLE_TYPE,dependentVariable,err,error,*999)
          NULLIFY(upwindParameterSet)
          CALL FieldVariable_ParameterSetCheck(dependentVariable,FIELD_UPWIND_VALUES_SET_TYPE,upwindParameterSet, &
            & err,error,*999)
          IF(.NOT.ASSOCIATED(upwindParameterSet)) CALL Field_ParameterSetCreate(dependentField,FIELD_U_VARIABLE_TYPE, &
              & FIELD_UPWIND_VALUES_SET_TYPE,err,error,*999)
          CALL Field_ParameterSetsCopy(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
        ...
        CASE DEFAULT
          ...
          CALL FlagError(localError,err,error,*999)
        END SELECT
      ELSE IF(ASSOCIATED(controlLoop%simpleLoop)) THEN
        ...
        ENDIF
      ELSE
        localError="The control loop type for solver "//TRIM(NumberToVString(solver%globalNumber,"*",err,error))// &
    ...
    CASE(PROBLEM_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE)
      ...
      ELSE IF(ASSOCIATED(controlLoop%simpleLoop)) THEN
        ...
        IF(controlLoop%subLoopIndex == 3) CALL NavierStokes_PostSolveOutputData(solver,err,error,*999)
      ELSE
        localError="The control loop type for solver "//TRIM(NumberToVString(solver%globalNumber,"*",err,error))// &
          & " is invalid for the a 1D0D coupled Navier-Stokes problem."
        CALL FlagError(localError,err,error,*999)
    ...
    CASE(PROBLEM_CONSTITUTIVE_RBS_NAVIER_STOKES_SUBTYPE)
      IF(SOLVER%globalNumber==2) THEN
        ...
        NULLIFY(solverMapping)
        CALL SolverEquations_SolverMappingGet(solverEquations,solverMapping,err,error,*999)
        DO equationsSetNumber=1,solverMapping%NUMBER_OF_EQUATIONS_SETS
          ...
          NULLIFY(equationsSet)
          CALL SolverMapping_EquationsSetGet(solverMapping,equationsSetNumber,equationsSet,err,error,*999)
          IF(equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) &
            & CALL NavierStokes_ShearRateCalculate(equationsSet,err,error,*999)
        ENDDO !equationsSetNumber
      ENDIF
    CASE(PROBLEM_MULTISCALE_NAVIER_STOKES_SUBTYPE)
      IF(ASSOCIATED(controlLoop%whileLoop)) THEN
        SELECT CASE(solver%globalNumber)
...
999 ERRORSEXITS("NavierStokes_PostSolve",err,error)
  ...
  SUBROUTINE NavierStokes_PreSolveUpdateBoundaryConditions(solver,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error
    !Local Variables
    INTEGER(INTG) :: derivativeIdx,versionIdx,variableIdx,numberOfSourceTimesteps,timeIdx,componentIdx
    INTEGER(INTG) :: numberOfDimensions,boundaryConditionCheckVariable,globalDerivIndex,nodeIdx
    INTEGER(INTG) :: localDOF,analyticFunctionType,coordinateIdx,solidVariableType
    INTEGER(INTG) :: elementIdx,elementNodeIdx,I,J,K,numberOfNodesXIC(3),searchIdx,globalDof, &
      & fluidVariableType,dimensionIdx
    ...
    REAL(DP), POINTER :: meshVelocityValues(:), geometricParameters(:), boundaryValues(:)
    REAL(DP), POINTER :: analyticParameters(:),materialsParameters(:)
    REAL(DP), ALLOCATABLE :: nodeData(:,:),qSpline(:),qValues(:),tValues(:),fittedNodes(:)
    ...
    TYPE(EquationsType), POINTER :: equations
    TYPE(EquationsInterpolationType), POINTER :: interpolation
    TYPE(EQUATIONS_SET_TYPE), POINTER :: equationsSet,solidEquationsSet,fluidEquationsSet
    ...
    TYPE(FieldVariableType), POINTER :: analyticVariable,dependentVariable,fluidDependentVariable,geometricVariable, &
      & independentVariable,materialsVariable,solidDependentVariable
    ...
    CASE(PROBLEM_FLUID_MECHANICS_CLASS)
      ...
      CASE(PROBLEM_STATIC_NAVIER_STOKES_SUBTYPE, &
        ...
        IF(solver%globalNumber==2) THEN
          ...
          IF(ASSOCIATED(equationsSet%INDEPENDENT)) THEN
            ...
            IF(independentVariable%components(componentNumberVelocity)%interpolationType==FIELD_NODE_BASED_INTERPOLATION) THEN
              NULLIFY(domain)
              ...
              inputFile = './../interpolatedData/fitData'//TRIM(NumberToVString(currentTimeLoopIteration, &
                & "*",err,error)) // '.dat'
              ...
              IF(importDataFromFile) THEN
                ...
                DO nodeIdx=1, numberOfFittedNodes
                  ...
                  IF(nodeExists .AND. .NOT. ghostNode) THEN
                    ...
                    DO componentIdx=1,numberOfDimensions
                      CALL FieldVariable_LocalNodeDOFGet(dependentVariable,1,1,localNodeNumber, &
                        & componentIdx,dependentDOF,err,error,*999)
                      CALL FieldVariable_LocalNodeDOFGet(independentVariable,1,1,localNodeNumber, &
                        & componentIdx,independentDOF,err,error,*999)
                      VALUE = componentValues(componentIdx)
                      CALL Field_ParameterSetUpdateLocalDOF(INdependentField,independentVariableType, &
          ...
          IF(ASSOCIATED(equationsSet%analytic)) THEN
            ...
            IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_SINUSOID) THEN
              ! Update analytic time value with current time
              equationsSet%analytic%ANALYTIC_TIME=currentTime
            ...
            ELSE IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE== &
              ...
              & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE== &
              ...
              CALL Equations_InterpolationGet(equations,interpolation,err,error,*999)
              NULLIFY(dependentInterpParameters)
              CALL EquationsInterpolation_DependentParametersGet(interpolation,FIELD_U_VARIABLE_TYPE,dependentInterpParameters, &
                & err,error,*999)
              NULLIFY(dependentInterpPoint)
              CALL EquationsInterpolation_DependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE,dependentInterpPoint, &
                & err,error,*999)
              DO variableIdx=1,dependentField%numberOfVariables
                ...
                CALL Field_ParameterSetEnsureCreated(dependentField,dependentVariableType,FIELD_ANALYTIC_VALUES_SET_TYPE, &
                  & err,error,*999)
                DO componentIdx=1,dependentVariable%numberOfComponents
                  IF(dependentVariable%components(componentIdx)%interpolationType==FIELD_NODE_BASED_INTERPOLATION) THEN
                    NULLIFY(domain)
                    ...
                    DO nodeIdx=1,domainNodes%numberOfNodes
                      ...
                      numberOfNodesXIC(1)=basis%numberOfNodesXiC(1)
                      numberOfNodesXIC(2)=basis%numberOfNodesXiC(2)
                      IF(numberOfDimensions==3) THEN
                        numberOfNodesXIC(3)=basis%numberOfNodesXiC(3)
                      ELSE
                        numberOfNodesXIC(3)=1
                      ENDIF
                      !\todo: change definitions as soon as adjacent elements / boundary elements calculation works for simplex
                      IF(domainElements%maximumNumberOfElementParameters==4 .OR. &
                        & domainElements%maximumNumberOfElementParameters==9 .OR. &
                        & domainElements%maximumNumberOfElementParameters==16 .OR. &
                        & domainElements%maximumNumberOfElementParameters==8 .OR. &
                        & domainElements%maximumNumberOfElementParameters==27 .OR. &
                        & domainElements%maximumNumberOfElementParameters==64) THEN
                        DO K=1,numberOfNodesXIC(3)
                          DO J=1,numberOfNodesXIC(2)
                            DO I=1,numberOfNodesXIC(1)
                              elementNodeIdx=elementNodeIdx+1
                              IF(domainElements%elements(elementIdx)% elementNodes(elementNodeIdx)==nodeIdx) EXIT
                      ...
                      ELSE
                        ...
                        IF(domainElements%maximumNumberOfElementParameters==3) THEN
                          tCoordinates(1,1:2)=[0.0_DP,1.0_DP]
                          tCoordinates(2,1:2)=[1.0_DP,0.0_DP]
                          tCoordinates(3,1:2)=[1.0_DP,1.0_DP]
                        ELSE IF(domainElements%maximumNumberOfElementParameters==6) THEN
                          tCoordinates(1,1:2)=[0.0_DP,1.0_DP]
                          tCoordinates(2,1:2)=[1.0_DP,0.0_DP]
                          tCoordinates(3,1:2)=[1.0_DP,1.0_DP]
                        ...
                        ELSE IF(domainElements%maximumNumberOfElementParameters==10.AND.numberOfDimensions==2) THEN
                          tCoordinates(1,1:2)=[0.0_DP,1.0_DP]
                          tCoordinates(2,1:2)=[1.0_DP,0.0_DP]
                          tCoordinates(3,1:2)=[1.0_DP,1.0_DP]
                        ...
                        ELSE IF(domainElements%maximumNumberOfElementParameters==4) THEN
                        ...
                        ELSE IF(domainElements%maximumNumberOfElementParameters==10.AND.numberOfDimensions==3) THEN
                          tCoordinates(1,1:3)=[0.0_DP,1.0_DP,1.0_DP]
                          tCoordinates(2,1:3)=[1.0_DP,0.0_DP,1.0_DP]
                          tCoordinates(3,1:3)=[1.0_DP,1.0_DP,0.0_DP]
                          tCoordinates(4,1:3)=[1.0_DP,1.0_DP,1.0_DP]
                        ...
                        ELSE IF(domainElements%maximumNumberOfElementParameters==20) THEN
                          tCoordinates(1,1:3)=[0.0_DP,1.0_DP,1.0_DP]
                          tCoordinates(2,1:3)=[1.0_DP,0.0_DP,1.0_DP]
                          tCoordinates(3,1:3)=[1.0_DP,1.0_DP,0.0_DP]
                          tCoordinates(4,1:3)=[1.0_DP,1.0_DP,1.0_DP]
                        ...
                        ENDIF
                        DO K=1,domainElements%maximumNumberOfElementParameters
                          IF(domainElements%elements(elementIdx)%elementNodes(K)==nodeIdx) EXIT
                        END DO !K
                        IF(numberOfDimensions==2) THEN
                      ...
                      X=0.0_DP
                      DO coordinateIdx=1,numberOfDimensions
                        X(coordinateIdx)=dependentInterpPoint%values(coordinateIdx,1)
                      END DO !coordinateIdx
                  ...
                  ENDIF
                ENDDO !componentIdx
                CALL Field_ParameterSetUpdateStart(dependentField,dependentVariableType,FIELD_ANALYTIC_VALUES_SET_TYPE, &
                  & err,error,*999)
                CALL Field_ParameterSetUpdateFinish(dependentField,dependentVariableType,FIELD_ANALYTIC_VALUES_SET_TYPE, &
                  & err,error,*999)
                CALL Field_ParameterSetUpdateStart(dependentField,dependentVariableType,FIELD_VALUES_SET_TYPE,err,error,*999)
                CALL Field_ParameterSetUpdateFinish(dependentField,dependentVariableType,FIELD_VALUES_SET_TYPE,err,error,*999)
              ENDDO !variableIdx
              ...
              IF(ASSOCIATED(boundaryConditionsVariable)) THEN
                DO componentIdx=1,dependentVariable%numberOfComponents
                  IF(dependentVariable%components(componentIdx)%interpolationType==FIELD_NODE_BASED_INTERPOLATION) THEN
                    ...
                    CALL Field_ParameterSetCreated(dependentField,dependentVariableType, &
                      & FIELD_ANALYTIC_VALUES_SET_TYPE,parameterSetCreated,err,error,*999)
                    IF (.NOT. parameterSetCreated) CALL Field_ParameterSetCreate(dependentField,dependentVariableType, &
                          ...
                          IF(boundaryConditionCheckVariable==BOUNDARY_CONDITION_FIXED_FITTED) THEN
                            ...
                            IF(importDataFromFile) THEN
                              ...
                              CALL spline_cubic_val(numberOfSourceTimesteps,tValues,qValues,qSpline, &
                                & currentTime,VALUE,QP,QPP,err,error,*999)
                              DEALLOCATE(nodeData)
                              DEALLOCATE(qSpline)
                              DEALLOCATE(qValues)
                              DEALLOCATE(tValues)
          ...
          DO equationsSetIdx = 1,solverMapping%NUMBER_OF_EQUATIONS_SETS
            ...
            CASE(EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
              ...
              IF(ASSOCIATED(equationsSet%INDEPENDENT)) THEN
                ...
                componentNumberVelocity = 1
                ! Get the nodes on this computation domain
                IF(independentVariable%components(componentNumberVelocity)%interpolationType== &
                ...
                IF(importDataFromFile) THEN
                  ...
                  DO nodeIdx=1, numberOfFittedNodes
                    userNodeNumber=INT(fittedNodes(nodeIdx),INTG)
                    CALL DomainNodes_NodeCheckExists(domainNodes,userNodeNumber,nodeExists, &
              ...
              IF(ASSOCIATED(equationsSet%analytic)) THEN
                ...
                IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_SINUSOID) THEN
                  ...
                  CALL NavierStokes_BoundaryConditionsAnalyticCalculate(equationsSet,boundaryConditions, err,error,*999)
                ELSE
                  localError="Analytic equations type "//TRIM(NumberToVString(equationsSet%analytic% &
                  ...
                  DO variableIdx=1,dependentField%numberOfVariables
                    ...
                    IF(ASSOCIATED(boundaryConditionsVariable)) THEN
                      DO componentIdx=1,dependentVariable%numberOfComponents
                        IF(dependentVariable%components(componentIdx)%interpolationType==FIELD_NODE_BASED_INTERPOLATION) THEN
                          NULLIFY(domain)
                          CALL FieldVariable_ComponentDomainGet(independentVariable,componentNumberVelocity,domain, &
                            & err,error,*999)
                          NULLIFY(domainTopology)
                          CALL Domain_DomainTopologyGet(domain,domainTopology,err,error,*999)
                          NULLIFY(domainNodes)
                            ...
                            DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                              DO versionIdx=1,domainNodes%nodes(nodeIdx)%derivatives(derivativeIdx)%numberOfVersions
                                ...
                                IF(importDataFromFile) THEN
                                  ...
                                  CALL Field_ParameterSetEnsureCreated(dependentField,dependentVariableType, &
                                    & FIELD_ANALYTIC_VALUES_SET_TYPE,err,error,*999)
                                  !Read fitted data from input file (if exists)
                                  OPEN(UNIT=10, FILE=inputFile, STATUS='OLD')
                                  ! Header timeData = numberOfTimesteps
                                  ...
                                  CALL spline_cubic_val(numberOfSourceTimesteps,tValues,qValues, &
                                    & qSpline,currentTime,VALUE,QP,QPP,err,error,*999)
      ...
      CASE(PROBLEM_QUASISTATIC_NAVIER_STOKES_SUBTYPE)
        ...
        CALL Field_ParameterSetUpdateStart(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
          & FIELD_VALUES_SET_TYPE,err,error,*999)
        CALL Field_ParameterSetUpdateFinish(equationsSet%dependent%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
          & FIELD_VALUES_SET_TYPE,err,error,*999)
      CASE(PROBLEM_PGM_NAVIER_STOKES_SUBTYPE)
        ...
        IF(solver%SOLVE_TYPE==SOLVER_DYNAMIC_TYPE) THEN
          ...
          NULLIFY(boundaryValues)
          CALL Field_ParameterSetDataGet(independentField,FIELD_U_VARIABLE_TYPE,FIELD_BOUNDARY_SET_TYPE, &
            & boundaryValues,err,error,*999)
      ...
      CASE(PROBLEM_ALE_NAVIER_STOKES_SUBTYPE)
        ...
        IF(solver%SOLVE_TYPE==SOLVER_LINEAR_TYPE) THEN
          ...
          DO variableIdx=1,dependentField%numberOfVariables
            ...
            ENDDO !componentIdx
          ENDDO !variableIdx
          CALL Field_ParameterSetDataRestore(independentField,FIELD_U_VARIABLE_TYPE,FIELD_BOUNDARY_SET_TYPE, &
            & boundaryValues,err,error,*999)
          !\todo: This part should be read in out of a file eventually
          CALL Field_ParameterSetUpdateStart(dependentField,FIELD_U_VARIABLE_TYPE, &
            & FIELD_VALUES_SET_TYPE,err,error,*999)
        ...
        ELSE IF(solver%SOLVE_TYPE==SOLVER_DYNAMIC_TYPE) THEN
          ...
          DO variableIdx=1,dependentField%numberOfVariables
            ...
            ENDDO !componentIdx
          ENDDO !variableIdx
          CALL Field_ParameterSetDataRestore(independentField,FIELD_U_VARIABLE_TYPE,FIELD_MESH_VELOCITY_SET_TYPE, &
            & meshVelocityValues,err,error,*999)
          CALL Field_ParameterSetDataRestore(independentField,FIELD_U_VARIABLE_TYPE,FIELD_BOUNDARY_SET_TYPE, &
            & boundaryValues,err,error,*999)
      ...
      CASE(PROBLEM_FINITE_ELASTICITY_NAVIER_STOKES_TYPE)
        ...
        CASE(PROBLEM_FINITE_ELASTICITY_NAVIER_STOKES_ALE_SUBTYPE, &
          ...
          IF(solver%SOLVE_TYPE==SOLVER_LINEAR_TYPE) THEN
            ...
            DO WHILE (.NOT.solidEquationsSetFound.AND.equationsSetIndex<=solidSolverMapping%NUMBER_OF_EQUATIONS_SETS)
              ...
              IF(solidEquationsSet%specification(1)==EQUATIONS_SET_ELASTICITY_CLASS &
                & .AND.solidEquationsSet%specification(2)==EQUATIONS_SET_FINITE_ELASTICITY_TYPE &
                & .AND.((solidEquationsSet%specification(3)==EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_MR_AND_GROWTH_LAW_IN_CELLML_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_DYNAMIC_ST_VENANT_KIRCHOFF_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_DYNAMIC_MOONEY_RIVLIN_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_DYNAMIC_COMP_ST_VENANT_KIRCHOFF_SUBTYPE) &
                & .OR.(solidEquationsSet%specification(3)==EQUATIONS_SET_DYNAMIC_COMP_MOONEY_RIVLIN_SUBTYPE))) THEN
            ...
            equationsSetIndex=1
            fluidEquationsSetFound=.FALSE.
            DO WHILE (.NOT.fluidEquationsSetFound.AND.equationsSetIndex<=fluidSolverMapping%NUMBER_OF_EQUATIONS_SETS)
            ...
            variableIdx=1
            DO componentIdx=1,fluidDependentVariable%numberOfComponents
              NULLIFY(domain)
              ...
              DO nodeIdx=1,domainNodes%numberOfNodes
                DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                  ...
                  IF(boundaryConditionCheckVariable==BOUNDARY_CONDITION_MOVED_WALL) THEN
                    ...
                    DO searchIdx=1,SIZE(meshConnectivity%coupledNodes(2,:))
                      IF(meshConnectivity%coupledNodes(2,searchIdx)==nodeIdx) THEN
                        solidNodeNumber=meshConnectivity%coupledNodes(1,searchIdx)!might wanna put a break here
                        solidNodeFound=.TRUE.
                      ENDIF
                    ENDDO !searchIdx
                    IF(.NOT.solidNodeFound.OR.fluidNodeNumber==0) &
                      & CALL FlagError("Solid interface node not found.",err,error,*999)
          ...
          ELSE IF(solver%SOLVE_TYPE==SOLVER_DYNAMIC_TYPE) THEN
            ...
            !             & .AND.equationsSet%specification(2)==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TYPE &
            !             & .AND.equationsSet%specification(3)==EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE &
            !             & .AND.equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE) THEN
            ...
            !       dependentVariable=>equationsSet%dependent%DEPENDENT_FIELD%variableTypeMap(FIELD_U_VARIABLE_TYPE)%ptr
            ...
            !           & numberOfDimensions,err,error,*999)
            !         NULLIFY(meshVelocityValues)
            !         CALL Field_ParameterSetDataGet(equationsSet%independent%INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
            !           & FIELD_MESH_VELOCITY_SET_TYPE,meshVelocityValues,err,error,*999)
            !         NULLIFY(boundaryValues)
            !         CALL Field_ParameterSetDataGet(equationsSet%independent%INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
            !           & FIELD_BOUNDARY_SET_TYPE,boundaryValues,err,error,*999)
            ...
            !             CALL Field_ParameterSetUpdateNode(equationsSet%dependent%DEPENDENT_FIELD, &
            !               & FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,1,InletNodes(nodeIdx),componentBC, &
            !               & BoundaryValues(nodeIdx),err,error,*999)
            !           END DO
            !         ELSE
            !           !Figure out which component we're applying BC at
            !           IF(controlLoop%timeLoop%inputNumber==2) THEN
            !             componentBC=1
            !           ELSE
            !             componentBC=2
            !           ENDIF
            ...
            !           END DO
            !         ENDIF
            !         CALL Field_ParameterSetDataRestore(equationsSet%independent%INDEPENDENT_FIELD, &
            !           & FIELD_U_VARIABLE_TYPE,FIELD_MESH_VELOCITY_SET_TYPE,meshVelocityValues,err,error,*999)
            !         CALL Field_ParameterSetDataRestore(equationsSet%independent%INDEPENDENT_FIELD, &
            !           & FIELD_U_VARIABLE_TYPE,FIELD_BOUNDARY_SET_TYPE,boundaryValues,err,error,*999)
            !       ELSE
            !         CALL FlagError("Boundary condition variable is not associated.",err,error,*999)
            !       ENDIF
            !     ELSE
    ...
    CASE DEFAULT
      localError="The first problem specification of "// &
        & TRIM(NumberToVString(problem%specification(1),"*",err,error))// &
    ...
    CASE(PROBLEM_FLUID_MECHANICS_CLASS)
      ...
      CASE(PROBLEM_PGM_NAVIER_STOKES_SUBTYPE)
        ...
        IF(solver%SOLVE_TYPE==SOLVER_DYNAMIC_TYPE) THEN
          ...
          !CALL Field_ParameterSetDataGet(fluidIndependentField,FIELD_U_VARIABLE_TYPE,FIELD_MESH_DISPLACEMENT_SET_TYPE, &
          !  & meshDisplacementValues,err,error,*999)
          DO variableIdx=1,fluidGeometricField%numberOfVariables
            NULLIFY(fluidGeometricVariable)
            CALL Field_VariableIndexGet(fluidGeometricField,variableIdx,fluidGeometricVariable,variableType,err,error,*999)
            DO componentIdx=1,fluidGeometricVariable%numberOfComponents
              NULLIFY(domain)
              ...
              DO nodeIdx=1,domainNodes%numberOfNodes
                DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                  DO versionIdx=1,domainNodes%nodes(nodeIdx)%derivatives(derivativeIdx)%numberOfVersions
                    CALL FieldVariable_LocalNodeDOFGet(fluidGeometricVariable,versionIdx,derivativeIdx,nodeIdx, &
                      & componentIdx,localDOF,err,error,*999)
          ...
          IF(solver%DYNAMIC_SOLVER%ALE) THEN
            ...
            DO componentIdx=1,fluidGeometricVariable%numberOfComponents
              ...
              DO nodeIdx=1,domainNodes%numberOfNodes
                DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                  !Default to version 1 of each node derivative
                  CALL FieldVariable_LocalNodeDOFGet(fluidGeometricVariable,1,derivativeIdx,nodeIdx, &
                    & componentIdx,localDOF,err,error,*999)
                  CALL Field_ParameterSetAddLocalDOF(fluidGeometricField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,localDOF, &
                    & meshDisplacementValues(localDOF),err,error,*999)
                ENDDO !derivativeIdx
        ...
        CASE(PROBLEM_FINITE_ELASTICITY_NAVIER_STOKES_ALE_SUBTYPE, &
          ...
          IF(solver%SOLVE_TYPE==SOLVER_DYNAMIC_TYPE) THEN
            IF(solver%DYNAMIC_SOLVER%ALE) THEN
              ...
              DO componentIdx=1,interfaceGeometricVariable%numberOfComponents
                SELECT CASE(interfaceGeometricVariable%components(componentIdx)%interpolationType)
...
999 ERRORSEXITS("NavierStokes_PreSolveALEUpdateMesh",err,error)
  ...
  SUBROUTINE NavierStokes_PreSolveALEUpdateParameters(solver,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error
    !Local Variables
    INTEGER(INTG) :: componentIdx,derivativeIdx,localDOF,nodeIdx,variableIdx,variableType
    ...
    CALL ControlLoop_ProblemGet(controlLoop,problem,err,error,*999)
    CALL ControlLoop_CurrentTimesGet(controlLoop,currentTime,timeIncrement,err,error,*999)
    IF(.NOT.ALLOCATED(controlLoop%problem%specification)) &
      & CALL FlagError("Problem specification array is not allocated.",err,error,*999)
    IF(SIZE(controlLoop%problem%specification,1)<3) &
      & CALL FlagError("Problem specification must have three entries for a Navier-Stokes problem.",err,error,*999)
    ...
    CASE(PROBLEM_FLUID_MECHANICS_CLASS)
      ...
      CASE(PROBLEM_ALE_NAVIER_STOKES_SUBTYPE)
        IF(solver%SOLVE_TYPE==SOLVER_LINEAR_TYPE) THEN
          ...
          CALL Field_ParameterSetDataGet(independentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,meshStiffValues, &
            & err,error,*999)
          DO variableIdx=1,dependentField%numberOfVariables
            NULLIFY(dependentVariable)
            ...
            DO componentIdx=1,dependentVariable%numberOfComponents
              ...
              DO nodeIdx=1,domainNodes%numberOfNodes
                DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                  ...
                  CALL Field_ParameterSetUpdateLocalDOF(independentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,localDOF, &
              ...
              DO componentIdx=1,dependentVariable%numberOfComponents
                ...
                DO nodeIdx=1,domainNodes%numberOfNodes
                  DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                    ...
                    !Calculation of K values dependent on current mesh topology
                    meshStiffValues(localDOF)=1.0_DP
                    CALL Field_ParameterSetUpdateLocalDOF(equationsSet%INDEPENDENT% &
                      & INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,localDOF, &
                      & meshStiffValues(localDOF),err,error,*999)
                  ENDDO !derivativeIdx
                ENDDO !nodeIdx
              ENDDO !componentIdx
        ...
        DO equationsSetIdx=1,solverMapping%NUMBER_OF_EQUATIONS_SETS
          ...
          IF(outputIterationNumber/=0) THEN
            IF(currentTime<=stopTime) THEN
              ...
              ENDIF
              IF(ASSOCIATED(equationsSet%analytic)) THEN                 
                IF(equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_4.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_5.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_4.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_5.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_ONE_DIM_1.OR. &
                  & equationsSet%analytic%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_THREE_DIM_1) THEN
                  NULLIFY(dependentField)
                  CALL EquationsSet_DependentFieldGet(equationsSet,dependentField,err,error,*999)
...
999 ERRORSEXITS("NavierStokes_PostSolveOutputData",err,error)
  ...
  SUBROUTINE NavierStokes_BoundaryConditionsAnalyticCalculate(equationsSet,boundaryConditions,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: componentIdx,derivativeIdx,dimensionIdx,localDOF,nodeIdx,numberOfDimensions,variableIdx,variableType,I,J,K
    INTEGER(INTG) :: numberOfNodesXiCoord(3),elementIdx,elementNodeIdx,boundaryCount,analyticFunctionType, &
      & globalDerivativeIndex,versionIdx
    INTEGER(INTG) :: boundaryConditionsCheckVariable,numberOfXi,nodeNumber,userNodeNumber,globalDof
    ...
    DO variableIdx=1,dependentField%numberOfVariables
      NULLIFY(dependentVariable)
      CALL Field_VariableIndexGet(dependentField,variableIdx,dependentVariable,variableType,err,error,*999)
      NULLIFY(analyticParameterSet)
      CALL FieldVariable_ParameterSetCheck(dependentVariable,FIELD_ANALYTIC_VALUES_SET_TYPE,analyticParameterSet, &
        & err,error,*999)
      IF(.NOT.ASSOCIATED(analyticParameterSet)) &
      ...
      DO componentIdx=1,dependentVariable%numberOfComponents
        ...
        IF(dependentVariable%components(componentIdx)%interpolationType==FIELD_NODE_BASED_INTERPOLATION) THEN
          ...
          DO nodeIdx=1,domainNodes%numberOfNodes
            ...
            numberOfNodesXiCoord(1)=basis%numberOfNodesXiC(1)
            IF(numberOfXi>1) THEN
              numberOfNodesXiCoord(2)=basis%numberOfNodesXiC(2)
            ELSE
              numberOfNodesXiCoord(2)=1
            ENDIF
            IF(numberOfXi>2) THEN
              numberOfNodesXiCoord(3)=basis%numberOfNodesXiC(3)
            ELSE
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_TWO_DIM_POISEUILLE)
              IF(variableIdx < 3) THEN
                ...
                DO dimensionIdx=1,numberOfDimensions
                  CALL FieldVariable_LocalNodeDOFGet(geometricVariable,1,1,nodeNumber,dimensionIdx,localDOF,err,error,*999)
                  x(dimensionIdx)=geometricParameters(localDOF)
                ENDDO !dimensionIdx
                DO derivativeIdx=1,domainNodes%nodes(nodeNumber)%numberOfDerivatives
                  globalDerivativeIndex=domainNodes%nodes(nodeNumber)%derivatives(derivativeIdx)%globalDerivativeIndex
                  DO versionIdx=1,domainNodes%nodes(nodeNumber)%derivatives(derivativeIdx)%numberOfVersions
                    CALL NavierStokes_AnalyticFunctionsEvaluate(analyticFunctionType,x,time,variableType, &
                      & globalDerivativeIndex,componentIdx,numberOfDimensions,dependentVariable%numberOfComponents, &
                      & analyticParameters,materialsParameters,VALUE,err,error,*999)
                    CALL FieldVariable_LocalNodeDOFGet(dependentVariable,versionIdx,derivativeIdx,nodeNumber, &
                      & componentIdx,localDOF,err,error,*999)
              ...
              DO derivativeIdx=1,domainNodes%nodes(nodeNumber)%numberOfDerivatives
                ...
                IF(componentIdx<=numberOfXi.OR.analyticFunctionType==EQUATIONS_SET_NAVIER_STOKES_EQUATION_SINUSOID) THEN
                  DO versionIdx=1,domainNodes%nodes(nodeNumber)%derivatives(derivativeIdx)%numberOfVersions
                    ...
                    CALL Field_ComponentDOFGetUserNode(dependentField,variableType,versionIdx,derivativeIdx, &
                      & userNodeNumber,componentIdx,localDof,globalDof,err,error,*999)
                    IF(analyticFunctionType==EQUATIONS_SET_NAVIER_STOKES_EQUATION_SINUSOID) THEN
                      CALL Field_NumberOfComponentsGet(analyticField,FIELD_U_VARIABLE_TYPE,numberOfParameters,err,error,*999)
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_FLOWRATE_AORTA, &
              ...
              ! Get geometric position info for this node
              DO dimensionIdx=1,numberOfDimensions
                CALL FieldVariable_LocalNodeDOFGet(geometricVariable,1,1,nodeIdx,dimensionIdx, &
            ...
            CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_ONE_DIM_1,  &
              ...
              IF(domain%topology%elements%maximumNumberOfElementParameters==4.AND.numberOfDimensions==2.OR. &
                ...
                !Tri/Tet
                !\todo: Use boundary flag
              ELSE IF(domainElements%maximumNumberOfElementParameters==3) THEN
                tCoordinates(1,1:2)=[0.0_DP,1.0_DP]
                tCoordinates(2,1:2)=[1.0_DP,0.0_DP]
                tCoordinates(3,1:2)=[1.0_DP,1.0_DP]
              ELSE IF(domainElements%maximumNumberOfElementParameters==6) THEN
              ...
              ELSE IF(domain%topology%elements%maximumNumberOfElementParameters==4) THEN
                ...
                tCoordinates(3,1:3)=[1.0_DP,1.0_DP,0.0_DP]
                tCoordinates(4,1:3)=[1.0_DP,1.0_DP,1.0_DP]
              ELSE IF(domain%topology%elements%maximumNumberOfElementParameters==10.AND.numberOfDimensions==3) THEN
                tCoordinates(1,1:3)=[0.0_DP,1.0_DP,1.0_DP]
                tCoordinates(2,1:3)=[1.0_DP,0.0_DP,1.0_DP]
                tCoordinates(3,1:3)=[1.0_DP,1.0_DP,0.0_DP]
                tCoordinates(4,1:3)=[1.0_DP,1.0_DP,1.0_DP]
              ...
              DO derivativeIdx=1,domainNodes%nodes(nodeIdx)%numberOfDerivatives
                ...
                CALL NavierStokes_AnalyticFunctionsEvaluate(analyticFunctionType,x,time,variableType, &
                  ...
                  & analyticParameters,materialsParameters,VALUE,err,error,*999)
                DO versionIdx=1,domainNodes%nodes(nodeIdx)%derivatives(derivativeIdx)%numberOfVersions
                  CALL FieldVariable_LocalNodeDOFGet(dependentVariable,versionIdx,derivativeIdx, &
                    & nodeIdx,componentIdx,localDOF,err,error,*999)
                  CALL Field_ParameterSetUpdateLocalDOF(dependentField,variableType, &
                    & FIELD_ANALYTIC_VALUES_SET_TYPE,localDOF,VALUE,err,error,*999)
                  IF(variableType==FIELD_U_VARIABLE_TYPE) THEN
                    IF(domainNodes%nodes(nodeIdx)%boundaryNode) THEN
                          ...
                          IF(analyticFunctionType==EQUATIONS_SET_STOKES_EQUATION_TWO_DIM_1.OR. &
                            ...
                            IF(-0.001_DP<X(1).AND.X(1)<0.001_DP.AND.-0.001_DP<X(2).AND.X(2)<0.001_DP.OR. &
                              ...
                              CALL BoundaryConditions_SetLocalDOF(boundaryConditions,dependentField, &
                                & variableType,localDOF,BOUNDARY_CONDITION_FIXED,VALUE,err,error,*999)
                              boundaryCount=boundaryCount+1
                            ENDIF
                          ENDIF
                        ELSE IF(domainElements%maximumNumberOfElementParameters==4.AND.numberOfDimensions==3) THEN
                    ...
                    ELSE
                      ...
                      CALL Field_ParameterSetUpdateLocalDOF(dependentField,variableType, &
                        & FIELD_VALUES_SET_TYPE,localDOF,initialValue,err,error,*999)
                    ENDIF
                  ENDIF
                ENDDO !versionIdx
              ENDDO !derivativeIdx
...
999 ERRORSEXITS("NavierStokes_AnalyticFunctionsEvaluate",err,error)
  ...
  SUBROUTINE NavierStokes_ResidualBasedStabilisation(equationsSet,elementNumber,gaussNumber,mu,rho,jacobianFlag,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: columnComponentIdx,columnElementDOFIdx,columnElementParameterIdx,dimensionIdx,dimensionIdx2,i,j,k,l, &
      & numberOfDimensions,meshComponent1,meshComponent2,numberOfDependentComponents,numberOfElementParameters(4), &
      & numberOfXi,pressureIndex,rowComponentIdx,rowElementDOFIdx,rowElementParameterIdx,stabilisationType,variableType, &
      & xiIdx,xiIdx2
    REAL(DP) :: rowPhi,columnPhi
    REAL(DP) :: dPhidXVelocity(27,3),dPhidXPressure(27,3),columndPhi2dXi(3,3)
    ...
    REAL(DP) :: jacobianGaussWeight,sum,sum2,SUPG,PSPG,LSIC,crossStress,reynoldsStress,momentumTerm
    ...
    CASE(EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE, &
      ...
      CALL EquationsInterpolation_GeometricParametersGet(interpolation,FIELD_U_VARIABLE_TYPE,geometricInterpParameters, &
        & err,error,*999)
      NULLIFY(geometricInterpPoint)
      CALL EquationsInterpolation_GeometricPointGet(interpolation,FIELD_U_VARIABLE_TYPE,geometricInterpPoint, &
        & err,error,*999)
      NULLIFY(geometricInterpPointMetrics)
      CALL EquationsInterpolation_GeometricPointMetricsGet(interpolation,FIELD_U_VARIABLE_TYPE,geometricInterpPointMetrics, &
        & err,error,*999)
      ...
      IF(equationsSet%specification(3) /= EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE) THEN
        CALL EquationsInterpolation_PreviousDependentParametersGet(interpolation,FIELD_U_VARIABLE_TYPE, &
          & prevDependentInterpParameters,err,error,*999)
        CALL EquationsInterpolation_PreviousDependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE, &
          & prevDependentInterpPoint,err,error,*999)
      ENDIF
      NULLIFY(independentInterpParameters)
      NULLIFY(independentInterpPoint)
      IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE) THEN
        CALL EquationsInterpolation_IndependentParametersGet(interpolation,FIELD_U_VARIABLE_TYPE, &
          & independentInterpParameters,err,error,*999)
        CALL EquationsInterpolation_IndependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE, &
          & independentInterpPoint,err,error,*999)
       ENDIF
      ...
      IF(stabilisationType > 0) THEN
        ...
        numberOfElementParameters(numberOfDimensions+1)=basisPressure%numberOfElementParameters
        ! Calculate dPhi/dX
          ...
          DO dimensionIdx=1,numberOfDimensions
            ...
            DO xiIdx=1,numberOfXi
              dPhidXVelocity(rowElementParameterIdx,dimensionIdx)=dPhidXVelocity(rowElementParameterIdx,dimensionIdx) + &
                & quadratureVelocity%gaussBasisFunctions(rowElementParameterIdx,PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(xiIdx), &
                & gaussNumber)*dXidX(xiIdx,dimensionIdx)
            ENDDO !xiIdx
          ENDDO !dimensionIdx
        ENDDO !rowElementParameterIdx
          ...
          DO dimensionIdx=1,numberOfDimensions
            ...
            DO xiIdx=1,numberOfXi
              dPhidXPressure(rowElementParameterIdx,dimensionIdx)=dPhidXPressure(rowElementParameterIdx,dimensionIdx) + &
                & quadraturePressure%gaussBasisFunctions(rowElementParameterIdx,PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(xiIdx), &
                & gaussNumber)*dXidX(xiIdx,dimensionIdx)
            ENDDO !xiIdx
          ENDDO !dimensionIdx
        ENDDO !rowElementParameterIdx
        jacobianGaussWeight=geometricInterpPointMetrics%jacobian*quadratureVelocity%gaussWeights(gaussNumber)
...
!! TODO: j is a xi index for the pressure gradient term below but a dimension idx for the viscous stress term below???
        ...
        ELSE IF(linearElement) THEN
          C1=3.0_DP
        ELSE
          IF(numberOfDimensions==2.AND.basisVelocity%numberOfElementParameters==9.AND.basisVelocity%interpolationOrder(1)==2) THEN
            C1=24.0_DP
          ELSE IF(numberOfDimensions==3.AND.basisVelocity%numberOfElementParameters==27 &
            & .AND. basisVelocity%interpolationOrder(1)==2) THEN
            C1=12.0_DP
        ...
        DO rowComponentIdx=1,numberOfDimensions+1
          DO rowElementParameterIdx=1,numberOfElementParameters(rowComponentIdx)
            ...
            IF(rowComponentIdx <= numberOfDimensions) THEN
              rowPhi=quadratureVelocity%gaussBasisFunctions(rowElementParameterIdx,NO_PART_DERIV,gaussNumber)
              jacobianGaussWeight=geometricInterpPointMetrics%jacobian*quadratureVelocity%gaussWeights(gaussNumber)
            ELSE
              rowPhi=quadraturePressure%gaussBasisFunctions(rowElementParameterIdx,NO_PART_DERIV,gaussNumber)
              jacobianGaussWeight=geometricInterpPointMetrics%jacobian*quadraturePressure%gaussWeights(gaussNumber)
            ENDIF
            !------------------
            ! J A C O B I A N
            !------------------
              ...
              DO columnComponentIdx=1,numberOfDimensions+1
                DO columnElementParameterIdx=1,numberOfElementParameters(columnComponentIdx)
                  ...
                  IF(columnComponentIdx <= numberOfDimensions) THEN
                    columnPhi=quadratureVelocity%gaussBasisFunctions(columnElementParameterIdx,NO_PART_DERIV,gaussNumber)
                  ELSE
                    columnPhi=quadraturePressure%gaussBasisFunctions(columnElementParameterIdx,NO_PART_DERIV,gaussNumber)
                  ENDIF
                  ...
                  ELSE
                    ...
                    IF(.NOT. linearElement) THEN
                      columndPhi2dXi(1,1)=quadratureVelocity% &
                        & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S1_S1,gaussNumber)
                      columndPhi2dXi(1,2)=quadratureVelocity% &
                        & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S1_S2,gaussNumber)
                      columndPhi2dXi(2,1)=quadratureVelocity% &
                        & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S1_S2,gaussNumber)
                      columndPhi2dXi(2,2)=quadratureVelocity% &
                        & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S2_S2,gaussNumber)
                      IF(numberOfDimensions > 2) THEN
                        columndPhi2dXi(1,3)=quadratureVelocity% &
                          & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S1_S3,gaussNumber)
                        columndPhi2dXi(2,3)=quadratureVelocity% &
                          & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S2_S3,gaussNumber)
                        columndPhi2dXi(3,1)=quadratureVelocity% &
                          & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S1_S3,gaussNumber)
                        columndPhi2dXi(3,2)=quadratureVelocity% &
                          & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S2_S3,gaussNumber)
                        columndPhi2dXi(3,3)=quadratureVelocity% &
                          & gaussBasisFunctions(columnElementParameterIdx,PART_DERIV_S3_S3,gaussNumber)
                      ENDIF
                    ENDIF
            ...
            ELSE
              IF(rowComponentIdx == numberOfDimensions+1) THEN
                ...
                nonlinearMatrices%elementResidual%vector(rowElementDOFIdx)= &
                  & nonlinearMatrices%elementResidual%vector(rowElementDOFIdx) + PSPG
              ...
              ELSE
                ...
                nonlinearMatrices%elementResidual%vector(rowElementDOFIdx)= &
                  & nonlinearMatrices%elementResidual%vector(rowElementDOFIdx) + momentumTerm
              ENDIF
            ENDIF ! jacobian/residual
          END DO !rowElementParameterIdx
        END DO !rowComponentIdx
...
999 ERRORSEXITS("NavierStokes_ResidualBasedStabilisation",err,error)
  ...
  SUBROUTINE NavierStokes_CalculateElementMetrics(equationsSet,elementNumber,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: dimensionIdx,gaussNumber,info,lWork,numberOfDependentComponents, &
      & numberOfElementParameters,numberOfDimensions,numberOfXi,rowComponentIdx,rowElementParameterIdx,variableType,xiIdx
    REAL(DP) :: cellReynoldsNumber,cellCourantNumber,timeIncrement
    REAL(DP) :: dPhidXVelocity(27,3)
    REAL(DP) :: dXidX(3,3)
    REAL(DP) :: velocity(3),meshVelocity(3),avgVelocity(3),velocityNorm,velocityPrevious(3),velocityDeriv(3,3)
    REAL(DP) :: rowPhi,jacobianGaussWeight,sum,sum2,mu,rho,normCMatrix,normKMatrix,normMMatrix,muScale
    ...
    CASE(EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE, &
      ...
      CALL EquationsInterpolation_PreviousDependentParametersGet(interpolation,FIELD_U_VARIABLE_TYPE, &
        & prevDependentInterpParameters,err,error,*999)
      NULLIFY(prevDependentInterpPoint)
      CALL EquationsInterpolation_PreviousDependentPointGet(interpolation,FIELD_U_VARIABLE_TYPE,prevDependentInterpPoint, &
        & err,error,*999)
      NULLIFY(independentInterpParameters)
      NULLIFY(independentInterpPoint)
      IF(equationsSet%specification(3)==EQUATIONS_SET_ALE_RBS_NAVIER_STOKES_SUBTYPE) THEN
      ...
      IF(equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
        CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,muScale,err,error,*999)
      ELSE
        CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,mu,err,error,*999)
      ENDIF
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2,rho,err,error,*999)
      ...
      avgVelocity = 0.0_DP
      DO gaussNumber = 1,quadratureVelocity%numberOfGauss
        ...
        IF(equationsSet%specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
          ...
          ! Get the gauss point based value returned from the CellML solver
          CALL Field_ParameterSetGetLocalGaussPoint(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
            & gaussNumber,elementNumber,1,mu,err,error,*999)
          mu=mu*muScale
        ENDIF
...
999 ERRORSEXITS("NavierStokes_CalculateElementMetrics",err,error)
  ...
  SUBROUTINE NavierStokes_FiniteElementBoundaryIntegrate(equationsSet,elementNumber,dependentVariable,jacobianFlag,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local variables
    INTEGER(INTG) :: boundaryIdx, boundaryNumber, xiDirection(4), orientation,rowComponentIdx,rowElementBaseDOFIdx
    INTEGER(INTG) :: componentIdx, gaussIdx, columnComponentIdx,columnElementBaseDOFIdx,columnElementDOFIndex
    INTEGER(INTG) :: elementNodeIdx, columnElementParameterIdx,rowElementDOFIndex
    INTEGER(INTG) :: globalNodeDerivativeIdx,rowElementParameterIdx
    INTEGER(INTG) :: columnNodeDerivativeIdx,columnNodeIdx,columnParameterIdx
    INTEGER(INTG) :: elementNodeIdx2
    INTEGER(INTG) :: globalNodeDerivativeIdx2,numberOfDependentComponents
    INTEGER(INTG) :: numberOfDimensions,numberOfElementBoundaries,boundaryType,dependentVariableType,xiIdx
    INTEGER(INTG) :: rowNodeIdx,rowNodeDerivativeIdx,rowParameterIdx
    ...
    CASE(EQUATIONS_SET_STATIC_RBS_NAVIER_STOKES_SUBTYPE, &
      ...
      IF(.NOT.ALLOCATED(decompositionElements%elements)) &
        & CALL FlagError("Decomposition elements elements is not allocated.",err,error,*999)
      decompositionElement=>decompositionElements%elements(elementNumber)
      ...
      IF(integratedBoundary) THEN
        IF(numberOfDimensions /= 2 .AND. numberOfDimensions /=3) THEN
          localError="Invalid number of dimensions ("//TRIM(NumberToVString(numberOfDimensions,"*",err,error))// &
            & ") for a 2D or 3D Navier-Stokes problem."
          CALL FlagError(localError,err,error,*999)
        ENDIF
        IF(numberOfDimensions == 3 .AND. decomposition%calculateFaces) THEN
          numberOfElementBoundaries = dependentBasis1%numberOfLocalFaces
        ELSE IF(numberOfDimensions == 2 .AND. decomposition%calculateLines) THEN
          numberOfElementBoundaries = dependentBasis1%numberOfLocalLines
        ELSE
          integratedBoundary = .FALSE.
        ENDIF
      ENDIF
      ...
      IF(integratedBoundary) THEN
        !Get the density
        CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2,density,err,error,*999)
        ...
        DO boundaryIdx=1,numberOfElementBoundaries
          ...
          IF(numberOfDimensions == 3) THEN
            IF(.NOT.ALLOCATED(decompositionElement%elementFaces)) &
              & CALL FlagError("Decomposition element faces is not allocated.",err,error,*999)
            boundaryNumber=decompositionElement%elementFaces(boundaryIdx)
            IF(.NOT.ALLOCATED(decompositionFaces%faces)) &
              & CALL FlagError("Decomposition faces faces is not allocated.",err,error,*999)
            face=>decompositionFaces%faces(boundaryNumber)
            ...
            CASE(BASIS_SIMPLEX_TYPE)
              orientation=1
            CASE DEFAULT
              localError="Face integration for basis type "//TRIM(NumberToVString(dependentBasis1%TYPE,"*",err,error))// &
          ...
          ELSE IF(numberOfDimensions == 2) THEN
            IF(.NOT.ALLOCATED(decompositionElement%elementLines)) &
              & CALL FlagError("Decomposition element lines is not allocated.",err,error,*999)
            boundaryNumber=decompositionElement%elementLines(boundaryIdx)
            IF(.NOT.ALLOCATED(decompositionLines%lines)) &
              & CALL FlagError("Decomposition lines lines is not allocated.",err,error,*999)
            line=>decompositionLines%lines(boundaryNumber)
            ...
            SELECT CASE(dependentBasis1%TYPE)
            CASE(BASIS_LAGRANGE_HERMITE_TP_TYPE)
              xiDirection(2)=ABS(line%xiDirection)
              xiDirection(1)=OTHER_XI_DIRECTIONS2(xiDirection(2))
              orientation=SIGN(1,OTHER_XI_ORIENTATIONS2(xiDirection(1))*line%xiDirection)
            CASE(BASIS_SIMPLEX_TYPE)
              orientation=1
            CASE DEFAULT
              localError="Line integration for basis type "//TRIM(NumberToVString(dependentBasis1%TYPE,"*",err,error))// &
                & " is not yet implemented for Navier-Stokes boundary integration."
              CALL FlagError(localError,err,error,*999)
            END SELECT
            NULLIFY(basis1)
          ...
          ! Loop over gauss points
          DO gaussIdx=1,quadratureScheme1%numberOfGauss
            ...
            IF(numberOfDimensions == 3) THEN
              ...
              CALL CrossProduct(geometricInterpPointMetrics%dXdXi(:,1),geometricInterpPointMetrics%dXdXi(:,2), &
                & normalProjection,err,error,*999)
              ...
              CALL Field_InterpolationParametersFaceGet(FIELD_VALUES_SET_TYPE,boundaryNumber,dependentInterpParameters, &
                & err,error,*999)
            ELSE
              CALL Field_InterpolatedPointMetricsCalculate(COORDINATE_JACOBIAN_LINE_TYPE,geometricInterpPointMetrics,err,error,*999)
              ! Make sure this is the boundary that corresponds with the provided normal (could be a wall rather than inlet/outlet)
            ...
            jacobianGaussWeights=geometricInterpPointMetrics%jacobian*quadratureScheme1%gaussWeights(gaussIdx)
            !Loop over field components
            DO rowComponentIdx=1,numberOfDimensions
              !Work out the first index of the vector for this element - (i.e. the number of previous)
              rowElementBaseDOFIdx=dependentBasis1%numberOfElementParameters*(rowComponentIdx-1)
              DO rowNodeIdx=1,basis1%numberOfNodes
                IF(numberOfDimensions == 3) THEN
                  elementNodeIdx=dependentBasis1%nodeNumbersInLocalFace(rowNodeIdx,boundaryIdx)
                ELSE
                  elementNodeIdx=dependentBasis1%nodeNumbersInLocalLine(rowNodeIdx,boundaryIdx)
                ENDIF
                DO rowNodeDerivativeIdx=1,basis1%numberOfDerivatives(rowNodeIdx)
                  IF(numberOfDimensions == 3) THEN
                    globalNodeDerivativeIdx= &
                      & dependentBasis1%derivativeNumbersInLocalFace(rowNodeDerivativeIdx,rowNodeIdx,boundaryIdx)
                  ELSE
                    globalNodeDerivativeIdx=dependentBasis1%derivativeNumbersInLocalLine(rowNodeIdx,boundaryIdx)
                  ENDIF
                  rowElementParameterIdx=dependentBasis1%elementParameterIndex(globalNodeDerivativeIdx,elementNodeIdx)
                  rowParameterIdx=basis1%elementParameterIndex(rowNodeDerivativeIdx,rowNodeIdx)
                  rowElementDOFIndex=rowElementBaseDOFIdx+rowElementParameterIdx
                  rowPhi=quadratureScheme1%gaussBasisFunctions(rowParameterIdx,NO_PART_DERIV,gaussIdx)
                  ...
                  IF (.NOT. jacobianFlag) THEN
                    IF (boundaryType==BOUNDARY_CONDITION_PRESSURE .OR. &
                      ...
                      nonlinearMatrices%elementResidual%vector(rowElementDOFIndex)= &
                        & nonlinearMatrices%elementResidual%vector(rowElementDOFIndex)-&
                  ...
                  ELSE
                    IF(ABS(beta) > ZERO_TOLERANCE) THEN
                      DO columnComponentIdx=1,numberOfDimensions
                        ...
                        columnElementBaseDOFIdx=dependentBasis2%numberOfElementParameters*(columnComponentIdx-1)
                        DO columnNodeIdx=1,basis2%numberOfNodes
                          IF(numberOfDimensions == 3) THEN
                            elementNodeIdx2=dependentBasis2%nodeNumbersInLocalFace(columnNodeIdx,boundaryIdx)
                          ELSE
                            elementNodeIdx2=dependentBasis2%nodeNumbersInLocalLine(columnNodeIdx,boundaryIdx)
                          ENDIF
                          DO columnNodeDerivativeIdx=1,basis2%numberOfDerivatives(columnNodeIdx)
                            IF(numberOfDimensions == 3) THEN
                              globalNodeDerivativeIdx2=dependentBasis2%derivativeNumbersInLocalFace(columnNodeDerivativeIdx, &
                                & columnNodeIdx,boundaryIdx)
                            ELSE
                              globalNodeDerivativeIdx2=dependentBasis2%derivativeNumbersInLocalLine(columnNodeIdx,boundaryIdx)
                            ENDIF
                            columnElementParameterIdx= &
                              & dependentBasis2%elementParameterIndex(globalNodeDerivativeIdx2,elementNodeIdx2)
                            columnParameterIdx=basis2%elementParameterIndex(columnNodeDerivativeIdx,columnNodeIdx)
                            ...
                            DO xiIdx=1,basis2%numberOfXi
                              columndPhidXi(xiIdx)=quadratureScheme2%gaussBasisFunctions(columnParameterIdx, &
...
999 ERRORSEXITS("NavierStokes_FiniteElementBoundaryIntegrate",err,error)
  ...
  SUBROUTINE NavierStokes_CalculateBoundaryFlux(equationsSet,coupledEquationsSet,iteration3D1D, &
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: boundaryID,boundaryType, &
      & componentIdx,computationNode,coupledNodeNumber,dependentVariableType,elementIdx, &
      & elementNodeIdx,faceIdx,faceNodeIdx,faceNodeDerivativeIdx,faceNumber,gaussIdx,groupCommunicator,i,j,meshComponentNumber, &
      & MPI_IERROR,nodeNumber,normalComponentIdx,numberOfBoundaries,numberOfDimensions,numberOfGlobalBoundaries, &
      & numberOfGroupComputationNodes,versionNumber
    ...
    REAL(DP) :: couplingFlow,couplingStress,p1D,q1D,a1D,p3D,stress1DPrevious,p0D,q0D
    REAL(DP) :: flowError,pressureError
    LOGICAL :: couple1DTo3D,couple3DTo1D,boundary3D0DFound(10)
   ...
   TYPE(EquationsVectorType), POINTER :: vectorEquations
    ...
    CASE(EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE, &
      ...
      dependentVariableType=dependentVariable3D%variableType
      ...
      !Get interpolations
      NULLIFY(interpolation)
      CALL Equations_InterpolationGet(equations3d,interpolation,err,error,*999)
      NULLIFY(geometricInterpParameters)
      CALL EquationsInterpolation_GeometricParametersGet(interpolation,FIELD_U_VARIABLE_TYPE,geometricInterpParameters, &
        & err,error,*999)
      NULLIFY(geometricInterpPoint)
      CALL EquationsInterpolation_GeometricPointGet(interpolation,FIELD_U_VARIABLE_TYPE,geometricInterpPoint,err,error,*999)
      NULLIFY(geometricInterpPointMetrics)
      CALL EquationsInterpolation_GeometricPointMetricsGet(interpolation,FIELD_U_VARIABLE_TYPE, &
      ...
      CALL Field_ParameterSetGetConstant(equationsSetField3D,FIELD_U1_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
       & 2,toleranceCourant,err,error,*999)
      IF(equationsSet%Specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
        CALL Field_ParameterSetGetConstant(materialsField3D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,muScale,err,error,*999)
      ELSE
        CALL Field_ParameterSetGetConstant(materialsField3D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,mu,err,error,*999)
      ENDIF
      ...
      DO elementIdx=1,elementsMapping3D%numberOfLocal
        ...
        IF (toleranceCourant > ZERO_TOLERANCE) THEN
          ...
          IF(courant > toleranceCourant) THEN
            localError="Element "//TRIM(NumberToVString(decompositionElement%userNumber, &
              & "*",err,error))//" has violated the CFL condition "//TRIM(NumberToVString(courant, &
              & "*",err,error))//" <= "//TRIM(NumberToVString(toleranceCourant,"*",err,error))// &
        ...
        IF(boundaryID>1) THEN
          ...
          DO faceIdx=1,dependentBasis%numberOfLocalFaces
            ...
            IF(.NOT.ALLOCATED(decompositionElement%elementFaces)) &
              & CALL FlagError("Decomposition element faces is not allocated.",err,error,*999)
            faceNumber=decompositionElement%elementFaces(faceIdx)
            ...
            DO gaussIdx=1,faceQuadratureScheme%numberOfGauss
              ...
              IF(boundaryType==BOUNDARY_CONDITION_COUPLING_STRESS .OR. &
               & boundaryType==BOUNDARY_CONDITION_COUPLING_FLOW) THEN
                ...
                IF(equationsSet%Specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
                  ! Get the gauss point based value returned from the CellML solver
                  CALL Field_ParameterSetGetLocalGaussPoint(materialsField3D,FIELD_V_VARIABLE_TYPE, &
              ...
              DO componentIdx=1,numberOfDimensions
                ...
                faceVelocity=faceVelocity+velocityGauss(componentIdx)*faceNormal(componentIdx)*gaussWeight* &
                  & geometricInterpPointMetrics%jacobian
                facePressure=facePressure+pressureGauss*faceNormal(componentIdx)*gaussWeight*geometricInterpPointMetrics%jacobian
                IF(boundaryType==BOUNDARY_CONDITION_COUPLING_STRESS .OR. &
                 & boundaryType==BOUNDARY_CONDITION_COUPLING_FLOW) THEN
                  faceTraction = faceTraction + (viscousTerm(componentIdx) - pressureGauss)* &
                    & faceNormal(componentIdx)*gaussWeight*geometricInterpPointMetrics%jacobian
                ENDIF
              ENDDO !componentIdx
            ENDDO !gaussIdx
          ENDDO !faceIdx
    ...
    CASE DEFAULT
      localError="Boundary flux calcluation for equations type "//TRIM(NumberToVString(equationsSet%Specification(3),"*", &
    ...
    DO elementIdx=1,elementsMapping3D%totalNumberOfLocal
      CALL Field_ParameterSetGetLocalElement(equationsSetField3D,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
       & elementIdx,5,elementNormal(1),err,error,*999)
      CALL Field_ParameterSetGetLocalElement(equationsSetField3D,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
       & elementIdx,6,elementNormal(2),err,error,*999)
      ...
      IF(boundaryID>1) THEN
        ...
        IF(boundaryType==BOUNDARY_CONDITION_COUPLING_STRESS .OR. &
          ...
          normal = 0.0_DP
          DO componentIdx =1,2
             CALL Field_ParameterSetGetNode(independentField1D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          ...
          IF(couple3DTo1D) THEN
            ...
            CALL Field_ParameterSetUpdateNode(dependentField1D,FIELD_U1_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          ...
          ELSE IF(couple1DTo3D) THEN
            ...
            CALL Field_ParameterSetGetNode(dependentField1D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
              & 1,1,coupledNodeNumber,1,q1D,err,error,*999)
            CALL Field_ParameterSetGetNode(dependentField1D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
              & 1,1,coupledNodeNumber,2,a1D,err,error,*999)
            CALL Field_ParameterSetGetNode(dependentField1D,FIELD_U2_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
            ...
            CALL Field_ParameterSetGetNode(dependentField1D,FIELD_U2_VARIABLE_TYPE,FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE, &
              & 1,1,coupledNodeNumber,2,stress1DPrevious,err,error,*999)
            CALL Field_ParameterSetGetConstant(materialsField1D,FIELD_U_VARIABLE_TYPE, &
            ...
            CALL Field_ParameterSetUpdateNode(dependentField1D,FIELD_U2_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
              & 1,1,coupledNodeNumber,2,couplingStress,err,error,*999)
            CALL Field_ParameterSetUpdateNode(dependentField1D,FIELD_U2_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
        ...
        ! --------------------------------------------------
        DO faceIdx=1,dependentBasis2%numberOfLocalFaces
          !Get the face normal and quadrature information
          IF(.NOT.ALLOCATED(decompositionElement%elementFaces)) &
            & CALL FlagError("Decomposition element faces is not allocated.",err,error,*999)
          faceNumber=decompositionElement%elementFaces(faceIdx)
          ...
          CASE(BASIS_LAGRANGE_HERMITE_TP_TYPE)
            ...
            CALL Field_InterpolateLocalFaceGauss(FIRST_PART_DERIV,BASIS_DEFAULT_QUADRATURE_SCHEME,faceIdx,1, &
              & geometricInterpPoint,err,error,*999)
          ...
          CASE DEFAULT
            localError="Face integration for basis type "//TRIM(NumberToVString(dependentBasis2%TYPE,"*",err,error))// &
              & " is not yet implemented for Navier-Stokes."
            CALL FlagError(localError,err,error,*999)
          END SELECT
          CALL L2Norm(elementNormal-unitNormal,normalDifference,err,error,*999)
          ...
          DO faceNodeIdx=1,faceBasis%numberOfNodes
            elementNodeIdx=dependentBasis2%nodeNumbersInLocalFace(faceNodeIdx,faceIdx)
            DO faceNodeDerivativeIdx=1,faceBasis%numberOfDerivatives(faceNodeIdx)
              nodeNumber=domainElements%elements(elementIdx)%elementNodes(elementNodeIdx)
              versionNumber=1
              ...
              ELSE
                ...
                CALL Field_ParameterSetUpdateLocalNode(equationsSetField3D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
...
999 ERRORSEXITS("NavierStokes_CalculateBoundaryFlux",err,error)
  ...
  SUBROUTINE NavierStokes_Couple1D0D(controlLoop,solver,err,error,*)
    ...
    REAL(DP) :: a0Param,eParam,hParam,beta,pCellML,normalWave(2),startTime,stopTime,currentTime,timeIncrement
    ...
    DO nodeIdx=1,numberOfLocalNodes1D
      ...
      IF(ABS(normalWave(1))>ZERO_TOLERANCE .AND. boundaryNode .AND. coupled1D0DBoundary) THEN
        ...
        !Get material parameters
        CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          & versionIdx,derivativeIdx,nodeNumber,1,a0Param,err,error,*999)
        CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          & versionIdx,derivativeIdx,nodeNumber,2,eParam,err,error,*999)
        CALL Field_ParameterSetGetLocalNode(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          & versionIdx,derivativeIdx,nodeNumber,3,hParam,err,error,*999)
        beta=(4.0_DP*SQRT(PI)*eParam*hParam)/(3.0_DP*a0Param)
        ...
        IF(iteration == 1 .AND. timestep == 0) THEN
          ...
          NULLIFY(dependentVariable)
          CALL Field_VariableGet(dependentField,FIELD_U_VARIABLE_TYPE,dependentVariable,err,error,*999)
          NULLIFY(previousParameterSet)
          CALL FieldVariable_ParameterSetCheck(dependentVariable,FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE, &
            & previousParameterSet,err,error,*999)
          IF(.NOT.ASSOCIATED(previousParameterSet)) &
            & CALL Field_ParameterSetCreate(dependentField,FIELD_U_VARIABLE_TYPE, &
            & FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE,err,error,*999)
          NULLIFY(dependentVariable)
          ...
          CALL FieldVariable_ParameterSetCheck(dependentVariable,FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE, &
            & previousParameterSet,err,error,*999)
          IF(.NOT.ASSOCIATED(previousParameterSet)) &
            & CALL Field_ParameterSetCreate(dependentField,FIELD_U1_VARIABLE_TYPE, &
            & FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE,err,error,*999)
        ELSE
          !Get previous Q1D
...
999 ERRORSEXITS("NavierStokes_Couple1D0D",err,error)
  ...
  SUBROUTINE NavierStokes_Couple3D1D(controlLoop,err,error,*)
    ...
    REAL(DP) :: flow1D,stress1D,flow3D,stress3D,flowError,stressError
    ...
    CASE(PROBLEM_MULTISCALE_NAVIER_STOKES_SUBTYPE)
      ...
      NULLIFY(independentField)
      CALL EquationsSet_IndependentFieldGet(equationsSet1D,independentField,err,error,*999)
      ...
      IF(ABS(normalWave(1))>ZERO_TOLERANCE .OR. ABS(normalWave(2))>ZERO_TOLERANCE) THEN
        ...
        IF(diagnostics1) THEN
          IF (boundaryNumber ==1) THEN
            CALL WriteStringValue(DIAGNOSTIC_OUTPUT_TYPE,"------3D-1D----- iteration:  ",iteration,err,error,*999)
          ENDIF
        ...
        CALL Field_ParameterSetUpdateLocalNode(dependentField1D,FIELD_U1_VARIABLE_TYPE, &
        ...
        CALL Field_ParameterSetUpdateLocalNode(dependentField1D,FIELD_U2_VARIABLE_TYPE, &
    ...
    IF(numberOfGroupComputationNodes>1) THEN !use mpi
      ...
      CALL MPI_ERROR_CHECK("MPI_ALLREDUCE",MPI_IERROR,err,error,*999)
      IF(globalConverged) CALL ControlLoop_ContinueLoopSet(controlLoop,.FALSE.,err,error,*999)
      IF(diagnostics1) THEN
        IF(globalConverged) THEN
          CALL WriteStringValue(DIAGNOSTIC_OUTPUT_TYPE,"3D/1D coupling converged; # iterations: ", &
            & iteration,err,error,*999)          
        ELSE
      ...
      IF(diagnostics1) THEN
        IF(localConverged) THEN
          CALL WriteStringValue(DIAGNOSTIC_OUTPUT_TYPE,"3D/1D coupling converged; # iterations: ", &
            & iteration,err,error,*999)        
        ELSE
          CALL WriteStringValue(DIAGNOSTIC_OUTPUT_TYPE,"3D/1D max flow error:  ", &
            & maxFlowError,err,error,*999)
          CALL WriteStringValue(DIAGNOSTIC_OUTPUT_TYPE,"3D/1D max stress error: ", &
            & maxStressError,err,error,*999)
        ENDIF
      ENDIF
    ENDIF
...
999 ERRORSEXITS("NavierStokes_Couple3D1D",err,error)
  ...
  SUBROUTINE NavierStokes_CoupleCharacteristics(controlLoop,solver,err,error,*)
    ...
    REAL(DP) :: rho,alpha,normalWave,a0Param,eParam,hParam,beta,aNew,penaltyCoeff
    ...
    CALL Field_ParameterSetGetConstant(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
    ...
    DO nodeIdx=1,domainNodes%numberOfNodes
      ...
      !DEBUG
      CALL Field_ParameterSetGetLocalNode(independentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
        & 1,1,nodeNumber,1,normalWave,err,error,*999)
      !Find branch nodes
      IF(numberOfVersions>1) THEN
          ...
          DO versionIdx=1,numberOfVersions
            ...
            IF(ABS(normalWave)>ZERO_TOLERANCE) THEN
              ...
              IF(boundaryNode) THEN
                ...
                CALL Field_ParameterSetUpdateLocalNode(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_PREVIOUS_VALUES_SET_TYPE, &
                  & versionIdx,derivativeIdx,nodeNumber,2,aNew,err,error,*999)
              ENDIF
...
999 ERRORSEXITS("NavierStokes_CoupleCharacteristics",err,error)
  ...
  SUBROUTINE NavierStokes_ShearRateCalculate(equationsSet,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: elementIdx,decompositionLocalElementNumber,gaussIdx,i,j,localElementNumber, &
      & numberOfDimensions,startElement,stopElement,userElementNumber,variableType
    ...
    LOGICAL :: defaultUpdate,elementExists,ghostElement
    ...
    CASE(EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE)
      ...
      CALL EquationsInterpolation_GeometricPointMetricsGet(interpolation,FIELD_U_VARIABLE_TYPE, &
        & geometricInterpPointMetrics,err,error,*999)
      NULLIFY(dependentInterpParameters)
      CALL EquationsInterpolation_DependentParametersGet(interpolation,variableType,geometricInterpParameters,err,error,*999)
      NULLIFY(dependentInterpPoint)
      CALL EquationsInterpolation_DependentPointGet(interpolation,variableType,geometricInterpPoint,err,error,*999)
      
      defaultUpdate=.FALSE.

      ! Loop over internal and boundary elements, skipping ghosts
      startElement = elementsMapping%internalStart
      stopElement = elementsMapping%boundaryFinish
      ! Loop over internal and boundary elements
      DO elementIdx=startElement,stopElement
        localElementNumber= elementsMapping%domainList(elementIdx)
        userElementNumber = elementsMapping%localToGlobalMap(localElementNumber)
      ...
      IF(defaultUpdate) THEN
        ...
        CALL Field_ComponentValuesInitialise(materialsField,FIELD_V_VARIABLE_TYPE, &
...
999 ERRORS("NavierStokes_FiniteElementPreResidualEvaluate",err,error)
  ...
  SUBROUTINE NavierStokes_ControlLoopPostLoop(controlLoop,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: numberOfSolvers,numberOfSolvers2,solverIdx,solverIdx2,equationsSetIdx,equationsSetIdx2
    ...
    CASE(PROBLEM_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE, &
      ...
      CASE(CONTROL_TIME_LOOP_TYPE)
        ...
        NULLIFY(decomposition)
        CALL Field_DecompositionGet(dependentField,decomposition,err,error,*999)
        IF(decomposition%calculateFaces) CALL NavierStokes_CalculateBoundaryFlux3D0D(equationsSet,err,error,*999)
    ...
    CASE(PROBLEM_MULTISCALE_NAVIER_STOKES_SUBTYPE, &
            ...
            DO equationsSetIdx = 1,solverMapping%NUMBER_OF_EQUATIONS_SETS
              ...
              CASE(EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
                ...
                IF (problem%specification(3)==PROBLEM_MULTISCALE_NAVIER_STOKES_SUBTYPE) THEN
                  ...
                  NULLIFY(iterativeWhileLoop3)
                  CALL ControlLoop_SubLoopGet(iterativeWhileLoop2,2,iterativeWhileLoop3,err,error,*999)
                  IF(iterativeWhileLoop3%numberOfSubLoops/=0) &
      ...
      CASE(CONTROL_TIME_LOOP_TYPE)
        ...
        IF(controlLoop%numberOfSubLoops==0) &
          ...
          DO subloopIdx2=1,subloop%numberOfSubLoops
            ...
            IF(subloop2%numberOfSubLoops>0) THEN
              ...
              DO subloopIdx3=1,subloop2%numberOfSubLoops
                ...
                IF(subloop3%numberOfSubLoops>0) CALL FlagError("Unrecognized number of subloops in 3D-1D-0D.",err,error,*999)
                NULLIFY(solvers)
...
999 ERRORSEXITS("NavierStokes_ControlLoopPostLoop",err,error)
  ...
  SUBROUTINE NavierStokes_UpdateMultiscaleBoundary(equationsSet,boundaryConditions,timeIncrement,err,error,*)
    ...
    CASE(EQUATIONS_SET_TRANSIENT1D_NAVIER_STOKES_SUBTYPE, &
      ...
      numberOfLocalNodes=dependentDomainNodes%numberOfNodes
      derivativeIdx=1
      !Get constant material parameters
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2,rho,err,error,*999)
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,4,pExternal,err,error,*999)
      !Get materials scale factors
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,5,lengthScale,err,error,*999)
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,6,timeScale,err,error,*999)
      CALL Field_ParameterSetGetConstant(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,7,massScale,err,error,*999)
            ...
            DO componentIdx=1,2
              ...
              CASE(BOUNDARY_CONDITION_FIXED_NONREFLECTING)
                ...
                IF(ABoundary < ZERO_TOLERANCE) THEN
                  localError="Negative area 1D non-reflecting boundary detected at node "//TRIM(NumberToVString(nodeIdx, &
                   & "*",err,error))//"."
                  CALL FlagError(localError,err,error,*999)
                ENDIF
                CALL Field_ParameterSetUpdateLocalNode(dependentField,FIELD_U_VARIABLE_TYPE, &
              ...
              CASE(BOUNDARY_CONDITION_FIXED_CELLML)
                ...
                ABoundary = (((2.0_DP*rho)/(beta))**2.0_DP)* &
                  & (((W1-W2)/8.0_DP+SQRT(beta/(2.0_DP*rho))*((A0)**0.25_DP))**4.0_DP)
                IF(ABoundary < ZERO_TOLERANCE) THEN
                  localError="Negative area coupled 1D0D boundary detected at node "//TRIM(NumberToVString(nodeIdx, &
                   & "*",err,error))//"."
                  CALL FlagError(localError,err,error,*999)
                ENDIF
                CALL Field_ParameterSetUpdateLocalNode(dependentField,FIELD_U_VARIABLE_TYPE, &
              ...
              CASE(BOUNDARY_CONDITION_COUPLING_STRESS)
                ...
                !ABoundary=A3D
                IF(ABoundary < ZERO_TOLERANCE) THEN
                  localError="Negative area coupled 3D1D boundary detected at node "//TRIM(NumberToVString(nodeIdx, &
                   & "*",err,error))//"."
                  CALL FlagError(localError,err,error,*999)
                ENDIF
              ...
              CASE(BOUNDARY_CONDITION_FIXED_STREE)
                ...
                CALL Field_ParameterSetDataGet(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                  & flow,err,error,*999)
                pCellml = 0.0_DP
                DO k=1,size(flow)
...
999 ERRORSEXITS("NavierStokes_UpdateMultiscaleBoundary",err,error)
  ...
  SUBROUTINE NavierStokes_CalculateBoundaryFlux3D0D(equationsSet,err,error,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
    INTEGER(INTG) :: faceIdx, faceNumber,elementIdx,nodeNumber,numberOfDimensions,versionNumber
    ...
    REAL(DP) :: jacobianGaussWeight, elementNormal(3)
    REAL(DP) :: normalDifference,normalTolerance
    ...
    REAL(DP) :: localBoundaryFlux(10),localBoundaryArea(10),globalBoundaryFlux(10),globalBoundaryArea(10)
    REAL(DP) :: localBoundaryPressure(10),globalBoundaryPressure(10),globalBoundaryMeanPressure(10)
    REAL(DP) :: localBoundaryNormalStress(10)
    REAL(DP) :: p0D,q0D
    ...
    TYPE(EquationsMappingNonlinearType), POINTER :: nonlinearMapping
    TYPE(EquationsVectorType), POINTER :: vectorEquations
    TYPE(FieldType), POINTER :: dependentField3D,equationsSetField3D,geometricField3D
    TYPE(FieldInterpolatedPointType), POINTER :: dependentInterpPoint,geometricInterpPoint
    TYPE(FieldInterpolationParametersType), POINTER :: dependentInterpParameters,geometricInterpParameters
    TYPE(FieldInterpolatedPointMetricsType), POINTER :: geometricInterpPointMetrics
    TYPE(FieldVariableType), POINTER :: dependentVariable3D
    ...
    CASE(EQUATIONS_SET_MULTISCALE3D_NAVIER_STOKES_SUBTYPE, &
      ...
      CALL Field_ParameterSetGetConstant(equationsSetField3D,FIELD_U1_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
       & 2,toleranceCourant,err,error,*999)
      IF(equationsSet%Specification(3)==EQUATIONS_SET_CONSTITUTIVE_MU_NAVIER_STOKES_SUBTYPE) THEN
        CALL Field_ParameterSetGetConstant(equationsSet%materials%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
      ...
      DO elementIdx=1,elementsMapping3D%numberOfLocal
        ...
        IF (toleranceCourant > ZERO_TOLERANCE) THEN
          ...
          IF(courant < -ZERO_TOLERANCE) THEN
            CALL FlagWarning("Negative Courant (CFL) number.",err,error,*999)
          ENDIF
          IF(courant > maxCourant) maxCourant = courant
          ! Check if element CFL number below specified tolerance
          IF(courant > toleranceCourant) THEN
          ...
          DO faceIdx=1,dependentBasis%numberOfLocalFaces
           ...
           ! Loop over face gauss points
            DO gaussIdx=1,faceQuadratureScheme%numberOfGauss
              ...
              jacobianGaussWeight=geometricInterpPointMetrics%jacobian*faceQuadratureScheme%gaussWeights(gaussIdx)
            ...
            DO faceNodeDerivativeIdx=1,faceBasis%numberOfDerivatives(faceNodeIdx)
              ...
              IF(boundaryType==BOUNDARY_CONDITION_FIXED_CELLML) THEN
                ...
                CALL Field_ParameterSetUpdateLocalNode(dependentField3D,FIELD_U_VARIABLE_TYPE, &
                  ...
                  & p0D,err,error,*999)
                CALL Field_ParameterSetUpdateLocalNode(equationsSetField3D,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_PREVIOUS_ITERATION_VALUES_SET_TYPE,versionNumber,faceNodeDerivativeIdx,nodeNumber,1, &
                  & q0D,err,error,*999)
                CALL Field_ParameterSetUpdateLocalNode(equationsSetField3D,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                  & versionNumber,faceNodeDerivativeIdx,nodeNumber,1,globalBoundaryFlux(boundaryID),err,error,*999)
              ENDIF
            END DO !faceNodeDerivativeIdx
          END DO !faceNodeIdx
        END DO !faceIdx
      ENDIF !boundaryIdentifier
    END DO !elementIdx
  ...
  SUBROUTINE NavierStokes_WallShearStressCalculate(equationsSet,err,error,*)
    ...
    CASE(EQUATIONS_SET_ALE_NAVIER_STOKES_SUBTYPE, &
      ...
      IF(ASSOCIATED(dependentVariable)) THEN
        ...
        CALL EquationsInterpolation_MaterialsPointGet(interpolation,FIELD_U_VARIABLE_TYPE,materialsInterpPoint, &
          & err,error,*999)

        !Loop over internal and boundary nodes
        startNode = nodesMappings%internalStart
        stopNode = nodesMappings%boundaryFinish
        !Loop over internal and boundary nodes
        nodes: DO nodeIdx=startNode,stopNode
          ...
          DO boundaryIdx=1,numberOfBoundaries
            ...
            CALL Field_PositionNormalTangentsCalculateIntPtMetric(geometricInterpPointMetrics,.FALSE.,position,normal,tangents, &
              & err,error,*999)
            numberOfXi=velocityBasis%numberOfXi
