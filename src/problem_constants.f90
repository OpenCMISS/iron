...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_DYNAMIC_FINITE_ELASTICITY_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: PROBLEM_FINITE_ELASTICITY_WITH_ACTIVE_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: PROBLEM_FINITE_ELASTICITY_WITH_CELLML_SUBTYPE=5
  INTEGER(INTG), PARAMETER :: PROBLEM_FINITE_ELASTICITY_WITH_GROWTH_CELLML_SUBTYPE=6
  INTEGER(INTG), PARAMETER :: PROBLEM_MULTISCALE_FINITE_ELASTICITY_SUBTYPE=7
