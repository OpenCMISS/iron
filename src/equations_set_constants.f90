...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_SMOOTH_MODEL_SUBTYPE=36
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_SMOOTH_MODEL_SUBTYPE=37
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_GROWTH_MODEL_SUBTYPE=38
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_GROWTH_MODEL_SUBTYPE=39
