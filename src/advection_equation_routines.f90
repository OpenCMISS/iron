    ...
    CASE(EQUATIONS_SET_ADVECTION_SUBTYPE)
       ...
       CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
             CALL Advection_EquationsSetSolutionMethodSet(EQUATIONS_SET,EQUATIONS_SET_FEM_SOLUTION_METHOD,err,error,*999)
       ...
       CASE(EQUATIONS_SET_SETUP_MATERIALS_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
             ...
             IF(.NOT.ASSOCIATED(EQUATIONS_MATERIALS)) CALL FlagError("Equations set materials is not associated.",err,error,*999)
             ...
             IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                   CALL FIELD_COMPONENT_INTERPOLATION_SET_AND_LOCK(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD, &
                        & FIELD_U_VARIABLE_TYPE,INDEPENDENT_FIELD_NUMBER_OF_COMPONENTS,FIELD_NODE_BASED_INTERPOLATION, &
                        & err,error,*999)
                   CALL FIELD_SCALING_TYPE_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,GEOMETRIC_SCALING_TYPE, &
                        & err,error,*999)
...
999 ERRORSEXITS("Advection_Couple1D0D",err,error)
  ...
  END SUBROUTINE Advection_Couple1D0D
