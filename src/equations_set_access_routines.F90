...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_ST_VENANT_KIRCHOFF_SUBTYPE=45
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_MOONEY_RIVLIN_SUBTYPE=46
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMP_ST_VENANT_KIRCHOFF_SUBTYPE=47
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMP_MOONEY_RIVLIN_SUBTYPE=48
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMP_MOONEY_RIVLIN_SUBTYPE=49
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ST_VENANT_KIRCHOFF_SUBTYPE=50
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMP_ST_VENANT_KIRCHOFF_SUBTYPE=51
