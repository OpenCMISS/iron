...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_EXPONENTIAL_POISSON_EQUATION_TWO_DIM_1=6 !<u=b^-1.ln((A^2+B^2)/(sin^2(Ax+By+C)))
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PRESSURE_POISSON_THREE_DIM_1=7 !<u=tbd, Pressure Poisson Equation (PPE) analytic
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PRESSURE_POISSON_THREE_DIM_2=8 !<u=tbd, Pressure Poisson Equation (PPE) without input data
  ...
  PUBLIC EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_1,EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_2, &
    ...
    & EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_3,EQUATIONS_SET_EXPONENTIAL_POISSON_EQUATION_TWO_DIM_1, &
