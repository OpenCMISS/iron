...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GUCCIONE_ACTIVECONTRACTION_NOLENDEP_SUBTYPE=33
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GUCCIONE_ACTIVECONTRACTION_2NDPIOLA_SUBTYPE=34
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTITUTIVE_AND_GROWTH_LAW_IN_CELLML_SUBTYPE=35
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GROWTH_LAW_IN_CELLML_SUBTYPE=36
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_STRAIN_SUBTYPE=37
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MULTISCALE_ACTIVE_STRAIN_SUBTYPE=38
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_SMOOTH_MODEL_SUBTYPE=39
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_SMOOTH_MODEL_SUBTYPE=40
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_GROWTH_MODEL_SUBTYPE=41
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_GROWTH_MODEL_SUBTYPE=42
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_MOONEY_RIVLIN_SUBTYPE=43
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_TRANSVERSE_GUCCIONE_SUBTYPE=44
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MR_AND_GROWTH_LAW_IN_CELLML_SUBTYPE=45
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_ST_VENANT_KIRCHOFF_SUBTYPE=46
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_MOONEY_RIVLIN_SUBTYPE=47
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMP_ST_VENANT_KIRCHOFF_SUBTYPE=48
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMP_MOONEY_RIVLIN_SUBTYPE=49
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMP_MOONEY_RIVLIN_SUBTYPE=50
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ST_VENANT_KIRCHOFF_SUBTYPE=51
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMP_ST_VENANT_KIRCHOFF_SUBTYPE=52
...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  !  Reaction Diffusion
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_SPLIT_GEN_REACT_DIFF_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_NOSPLIT_LINEAR_GEN_REACT_DIFF_SUBTYPE=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_NOSPLIT_NONLINEAR_GEN_REACT_DIFF_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GEN_FISHERS_SPLIT_REACT_DIFF_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GEN_FISHERS_NOSPLIT_REACT_DIFF_SUBTYPE=5
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DIFFUSION_TENSOR_FIBRE_DATA_FITTING_SUBTYPE=2
  !Gauss fitting
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_GROWTH_TENSOR=4 !<Deformation growth tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_R_CAUCHY_GREEN_DEFORMATION_TENSOR=5 !<Right Cauchy-Green deformation field \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_L_CAUCHY_GREEN_DEFORMATION_TENSOR=6 !<Right Cauchy-Green deformation field \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GREEN_LAGRANGE_STRAIN_TENSOR=7 !<Green-Lagrange strain tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR=8 !<Cauchy stress tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR_FIBRE=9 !<Cauchy stress tensor wrt deformed fibres \see EquationsSetConstants_TensorTypes,EquationsSetConstants
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIRST_PK_STRESS_TENSOR=10 !<First Piola Kirchhoff stress tensor \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SECOND_PK_STRESS_TENSOR=11 !<Second Piola Kirchhoff stress tensor \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  !>@}
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NUMBER_OF_TENSOR_TYPES=11
  ...
  !>@{  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_TWO_DIM_1=1 !<u=x**2+2*x*y-y**2 
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_TWO_DIM_2=2 !<u=cos(x)cosh(y)
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_THREE_DIM_1=3 !<u=x**2-2*y**2+z**2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_THREE_DIM_2=4 !<u=cos(x)*cosh(y)*z
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GENERALISED_LAPLACE_EQUATION_TWO_DIM_1=5 !<u=2.e^x.e^{-\lambda_{1}.y}cos(\lambda_{2}y)
  !>@}
  ...
  !>@{  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_1=1 !<u=ln(4/(x+y+1^2))
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_2=2 !<u=tbd
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_1=3 !<u=ln(6/(x+y+z+1^2))
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_2=4 !<u=tbd
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_3=5 !<u=tbd
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_QUADRATIC_POISSON_EQUATION_TWO_DIM_1=6 !<u=???
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_EXPONENTIAL_POISSON_EQUATION_TWO_DIM_1=7 !<u=b^-1.ln((A^2+B^2)/(sin^2(Ax+By+C)))
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PRESSURE_POISSON_THREE_DIM_1=8 !<u=tbd, Pressure Poisson Equation (PPE) analytic
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PRESSURE_POISSON_THREE_DIM_2=9 !<u=tbd, Pressure Poisson Equation (PPE) without input data
  !>@}
  ...
  PUBLIC EQUATIONS_SET_ONE_DIMENSIONAL_SUBTYPE,EQUATIONS_SET_TWO_DIMENSIONAL_PLANE_STRESS_SUBTYPE, &
    ...
    & EQUATIONS_SET_PLATE_SUBTYPE,EQUATIONS_SET_SHELL_SUBTYPE,EQUATIONS_SET_ONE_DIM_STOKES_DAMPING_SUBTYPE, &
  ...
  PUBLIC EQUATIONS_SET_CELLML_SPLIT_GEN_REACT_DIFF_SUBTYPE,EQUATIONS_SET_CELLML_NOSPLIT_LINEAR_GEN_REACT_DIFF_SUBTYPE, &
    & EQUATIONS_SET_CELLML_NOSPLIT_NONLINEAR_GEN_REACT_DIFF_SUBTYPE,EQUATIONS_SET_GEN_FISHERS_SPLIT_REACT_DIFF_SUBTYPE, &
  ...
  PUBLIC EQUATIONS_SET_GENERALISED_DATA_FITTING_SUBTYPE,EQUATIONS_SET_DIFFUSION_TENSOR_FIBRE_DATA_FITTING_SUBTYPE
  ...
  PUBLIC EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR,EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_SPATIAL, &
    & EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_FIBRE,EQUATIONS_SET_DEFORMATION_GROWTH_TENSOR, &
    & EQUATIONS_SET_R_CAUCHY_GREEN_DEFORMATION_TENSOR,EQUATIONS_SET_L_CAUCHY_GREEN_DEFORMATION_TENSOR, &
    & EQUATIONS_SET_GREEN_LAGRANGE_STRAIN_TENSOR,EQUATIONS_SET_CAUCHY_STRESS_TENSOR, EQUATIONS_SET_CAUCHY_STRESS_TENSOR_FIBRE, &
    & EQUATIONS_SET_FIRST_PK_STRESS_TENSOR,EQUATIONS_SET_SECOND_PK_STRESS_TENSOR,EQUATIONS_SET_NUMBER_OF_TENSOR_TYPES

  PUBLIC EQUATIONS_SET_NO_OUTPUT,EQUATIONS_SET_PROGRESS_OUTPUT

  PUBLIC EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_TWO_DIM_1,EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_TWO_DIM_2, &
    & EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_THREE_DIM_1,EQUATIONS_SET_STANDARD_LAPLACE_EQUATION_THREE_DIM_2, &
    & EQUATIONS_SET_GENERALISED_LAPLACE_EQUATION_TWO_DIM_1
  ...
  PUBLIC EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_1,EQUATIONS_SET_CONSTANT_POISSON_EQUATION_TWO_DIM_2, &
    & EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_1,EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_2, &
    & EQUATIONS_SET_CONSTANT_POISSON_EQUATION_THREE_DIM_3,EQUATIONS_SET_QUADRATIC_POISSON_EQUATION_TWO_DIM_1, &
    & EQUATIONS_SET_EXPONENTIAL_POISSON_EQUATION_TWO_DIM_1,EQUATIONS_SET_PRESSURE_POISSON_THREE_DIM_1, &
