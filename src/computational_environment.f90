...
#include "mpif.h"
  ...
  INTERFACE Computational_NodeNumberGet
    MODULE PROCEDURE COMPUTATIONAL_NODE_NUMBER_GET
  END INTERFACE Computational_NodeNumberGet

  INTERFACE Computational_NumberOfNodesGet
    MODULE PROCEDURE COMPUTATIONAL_NODES_NUMBER_GET
  END INTERFACE Computational_NumberOfNodesGet

  INTERFACE Computational_EnvironmentInitialise
    MODULE PROCEDURE COMPUTATIONAL_ENVIRONMENT_INITIALISE
  END INTERFACE Computational_EnvironmentInitialise

  INTERFACE Computational_EnvironmentFinalise
    MODULE PROCEDURE COMPUTATIONAL_ENVIRONMENT_FINALISE
  END INTERFACE Computational_EnvironmentFinalise
  ...
  PUBLIC Computational_EnvironmentInitialise,Computational_EnvironmentFinalise
  
  PUBLIC COMPUTATIONAL_ENVIRONMENT_INITIALISE,COMPUTATIONAL_ENVIRONMENT_FINALISE

  PUBLIC Computational_NodeNumberGet,Computational_NumberOfNodesGet

  PUBLIC COMPUTATIONAL_NODES_NUMBER_GET,COMPUTATIONAL_NODE_NUMBER_GET
...
!     CALL MPI_ERROR_CHECK("MPI_ALLGATHER",MPI_IERROR,ERR,ERROR,*999)
    ...
    CALL ComputationalNodeNumbersSet(COMPUTATIONAL_ENVIRONMENT%MY_COMPUTATIONAL_NODE_NUMBER,COMPUTATIONAL_ENVIRONMENT% &
