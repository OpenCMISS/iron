...
!> \brief This module contains all machine dependent constants for IRIX systems.
!>
!> \section LICENSE
!>
...
MODULE MachineConstants
  ...
  !Machine constants
  INTEGER(INTG), PARAMETER :: MACHINE_TYPE=SGI_COMPUTER
  INTEGER(INTG), PARAMETER :: MACHINE_OS=IRIX_OS
