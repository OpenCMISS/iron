...
#include "macros.h"
  ...
  INTERFACE CONTROL_LOOP_CREATE_START
    MODULE PROCEDURE ControlLoop_CreateStart
  END INTERFACE CONTROL_LOOP_CREATE_START

  INTERFACE CONTROL_LOOP_CREATE_FINISH
    MODULE PROCEDURE ControlLoop_CreateFinish
  END INTERFACE CONTROL_LOOP_CREATE_FINISH
  
  INTERFACE CONTROL_LOOP_ITERATIONS_SET   
    MODULE PROCEDURE ControlLoop_IterationsSet 
  END INTERFACE CONTROL_LOOP_ITERATIONS_SET
  ...
  INTERFACE CONTROL_LOOP_MAXIMUM_ITERATIONS_SET
    MODULE PROCEDURE ControlLoop_MaximumIterationsSet
  END INTERFACE CONTROL_LOOP_MAXIMUM_ITERATIONS_SET

  INTERFACE CONTROL_LOOP_LOAD_OUTPUT_SET
    MODULE PROCEDURE ControlLoop_LoadOutputSet
  END INTERFACE CONTROL_LOOP_LOAD_OUTPUT_SET
  
  INTERFACE CONTROL_LOOP_NUMBER_OF_SUB_LOOPS_SET
    MODULE PROCEDURE ControlLoop_NumberOfSubLoopsSet
  END INTERFACE CONTROL_LOOP_NUMBER_OF_SUB_LOOPS_SET

  INTERFACE CONTROL_LOOP_OUTPUT_TYPE_GET
    MODULE PROCEDURE ControlLoop_OutputTypeGet
  END INTERFACE CONTROL_LOOP_OUTPUT_TYPE_GET

  INTERFACE CONTROL_LOOP_OUTPUT_TYPE_SET
    MODULE PROCEDURE ControlLoop_OutputTypeSet
  END INTERFACE CONTROL_LOOP_OUTPUT_TYPE_SET

  INTERFACE CONTROL_LOOP_SOLVERS_DESTROY
    MODULE PROCEDURE ControlLoop_SolversDestroy
  END INTERFACE CONTROL_LOOP_SOLVERS_DESTROY

  INTERFACE CONTROL_LOOP_SOLVER_EQUATIONS_DESTROY
    MODULE PROCEDURE ControlLoop_SolverEquationsDestroy
  END INTERFACE CONTROL_LOOP_SOLVER_EQUATIONS_DESTROY

  INTERFACE CONTROL_LOOP_TIMES_GET
    MODULE PROCEDURE ControlLoop_TimesGet
  END INTERFACE CONTROL_LOOP_TIMES_GET

  INTERFACE CONTROL_LOOP_TIMES_SET
    MODULE PROCEDURE ControlLoop_TimesSet
  END INTERFACE CONTROL_LOOP_TIMES_SET

  INTERFACE CONTROL_LOOP_TYPE_SET
    MODULE PROCEDURE ControlLoop_TypeSet
  END INTERFACE CONTROL_LOOP_TYPE_SET

  INTERFACE CONTROL_LOOP_TIME_INPUT_SET
    MODULE PROCEDURE ControlLoop_TimeInputSet
  END INTERFACE CONTROL_LOOP_TIME_INPUT_SET
  
  INTERFACE CONTROL_LOOP_TIME_OUTPUT_SET
  ...
  PUBLIC CONTROL_LOOP_NUMBER_OF_SUB_LOOPS_SET
