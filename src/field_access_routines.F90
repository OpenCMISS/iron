...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: FIELD_CELLML_VALUES_SET_TYPE=45 !<Stores values from a CellML model. \see FieldRoutines_ParameterSetTypes,FieldRoutines
  !>@}
