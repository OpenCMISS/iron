...
CONTAINS
  ...
  SUBROUTINE Burgers_BoundaryConditionsAnalyticCalculate(EQUATIONS_SET,BOUNDARY_CONDITIONS,err,error,*)
    ...
    !Local Variables
    INTEGER(INTG) :: component_idx,deriv_idx,dim_idx,local_ny,node_idx,numberOfDimensions,variable_idx,variable_type,version_idx
...
999 ERRORSEXITS("BURGERS_EQUATION_PROBLEM_SETUP",err,error)
  ...
  SUBROUTINE Burgers_FiniteElementJacobianEvaluate(EQUATIONS_SET,ELEMENT_NUMBER,err,error,*)
    ...
    TYPE(BasisType), POINTER :: DEPENDENT_BASIS1,DEPENDENT_BASIS2,GEOMETRIC_BASIS
    TYPE(EquationsType), POINTER :: equations
    TYPE(EquationsMappingVectorType), POINTER :: vectorMapping
    ...
    TYPE(QuadratureSchemeType), POINTER :: QUADRATURE_SCHEME1,QUADRATURE_SCHEME2
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        IF(evaluateJacobian) THEN
          ...
          DEPENDENT_BASIS1=>dependentField%DECOMPOSITION%DOMAIN(dependentField%decomposition%meshComponentNumber)%ptr% &
            & TOPOLOGY%ELEMENTS%ELEMENTS(ELEMENT_NUMBER)%BASIS
          ...
          DO ng=1,QUADRATURE_SCHEME1%numberOfGauss
                  ...
                  DO ns=1,DEPENDENT_BASIS2%numberOfElementParameters
                    ...
                    IF(nh==mh) THEN
                      ...
                      DO nj=1,GEOMETRIC_VARIABLE%numberOfComponents
                        ...
                        SUM3=0.0_DP
                        DO ni=1,DEPENDENT_BASIS1%numberOfXi
                          DPHINS_DXI=QUADRATURE_SCHEME1%gaussBasisFunctions(ns,PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(ni),ng)
...
999 ERRORS("Burgers_FiniteElementJacobianEvaluate",err,error)
  ...
  SUBROUTINE Burgers_FiniteElementResidualEvaluate(EQUATIONS_SET,ELEMENT_NUMBER,err,error,*)
    ...
    TYPE(BasisType), POINTER :: DEPENDENT_BASIS,GEOMETRIC_BASIS,DEPENDENT_BASIS1,DEPENDENT_BASIS2
    TYPE(EquationsType), POINTER :: equations
    TYPE(EquationsMappingVectorType), POINTER :: vectorMapping
