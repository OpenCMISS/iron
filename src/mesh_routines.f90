...
999 IF(ASSOCIATED(NEW_DECOMPOSITIONS)) DEALLOCATE(NEW_DECOMPOSITIONS)
  ...
  SUBROUTINE DECOMPOSITION_ELEMENT_DOMAIN_CALCULATE(DECOMPOSITION,ERR,ERROR,*)
    ...
    INTEGER(INTG), ALLOCATABLE :: ELEMENT_COUNT(:),ELEMENT_PTR(:),ELEMENT_INDICIES(:),ELEMENT_DISTANCE(:),DISPLACEMENTS(:), &
      & RECEIVE_COUNTS(:)
    INTEGER(INTG) :: ELEMENT_WEIGHT(1),NUMBER_FLAG,NUMBER_OF_CONSTRAINTS, PARMETIS_OPTIONS(0:2), NUMBER_OF_COMMON_NODES, & 
                      WEIGHT_FLAG
 ...
 !   & ELEMENT_WEIGHT, WEIGHT_FLAG, NUMBER_FLAG, &
 !   & NUMBER_OF_CONSTRAINTS, NUMBER_OF_COMMON_NODES, DECOMPOSITION%NUMBER_OF_DOMAINS, & 
 !   & TPWGTS, UBVEC, PARMETIS_OPTIONS, & 
 ...
 !   & COMPUTATIONAL_ENVIRONMENT%MPI_COMM)
  ...
  !  STOP("hello world1")
    ...
    call ParMETIS_V3_PartMeshKway(ELEMENT_DISTANCE, ELEMENT_PTR, ELEMENT_INDICIES, ELEMENT_WEIGHT, & 
...
!                & NUMBER_OF_CONSTRAINTS,NUMBER_OF_COMMON_NODES,DECOMPOSITION%NUMBER_OF_DOMAINS,[1.0_DP],UBVEC,PARMETIS_OPTIONS, &
