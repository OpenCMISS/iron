...
MODULE TYPES
  ...
  TYPE GENERATED_MESH_REGULAR_TYPE
    ...
    INTEGER(INTG),ALLOCATABLE  :: ElementXiCoordinates(:,:) ! (elementidx , XI coordinates) therefore the dimensions are
                                                            ! number of elements x 3 ( for 2D the fourth column will be zero)
...
!!TODO: just make this the size of the number of matrix variables rather than the field number of variable types and merge matrix variable types above???
  ...
  TYPE INTERFACE_MESH_CONNECTIVITY_TYPE !mirzawd2
