...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_QUASISTATIC_FITTING_SUBTYPE=2  
  INTEGER(INTG), PARAMETER :: PROBLEM_DIV_FREE_VELOCITY_FITTING_SUBTYPE=3
  ...
  PUBLIC PROBLEM_STATIC_FITTING_SUBTYPE,PROBLEM_QUASISTATIC_FITTING_SUBTYPE,PROBLEM_DIV_FREE_VELOCITY_FITTING_SUBTYPE
