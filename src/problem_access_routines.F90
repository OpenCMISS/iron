...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_NO_SOURCE_STATIC_ADVEC_DIFF_SUBTYPE=8
  ...
  PUBLIC PROBLEM_LAPLACE_EQUATION_TYPE,PROBLEM_POISSON_EQUATION_TYPE,PROBLEM_HELMHOLTZ_EQUATION_TYPE, &
    ...
    & PROBLEM_BIHARMONIC_EQUATION_TYPE,PROBLEM_DATA_FITTING_TYPE,PROBLEM_HJ_EQUATION_TYPE
  ...
  PUBLIC PROBLEM_STATIC_STOKES_SUBTYPE,PROBLEM_LAPLACE_STOKES_SUBTYPE,PROBLEM_TRANSIENT_STOKES_SUBTYPE, &
    & PROBLEM_OPTIMISED_STOKES_SUBTYPE,PROBLEM_ALE_STOKES_SUBTYPE,PROBLEM_PGM_STOKES_SUBTYPE
  ...
  PUBLIC PROBLEM_STATIC_NAVIER_STOKES_SUBTYPE,PROBLEM_LAPLACE_NAVIER_STOKES_SUBTYPE,PROBLEM_TRANSIENT_NAVIER_STOKES_SUBTYPE, &
    ...
    & PROBLEM_OPTIMISED_NAVIER_STOKES_SUBTYPE,PROBLEM_ALE_NAVIER_STOKES_SUBTYPE,PROBLEM_PGM_NAVIER_STOKES_SUBTYPE, &
  ...
  PUBLIC PROBLEM_STANDARD_DARCY_SUBTYPE,PROBLEM_QUASISTATIC_DARCY_SUBTYPE,PROBLEM_ALE_DARCY_SUBTYPE, &
    & PROBLEM_TRANSIENT_DARCY_SUBTYPE,PROBLEM_PGM_DARCY_SUBTYPE,PROBLEM_PGM_TRANSIENT_DARCY_SUBTYPE
  ...
  PUBLIC PROBLEM_NO_SOURCE_DIFFUSION_SUBTYPE,PROBLEM_LINEAR_SOURCE_DIFFUSION_SUBTYPE,PROBLEM_NONLINEAR_SOURCE_DIFFUSION_SUBTYPE, &
  ...
  PUBLIC PROBLEM_NO_SOURCE_ADVECTION_DIFFUSION_SUBTYPE,PROBLEM_LINEAR_SOURCE_ADVECTION_DIFFUSION_SUBTYPE, &
    ...
    & PROBLEM_ADVECTION_SUBTYPE,PROBLEM_NO_SOURCE_STATIC_ADVEC_DIFF_SUBTYPE,PROBLEM_LINEAR_SOURCE_STATIC_ADVEC_DIFF_SUBTYPE, &
  ...
  PUBLIC PROBLEM_MONODOMAIN_BUENOOROVIO_SUBTYPE,PROBLEM_MONODOMAIN_TENTUSSCHER06_SUBTYPE

  PUBLIC PROBLEM_STATIC_FITTING_SUBTYPE,PROBLEM_STANDARD_DATA_FITTING_SUBTYPE,PROBLEM_GENERALISED_DATA_FITTING_SUBTYPE, &
    & PROBLEM_MAT_PROPERTIES_DATA_FITTING_SUBTYPE,PROBLEM_VECTOR_DATA_FITTING_SUBTYPE, &
    & PROBLEM_DIV_FREE_VECTOR_DATA_FITTING_SUBTYPE,PROBLEM_DIV_FREE_VECTOR_DATA_PRE_FITTING_SUBTYPE, &
    & PROBLEM_DATA_POINT_VECTOR_STATIC_FITTING_SUBTYPE,PROBLEM_DATA_POINT_VECTOR_QUASISTATIC_FITTING_SUBTYPE

  PUBLIC PROBLEM_STANDARD_ELASTICITY_DARCY_SUBTYPE,PROBLEM_PGM_ELASTICITY_DARCY_SUBTYPE, &
    & PROBLEM_QUASISTATIC_ELASTICITY_TRANSIENT_DARCY_SUBTYPE,PROBLEM_QUASISTATIC_ELAST_TRANS_DARCY_MAT_SOLVE_SUBTYPE, &
    & PROBLEM_COUPLED_SOURCE_DIFFUSION_DIFFUSION_SUBTYPE,PROBLEM_COUPLED_SOURCE_ALE_DIFFUSION_DIFFUSION_SUBTYPE, &
    & PROBLEM_COUPLED_SOURCE_DIFFUSION_ADVEC_DIFFUSION_SUBTYPE,PROBLEM_COUPLED_SOURCE_ALE_DIFFUSION_ADVEC_DIFFUSION_SUBTYPE, &
