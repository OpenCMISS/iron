...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_CELLML_GUDUNOV_SPLIT_REACT_DIFF_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: PROBLEM_CELLML_STRANG_SPLIT_REACT_DIFF_SUBTYPE=2
  INTEGER(INTG), PARAMETER :: PROBLEM_CELLML_LINEAR_NOSPLIT_REACT_DIFF_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: PROBLEM_CELLML_NONLINEAR_NOSPLIT_REACT_DIFF_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: PROBLEM_GUDUNOV_SPLIT_REACT_DIFF_SUBTYPE=5
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_SPLIT_REACT_DIFF_SUBTYPE=6
  INTEGER(INTG), PARAMETER :: PROBLEM_LINEAR_NOSPLIT_REACT_DIFF_SUBTYPE=7
  INTEGER(INTG), PARAMETER :: PROBLEM_NONLINEAR_NOSPLIT_REACT_DIFF_SUBTYPE=8
  ...
  PUBLIC PROBLEM_CELLML_GUDUNOV_SPLIT_REACT_DIFF_SUBTYPE,PROBLEM_CELLML_STRANG_SPLIT_REACT_DIFF_SUBTYPE, &
    & PROBLEM_CELLML_LINEAR_NOSPLIT_REACT_DIFF_SUBTYPE,PROBLEM_CELLML_NONLINEAR_NOSPLIT_REACT_DIFF_SUBTYPE, &
    & PROBLEM_GUDUNOV_SPLIT_REACT_DIFF_SUBTYPE,PROBLEM_STRANG_SPLIT_REACT_DIFF_SUBTYPE, &
    & PROBLEM_LINEAR_NOSPLIT_REACT_DIFF_SUBTYPE,PROBLEM_NONLINEAR_NOSPLIT_REACT_DIFF_SUBTYPE
