...
#include "mpif.h"
  ...
  REAL(CMISSRP), PARAMETER :: ORIGIN(3)=[0.0_CMISSRP,-1.0_CMISSRP,-1.0_CMISSRP]
...
!    ELSE
      ...
      MaterialParameters = [10.0E3_CMISSRP,10.0E3_CMISSRP,10.0E3_CMISSRP,0.45_CMISSRP,0.45_CMISSRP,0.45_CMISSRP]
!    ENDIF
